...
```php
acceptDeliveryCallback($x_application_id, $x_store_id, $x_event_id, $delivery_reference_id, $accept_delivery_callback_request)
```
...
try {
    $apiInstance->acceptDeliveryCallback($x_application_id, $x_store_id, $x_event_id, $delivery_reference_id, $accept_delivery_callback_request);
} catch (Exception $e) {
...
```php
cancelDeliveryCallback($x_application_id, $x_store_id, $x_event_id, $delivery_reference_id, $cancel_delivery_callback_request)
```
...
try {
    $apiInstance->cancelDeliveryCallback($x_application_id, $x_store_id, $x_event_id, $delivery_reference_id, $cancel_delivery_callback_request);
} catch (Exception $e) {
...
```php
requestDeliveryQuoteCallback($x_application_id, $x_store_id, $x_event_id, $delivery_reference_id, $request_delivery_quote_callback_request)
```
...
try {
    $apiInstance->requestDeliveryQuoteCallback($x_application_id, $x_store_id, $x_event_id, $delivery_reference_id, $request_delivery_quote_callback_request);
} catch (Exception $e) {
...
```php
updateDeliveryStatus($x_application_id, $x_store_id, $delivery_reference_id, $delivery_status_update_request)
```
...
try {
    $apiInstance->updateDeliveryStatus($x_application_id, $x_store_id, $delivery_reference_id, $delivery_status_update_request);
} catch (Exception $e) {
