...
/**
 * PingEndpointsApi Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
...
/**
     ...
     * @param  string $x_echo_error x_echo_error (optional)
     ...
     * @return \OpenAPI\Client\Model\PongObject|\OpenAPI\Client\Model\ErrorMessage|\OpenAPI\Client\Model\ErrorMessage|\OpenAPI\Client\Model\ErrorMessage
     */
    public function ping($x_store_id, $x_echo_error = null, string $contentType = self::contentTypes['ping'][0])
    {
        list($response) = $this->pingWithHttpInfo($x_store_id, $x_echo_error, $contentType);
        return $response;
    }
     ...
     * @param  string $x_echo_error (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['ping'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\PongObject|\OpenAPI\Client\Model\ErrorMessage|\OpenAPI\Client\Model\ErrorMessage|\OpenAPI\Client\Model\ErrorMessage, HTTP status code, HTTP response headers (array of strings)
     */
    public function pingWithHttpInfo($x_store_id, $x_echo_error = null, string $contentType = self::contentTypes['ping'][0])
    {
        $request = $this->pingRequest($x_store_id, $x_echo_error, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\PongObject' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\PongObject' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\PongObject', []),
            ...
            $returnType = '\OpenAPI\Client\Model\PongObject';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\PongObject',
     ...
     */
    public function pingAsync($x_store_id, $x_echo_error = null, string $contentType = self::contentTypes['ping'][0])
    {
        return $this->pingAsyncWithHttpInfo($x_store_id, $x_echo_error, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function pingAsyncWithHttpInfo($x_store_id, $x_echo_error = null, string $contentType = self::contentTypes['ping'][0])
    {
        $returnType = '\OpenAPI\Client\Model\PongObject';
        $request = $this->pingRequest($x_store_id, $x_echo_error, $contentType);
     ...
     */
    public function pingRequest($x_store_id, $x_echo_error = null, string $contentType = self::contentTypes['ping'][0])
    {

        // verify the required parameter 'x_store_id' is set
        if ($x_store_id === null || (is_array($x_store_id) && count($x_store_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $x_store_id when calling ping'
            );
        }
        ...
        // header params
        if ($x_echo_error !== null) {
            $headerParams['X-Echo-Error'] = ObjectSerializer::toHeaderValue($x_echo_error);
        }
