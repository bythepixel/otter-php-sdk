...
class PingEndpointsApi
{
     ...
     */
    public function ping($x_application_id, $x_store_id, $x_echo_error = null)
    {
        list($response) = $this->pingWithHttpInfo($x_application_id, $x_store_id, $x_echo_error);
        return $response;
    }
     ...
     */
    public function pingWithHttpInfo($x_application_id, $x_store_id, $x_echo_error = null)
    {
        $request = $this->pingRequest($x_application_id, $x_store_id, $x_echo_error);
     ...
     */
    public function pingAsync($x_application_id, $x_store_id, $x_echo_error = null)
    {
        return $this->pingAsyncWithHttpInfo($x_application_id, $x_store_id, $x_echo_error)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function pingAsyncWithHttpInfo($x_application_id, $x_store_id, $x_echo_error = null)
    {
        $returnType = '\OpenAPI\Client\Model\PongObject';
        $request = $this->pingRequest($x_application_id, $x_store_id, $x_echo_error);
     ...
     */
    public function pingRequest($x_application_id, $x_store_id, $x_echo_error = null)
    {
        ...
        if ($x_application_id === null || (is_array($x_application_id) && count($x_application_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $x_application_id when calling ping'
            );
        }
