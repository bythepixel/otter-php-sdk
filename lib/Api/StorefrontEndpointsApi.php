...
/**
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postPauseStoreEventResult'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     */
    public function postPauseStoreEventResult($x_store_id, $x_event_id, $pause_store_event_result, string $contentType = self::contentTypes['postPauseStoreEventResult'][0])
    {
        $this->postPauseStoreEventResultWithHttpInfo($x_store_id, $x_event_id, $pause_store_event_result, $contentType);
    }
     ...
     */
    public function postPauseStoreEventResultWithHttpInfo($x_store_id, $x_event_id, $pause_store_event_result, string $contentType = self::contentTypes['postPauseStoreEventResult'][0])
    {
        $request = $this->postPauseStoreEventResultRequest($x_store_id, $x_event_id, $pause_store_event_result, $contentType);
     ...
     */
    public function postPauseStoreEventResultAsync($x_store_id, $x_event_id, $pause_store_event_result, string $contentType = self::contentTypes['postPauseStoreEventResult'][0])
    {
        return $this->postPauseStoreEventResultAsyncWithHttpInfo($x_store_id, $x_event_id, $pause_store_event_result, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postPauseStoreEventResultAsyncWithHttpInfo($x_store_id, $x_event_id, $pause_store_event_result, string $contentType = self::contentTypes['postPauseStoreEventResult'][0])
    {
        $returnType = '';
        $request = $this->postPauseStoreEventResultRequest($x_store_id, $x_event_id, $pause_store_event_result, $contentType);
     ...
     */
    public function postPauseStoreEventResultRequest($x_store_id, $x_event_id, $pause_store_event_result, string $contentType = self::contentTypes['postPauseStoreEventResult'][0])
    {
        ...
        if (isset($pause_store_event_result)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                ...
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($pause_store_event_result));
            } else {
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postStoreAvailabilityChange'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     */
    public function postStoreAvailabilityChange($x_store_id, $store_availability_event_result, $x_event_id = null, string $contentType = self::contentTypes['postStoreAvailabilityChange'][0])
    {
        $this->postStoreAvailabilityChangeWithHttpInfo($x_store_id, $store_availability_event_result, $x_event_id, $contentType);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function postStoreAvailabilityChangeWithHttpInfo($x_store_id, $store_availability_event_result, $x_event_id = null, string $contentType = self::contentTypes['postStoreAvailabilityChange'][0])
    {
        $request = $this->postStoreAvailabilityChangeRequest($x_store_id, $store_availability_event_result, $x_event_id, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postStoreAvailabilityChangeAsync($x_store_id, $store_availability_event_result, $x_event_id = null, string $contentType = self::contentTypes['postStoreAvailabilityChange'][0])
    {
        return $this->postStoreAvailabilityChangeAsyncWithHttpInfo($x_store_id, $store_availability_event_result, $x_event_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postStoreAvailabilityChangeAsyncWithHttpInfo($x_store_id, $store_availability_event_result, $x_event_id = null, string $contentType = self::contentTypes['postStoreAvailabilityChange'][0])
    {
        $returnType = '';
        $request = $this->postStoreAvailabilityChangeRequest($x_store_id, $store_availability_event_result, $x_event_id, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function postStoreAvailabilityChangeRequest($x_store_id, $store_availability_event_result, $x_event_id = null, string $contentType = self::contentTypes['postStoreAvailabilityChange'][0])
    {
        ...
        if (isset($store_availability_event_result)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($store_availability_event_result));
            } else {
     ...
     * @param  string $x_event_id x_event_id (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postStoreHoursConfigurationChange'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     */
    public function postStoreHoursConfigurationChange($x_store_id, $store_hours_configuration_event_result, $x_event_id = null, string $contentType = self::contentTypes['postStoreHoursConfigurationChange'][0])
    {
        $this->postStoreHoursConfigurationChangeWithHttpInfo($x_store_id, $store_hours_configuration_event_result, $x_event_id, $contentType);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function postStoreHoursConfigurationChangeWithHttpInfo($x_store_id, $store_hours_configuration_event_result, $x_event_id = null, string $contentType = self::contentTypes['postStoreHoursConfigurationChange'][0])
    {
        $request = $this->postStoreHoursConfigurationChangeRequest($x_store_id, $store_hours_configuration_event_result, $x_event_id, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postStoreHoursConfigurationChangeAsync($x_store_id, $store_hours_configuration_event_result, $x_event_id = null, string $contentType = self::contentTypes['postStoreHoursConfigurationChange'][0])
    {
        return $this->postStoreHoursConfigurationChangeAsyncWithHttpInfo($x_store_id, $store_hours_configuration_event_result, $x_event_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postStoreHoursConfigurationChangeAsyncWithHttpInfo($x_store_id, $store_hours_configuration_event_result, $x_event_id = null, string $contentType = self::contentTypes['postStoreHoursConfigurationChange'][0])
    {
        $returnType = '';
        $request = $this->postStoreHoursConfigurationChangeRequest($x_store_id, $store_hours_configuration_event_result, $x_event_id, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function postStoreHoursConfigurationChangeRequest($x_store_id, $store_hours_configuration_event_result, $x_event_id = null, string $contentType = self::contentTypes['postStoreHoursConfigurationChange'][0])
    {
        ...
        if (isset($store_hours_configuration_event_result)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($store_hours_configuration_event_result));
            } else {
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postUnpauseStoreEventResult'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     */
    public function postUnpauseStoreEventResult($x_store_id, $x_event_id, $unpause_store_event_result, string $contentType = self::contentTypes['postUnpauseStoreEventResult'][0])
    {
        $this->postUnpauseStoreEventResultWithHttpInfo($x_store_id, $x_event_id, $unpause_store_event_result, $contentType);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function postUnpauseStoreEventResultWithHttpInfo($x_store_id, $x_event_id, $unpause_store_event_result, string $contentType = self::contentTypes['postUnpauseStoreEventResult'][0])
    {
        $request = $this->postUnpauseStoreEventResultRequest($x_store_id, $x_event_id, $unpause_store_event_result, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postUnpauseStoreEventResultAsync($x_store_id, $x_event_id, $unpause_store_event_result, string $contentType = self::contentTypes['postUnpauseStoreEventResult'][0])
    {
        return $this->postUnpauseStoreEventResultAsyncWithHttpInfo($x_store_id, $x_event_id, $unpause_store_event_result, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postUnpauseStoreEventResultAsyncWithHttpInfo($x_store_id, $x_event_id, $unpause_store_event_result, string $contentType = self::contentTypes['postUnpauseStoreEventResult'][0])
    {
        $returnType = '';
        $request = $this->postUnpauseStoreEventResultRequest($x_store_id, $x_event_id, $unpause_store_event_result, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function postUnpauseStoreEventResultRequest($x_store_id, $x_event_id, $unpause_store_event_result, string $contentType = self::contentTypes['postUnpauseStoreEventResult'][0])
    {
        ...
        if (isset($unpause_store_event_result)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($unpause_store_event_result));
            } else {
