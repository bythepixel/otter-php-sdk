...
/**
    ...
    /**
     * Operation postFinancialInvoice
     *
     * Post a financial invoice
     *
     * @param  string $x_store_id x_store_id (required)
     * @param  \OpenAPI\Client\Model\FinancialInvoice $financial_invoice financial_invoice (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postFinancialInvoice'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     */
    public function postFinancialInvoice($x_store_id, $financial_invoice, string $contentType = self::contentTypes['postFinancialInvoice'][0])
    {
        $this->postFinancialInvoiceWithHttpInfo($x_store_id, $financial_invoice, $contentType);
    }

    /**
     * Operation postFinancialInvoiceWithHttpInfo
     *
     * Post a financial invoice
     *
     * @param  string $x_store_id (required)
     * @param  \OpenAPI\Client\Model\FinancialInvoice $financial_invoice (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postFinancialInvoice'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     */
    public function postFinancialInvoiceWithHttpInfo($x_store_id, $financial_invoice, string $contentType = self::contentTypes['postFinancialInvoice'][0])
    {
        $request = $this->postFinancialInvoiceRequest($x_store_id, $financial_invoice, $contentType);
    ...
    /**
     * Operation postFinancialInvoiceAsync
     *
     * Post a financial invoice
     *
     * @param  string $x_store_id (required)
     ...
     */
    public function postFinancialInvoiceAsync($x_store_id, $financial_invoice, string $contentType = self::contentTypes['postFinancialInvoice'][0])
    {
        return $this->postFinancialInvoiceAsyncWithHttpInfo($x_store_id, $financial_invoice, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation postFinancialInvoiceAsyncWithHttpInfo
     *
     * Post a financial invoice
     *
     * @param  string $x_store_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postFinancialInvoiceAsyncWithHttpInfo($x_store_id, $financial_invoice, string $contentType = self::contentTypes['postFinancialInvoice'][0])
    {
        $returnType = '';
        $request = $this->postFinancialInvoiceRequest($x_store_id, $financial_invoice, $contentType);
    ...
    /**
     * Create request for operation 'postFinancialInvoice'
     *
     * @param  string $x_store_id (required)
     * @param  \OpenAPI\Client\Model\FinancialInvoice $financial_invoice (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postFinancialInvoice'] to see the possible values for this operation
     ...
     */
    public function postFinancialInvoiceRequest($x_store_id, $financial_invoice, string $contentType = self::contentTypes['postFinancialInvoice'][0])
    {

        // verify the required parameter 'x_store_id' is set
        if ($x_store_id === null || (is_array($x_store_id) && count($x_store_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $x_store_id when calling postFinancialInvoice'
            );
        }

        // verify the required parameter 'financial_invoice' is set
        if ($financial_invoice === null || (is_array($financial_invoice) && count($financial_invoice) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $financial_invoice when calling postFinancialInvoice'
            );
        }


        $resourcePath = '/finance/v1/financial-invoices';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($financial_invoice)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($financial_invoice));
            } else {
                $httpBody = $financial_invoice;
            }
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postFinancialTransactions'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     */
    public function postFinancialTransactions($x_store_id, $financial_transaction, string $contentType = self::contentTypes['postFinancialTransactions'][0])
    {
        $this->postFinancialTransactionsWithHttpInfo($x_store_id, $financial_transaction, $contentType);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function postFinancialTransactionsWithHttpInfo($x_store_id, $financial_transaction, string $contentType = self::contentTypes['postFinancialTransactions'][0])
    {
        $request = $this->postFinancialTransactionsRequest($x_store_id, $financial_transaction, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postFinancialTransactionsAsync($x_store_id, $financial_transaction, string $contentType = self::contentTypes['postFinancialTransactions'][0])
    {
        return $this->postFinancialTransactionsAsyncWithHttpInfo($x_store_id, $financial_transaction, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postFinancialTransactionsAsyncWithHttpInfo($x_store_id, $financial_transaction, string $contentType = self::contentTypes['postFinancialTransactions'][0])
    {
        $returnType = '';
        $request = $this->postFinancialTransactionsRequest($x_store_id, $financial_transaction, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function postFinancialTransactionsRequest($x_store_id, $financial_transaction, string $contentType = self::contentTypes['postFinancialTransactions'][0])
    {
        ...
        if (isset($financial_transaction)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($financial_transaction));
            } else {
