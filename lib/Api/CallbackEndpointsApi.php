...
/**
 * CallbackEndpointsApi Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
...
/**
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['publishError'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     */
    public function publishError($x_store_id, $x_event_id, $event_callback_error, string $contentType = self::contentTypes['publishError'][0])
    {
        $this->publishErrorWithHttpInfo($x_store_id, $x_event_id, $event_callback_error, $contentType);
    }

    /**
     * Operation publishErrorWithHttpInfo
     *
     * Publish callback error
     *
     ...
     */
    public function publishErrorWithHttpInfo($x_store_id, $x_event_id, $event_callback_error, string $contentType = self::contentTypes['publishError'][0])
    {
        $request = $this->publishErrorRequest($x_store_id, $x_event_id, $event_callback_error, $contentType);
     ...
     */
    public function publishErrorAsync($x_store_id, $x_event_id, $event_callback_error, string $contentType = self::contentTypes['publishError'][0])
    {
        return $this->publishErrorAsyncWithHttpInfo($x_store_id, $x_event_id, $event_callback_error, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation publishErrorAsyncWithHttpInfo
     *
     * Publish callback error
     *
     * @param  string $x_store_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function publishErrorAsyncWithHttpInfo($x_store_id, $x_event_id, $event_callback_error, string $contentType = self::contentTypes['publishError'][0])
    {
        $returnType = '';
        $request = $this->publishErrorRequest($x_store_id, $x_event_id, $event_callback_error, $contentType);
    ...
    /**
     * Create request for operation 'publishError'
     *
     * @param  string $x_store_id (required)
     * @param  string $x_event_id (required)
     * @param  \OpenAPI\Client\Model\EventCallbackError $event_callback_error (required)
     ...
     */
    public function publishErrorRequest($x_store_id, $x_event_id, $event_callback_error, string $contentType = self::contentTypes['publishError'][0])
    {

        // verify the required parameter 'x_store_id' is set
        if ($x_store_id === null || (is_array($x_store_id) && count($x_store_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $x_store_id when calling publishError'
            );
        }
        ...
        if ($x_event_id === null || (is_array($x_event_id) && count($x_event_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $x_event_id when calling publishError'
            );
        }
        ...
        if ($event_callback_error === null || (is_array($event_callback_error) && count($event_callback_error) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $event_callback_error when calling publishError'
            );
        }


        $resourcePath = '/v1/callback/error';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
