...
class CallbackEndpointsApi
{
     ...
     * @return void
     */
    public function publishError($x_application_id, $x_store_id, $x_event_id, $event_callback_error)
    {
        $this->publishErrorWithHttpInfo($x_application_id, $x_store_id, $x_event_id, $event_callback_error);
    }
     ...
     */
    public function publishErrorWithHttpInfo($x_application_id, $x_store_id, $x_event_id, $event_callback_error)
    {
        $request = $this->publishErrorRequest($x_application_id, $x_store_id, $x_event_id, $event_callback_error);
     ...
     */
    public function publishErrorAsync($x_application_id, $x_store_id, $x_event_id, $event_callback_error)
    {
        return $this->publishErrorAsyncWithHttpInfo($x_application_id, $x_store_id, $x_event_id, $event_callback_error)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function publishErrorAsyncWithHttpInfo($x_application_id, $x_store_id, $x_event_id, $event_callback_error)
    {
        $returnType = '';
        $request = $this->publishErrorRequest($x_application_id, $x_store_id, $x_event_id, $event_callback_error);
     ...
     */
    public function publishErrorRequest($x_application_id, $x_store_id, $x_event_id, $event_callback_error)
    {
        ...
        if ($x_application_id === null || (is_array($x_application_id) && count($x_application_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $x_application_id when calling publishError'
            );
        }
