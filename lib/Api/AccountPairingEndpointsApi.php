...
/**
 * AccountPairingEndpointsApi Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AccountPairingEndpointsApi
{
    /**
     * @var ClientInterface
     */
...
/**
    ...
    /**
     * Operation updateStoreStatusEndpoint
     *
     * Update Store Status
     *
     * @param  string $x_store_id x_store_id (required)
     * @param  \OpenAPI\Client\Model\UpdateStorelinkStatusRequest $update_storelink_status_request update_storelink_status_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['updateStoreStatusEndpoint'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     */
    public function updateStoreStatusEndpoint($x_store_id, $update_storelink_status_request, string $contentType = self::contentTypes['updateStoreStatusEndpoint'][0])
    {
        $this->updateStoreStatusEndpointWithHttpInfo($x_store_id, $update_storelink_status_request, $contentType);
    }

    /**
     * Operation updateStoreStatusEndpointWithHttpInfo
     *
     * Update Store Status
     *
     * @param  string $x_store_id (required)
     * @param  \OpenAPI\Client\Model\UpdateStorelinkStatusRequest $update_storelink_status_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['updateStoreStatusEndpoint'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     */
    public function updateStoreStatusEndpointWithHttpInfo($x_store_id, $update_storelink_status_request, string $contentType = self::contentTypes['updateStoreStatusEndpoint'][0])
    {
        $request = $this->updateStoreStatusEndpointRequest($x_store_id, $update_storelink_status_request, $contentType);
    ...
    /**
     * Operation updateStoreStatusEndpointAsync
     *
     * Update Store Status
     *
     * @param  string $x_store_id (required)
     ...
     */
    public function updateStoreStatusEndpointAsync($x_store_id, $update_storelink_status_request, string $contentType = self::contentTypes['updateStoreStatusEndpoint'][0])
    {
        return $this->updateStoreStatusEndpointAsyncWithHttpInfo($x_store_id, $update_storelink_status_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation updateStoreStatusEndpointAsyncWithHttpInfo
     *
     * Update Store Status
     *
     * @param  string $x_store_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateStoreStatusEndpointAsyncWithHttpInfo($x_store_id, $update_storelink_status_request, string $contentType = self::contentTypes['updateStoreStatusEndpoint'][0])
    {
        $returnType = '';
        $request = $this->updateStoreStatusEndpointRequest($x_store_id, $update_storelink_status_request, $contentType);
    ...
    /**
     * Create request for operation 'updateStoreStatusEndpoint'
     *
     * @param  string $x_store_id (required)
     * @param  \OpenAPI\Client\Model\UpdateStorelinkStatusRequest $update_storelink_status_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['updateStoreStatusEndpoint'] to see the possible values for this operation
     ...
     */
    public function updateStoreStatusEndpointRequest($x_store_id, $update_storelink_status_request, string $contentType = self::contentTypes['updateStoreStatusEndpoint'][0])
    {

        // verify the required parameter 'x_store_id' is set
        if ($x_store_id === null || (is_array($x_store_id) && count($x_store_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $x_store_id when calling updateStoreStatusEndpoint'
            );
        }

        // verify the required parameter 'update_storelink_status_request' is set
        if ($update_storelink_status_request === null || (is_array($update_storelink_status_request) && count($update_storelink_status_request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $update_storelink_status_request when calling updateStoreStatusEndpoint'
            );
        }


        $resourcePath = '/v1/stores/status';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($update_storelink_status_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($update_storelink_status_request));
            } else {
                $httpBody = $update_storelink_status_request;
            }
    ...
    /**
     * Operation upsertStorelinkEventResultEndpoint
     *
     ...
     * @param  \OpenAPI\Client\Model\UpsertStorelinkEventResultRequest $upsert_storelink_event_result_request upsert_storelink_event_result_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['upsertStorelinkEventResultEndpoint'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     */
    public function upsertStorelinkEventResultEndpoint($x_application_id, $x_event_id, $upsert_storelink_event_result_request, string $contentType = self::contentTypes['upsertStorelinkEventResultEndpoint'][0])
    {
        $this->upsertStorelinkEventResultEndpointWithHttpInfo($x_application_id, $x_event_id, $upsert_storelink_event_result_request, $contentType);
    }

    /**
     * Operation upsertStorelinkEventResultEndpointWithHttpInfo
     *
     * Complete Store Onboarding
     *
     * @param  string $x_application_id (required)
     * @param  string $x_event_id (required)
     * @param  \OpenAPI\Client\Model\UpsertStorelinkEventResultRequest $upsert_storelink_event_result_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['upsertStorelinkEventResultEndpoint'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function upsertStorelinkEventResultEndpointWithHttpInfo($x_application_id, $x_event_id, $upsert_storelink_event_result_request, string $contentType = self::contentTypes['upsertStorelinkEventResultEndpoint'][0])
    {
        $request = $this->upsertStorelinkEventResultEndpointRequest($x_application_id, $x_event_id, $upsert_storelink_event_result_request, $contentType);
    ...
    /**
     * Operation upsertStorelinkEventResultEndpointAsync
     *
     * Complete Store Onboarding
     *
     * @param  string $x_application_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function upsertStorelinkEventResultEndpointAsync($x_application_id, $x_event_id, $upsert_storelink_event_result_request, string $contentType = self::contentTypes['upsertStorelinkEventResultEndpoint'][0])
    {
        return $this->upsertStorelinkEventResultEndpointAsyncWithHttpInfo($x_application_id, $x_event_id, $upsert_storelink_event_result_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation upsertStorelinkEventResultEndpointAsyncWithHttpInfo
     *
     * Complete Store Onboarding
     *
     * @param  string $x_application_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function upsertStorelinkEventResultEndpointAsyncWithHttpInfo($x_application_id, $x_event_id, $upsert_storelink_event_result_request, string $contentType = self::contentTypes['upsertStorelinkEventResultEndpoint'][0])
    {
        $returnType = '';
        $request = $this->upsertStorelinkEventResultEndpointRequest($x_application_id, $x_event_id, $upsert_storelink_event_result_request, $contentType);
    ...
    /**
     * Create request for operation 'upsertStorelinkEventResultEndpoint'
     *
     * @param  string $x_application_id (required)
     * @param  string $x_event_id (required)
     * @param  \OpenAPI\Client\Model\UpsertStorelinkEventResultRequest $upsert_storelink_event_result_request (required)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function upsertStorelinkEventResultEndpointRequest($x_application_id, $x_event_id, $upsert_storelink_event_result_request, string $contentType = self::contentTypes['upsertStorelinkEventResultEndpoint'][0])
    {
        ...
        if ($x_application_id === null || (is_array($x_application_id) && count($x_application_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $x_application_id when calling upsertStorelinkEventResultEndpoint'
            );
        }
        ...
        if ($x_event_id === null || (is_array($x_event_id) && count($x_event_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $x_event_id when calling upsertStorelinkEventResultEndpoint'
            );
        }

        // verify the required parameter 'upsert_storelink_event_result_request' is set
        if ($upsert_storelink_event_result_request === null || (is_array($upsert_storelink_event_result_request) && count($upsert_storelink_event_result_request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $upsert_storelink_event_result_request when calling upsertStorelinkEventResultEndpoint'
            );
        }
        ...
        // for model (json/xml)
        if (isset($upsert_storelink_event_result_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($upsert_storelink_event_result_request));
            } else {
                $httpBody = $upsert_storelink_event_result_request;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
