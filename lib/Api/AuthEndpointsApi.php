...
class AuthEndpointsApi
{
     ...
     */
    public function requestToken($grant_type, $scope, $client_id = null, $client_secret = null)
    {
        list($response) = $this->requestTokenWithHttpInfo($grant_type, $scope, $client_id, $client_secret);
        return $response;
    }
     ...
     */
    public function requestTokenWithHttpInfo($grant_type, $scope, $client_id = null, $client_secret = null)
    {
        $request = $this->requestTokenRequest($grant_type, $scope, $client_id, $client_secret);
     ...
     */
    public function requestTokenAsync($grant_type, $scope, $client_id = null, $client_secret = null)
    {
        return $this->requestTokenAsyncWithHttpInfo($grant_type, $scope, $client_id, $client_secret)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function requestTokenAsyncWithHttpInfo($grant_type, $scope, $client_id = null, $client_secret = null)
    {
        $returnType = '\OpenAPI\Client\Model\HydraToken';
        $request = $this->requestTokenRequest($grant_type, $scope, $client_id, $client_secret);
     ...
     */
    public function requestTokenRequest($grant_type, $scope, $client_id = null, $client_secret = null)
    {
