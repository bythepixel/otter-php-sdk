...
/**
 * AuthEndpointsApi Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
...
/**
     ...
     * Generate token
     *
     * @param  string $grant_type The OAuth2.0 grant types supported. (required)
     * @param  string $scope The scope to request, multiple scopes are passed delimited by a space character. (required)
     * @param  string $client_id The ID of the client (also known as the Application ID). (optional)
     * @param  string $client_secret The secret of the client. (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['requestToken'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\HydraToken|\OpenAPI\Client\Model\ErrorMessage|\OpenAPI\Client\Model\ErrorMessage|\OpenAPI\Client\Model\ErrorMessage
     */
    public function requestToken($grant_type, $scope, $client_id = null, $client_secret = null, string $contentType = self::contentTypes['requestToken'][0])
    {
        list($response) = $this->requestTokenWithHttpInfo($grant_type, $scope, $client_id, $client_secret, $contentType);
        return $response;
    }

    /**
     * Operation requestTokenWithHttpInfo
     *
     * Generate token
     *
     * @param  string $grant_type The OAuth2.0 grant types supported. (required)
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\HydraToken|\OpenAPI\Client\Model\ErrorMessage|\OpenAPI\Client\Model\ErrorMessage|\OpenAPI\Client\Model\ErrorMessage, HTTP status code, HTTP response headers (array of strings)
     */
    public function requestTokenWithHttpInfo($grant_type, $scope, $client_id = null, $client_secret = null, string $contentType = self::contentTypes['requestToken'][0])
    {
        $request = $this->requestTokenRequest($grant_type, $scope, $client_id, $client_secret, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\HydraToken' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\HydraToken' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\HydraToken', []),
            ...
            $returnType = '\OpenAPI\Client\Model\HydraToken';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\HydraToken',
     ...
     */
    public function requestTokenAsync($grant_type, $scope, $client_id = null, $client_secret = null, string $contentType = self::contentTypes['requestToken'][0])
    {
        return $this->requestTokenAsyncWithHttpInfo($grant_type, $scope, $client_id, $client_secret, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation requestTokenAsyncWithHttpInfo
     *
     * Generate token
     *
     * @param  string $grant_type The OAuth2.0 grant types supported. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function requestTokenAsyncWithHttpInfo($grant_type, $scope, $client_id = null, $client_secret = null, string $contentType = self::contentTypes['requestToken'][0])
    {
        $returnType = '\OpenAPI\Client\Model\HydraToken';
        $request = $this->requestTokenRequest($grant_type, $scope, $client_id, $client_secret, $contentType);
    ...
    /**
     * Create request for operation 'requestToken'
     *
     * @param  string $grant_type The OAuth2.0 grant types supported. (required)
     * @param  string $scope The scope to request, multiple scopes are passed delimited by a space character. (required)
     * @param  string $client_id The ID of the client (also known as the Application ID). (optional)
     ...
     */
    public function requestTokenRequest($grant_type, $scope, $client_id = null, $client_secret = null, string $contentType = self::contentTypes['requestToken'][0])
    {

        // verify the required parameter 'grant_type' is set
        if ($grant_type === null || (is_array($grant_type) && count($grant_type) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $grant_type when calling requestToken'
            );
        }
        ...
        if ($scope === null || (is_array($scope) && count($scope) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $scope when calling requestToken'
            );
        }
