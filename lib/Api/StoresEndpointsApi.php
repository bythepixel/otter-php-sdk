...
/**
 * StoresEndpointsApi Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
...
class StoresEndpointsApi
{
     ...
     * @return void
     */
    public function updateStoreStatusEndpoint($x_application_id, $x_store_id, $update_storelink_status_request)
    {
        $this->updateStoreStatusEndpointWithHttpInfo($x_application_id, $x_store_id, $update_storelink_status_request);
    }
     ...
     */
    public function updateStoreStatusEndpointWithHttpInfo($x_application_id, $x_store_id, $update_storelink_status_request)
    {
        $request = $this->updateStoreStatusEndpointRequest($x_application_id, $x_store_id, $update_storelink_status_request);
     ...
     */
    public function updateStoreStatusEndpointAsync($x_application_id, $x_store_id, $update_storelink_status_request)
    {
        return $this->updateStoreStatusEndpointAsyncWithHttpInfo($x_application_id, $x_store_id, $update_storelink_status_request)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateStoreStatusEndpointAsyncWithHttpInfo($x_application_id, $x_store_id, $update_storelink_status_request)
    {
        $returnType = '';
        $request = $this->updateStoreStatusEndpointRequest($x_application_id, $x_store_id, $update_storelink_status_request);
     ...
     */
    public function updateStoreStatusEndpointRequest($x_application_id, $x_store_id, $update_storelink_status_request)
    {
        ...
        if ($x_application_id === null || (is_array($x_application_id) && count($x_application_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $x_application_id when calling updateStoreStatusEndpoint'
            );
        }
     ...
     * @return void
     */
    public function upsertStorelinkEventResultEndpoint($x_application_id, $x_event_id, $upsert_storelink_event_result_request)
    {
        $this->upsertStorelinkEventResultEndpointWithHttpInfo($x_application_id, $x_event_id, $upsert_storelink_event_result_request);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function upsertStorelinkEventResultEndpointWithHttpInfo($x_application_id, $x_event_id, $upsert_storelink_event_result_request)
    {
        $request = $this->upsertStorelinkEventResultEndpointRequest($x_application_id, $x_event_id, $upsert_storelink_event_result_request);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function upsertStorelinkEventResultEndpointAsync($x_application_id, $x_event_id, $upsert_storelink_event_result_request)
    {
        return $this->upsertStorelinkEventResultEndpointAsyncWithHttpInfo($x_application_id, $x_event_id, $upsert_storelink_event_result_request)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function upsertStorelinkEventResultEndpointAsyncWithHttpInfo($x_application_id, $x_event_id, $upsert_storelink_event_result_request)
    {
        $returnType = '';
        $request = $this->upsertStorelinkEventResultEndpointRequest($x_application_id, $x_event_id, $upsert_storelink_event_result_request);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function upsertStorelinkEventResultEndpointRequest($x_application_id, $x_event_id, $upsert_storelink_event_result_request)
    {
        // verify the required parameter 'x_application_id' is set
        if ($x_application_id === null || (is_array($x_application_id) && count($x_application_id) === 0)) {
            throw new \InvalidArgumentException(
