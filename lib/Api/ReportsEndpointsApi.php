...
class ReportsEndpointsApi
{
     ...
     * @param  \OpenAPI\Client\Model\GenerateReportRequest $generate_report_request generate_report_request (required)
     *
     ...
     */
    public function generateReport($x_application_id, $x_store_id, $generate_report_request)
    {
        list($response) = $this->generateReportWithHttpInfo($x_application_id, $x_store_id, $generate_report_request);
        return $response;
    }
     ...
     * @param  \OpenAPI\Client\Model\GenerateReportRequest $generate_report_request (required)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     */
    public function generateReportWithHttpInfo($x_application_id, $x_store_id, $generate_report_request)
    {
        $request = $this->generateReportRequest($x_application_id, $x_store_id, $generate_report_request);
     ...
     */
    public function generateReportAsync($x_application_id, $x_store_id, $generate_report_request)
    {
        return $this->generateReportAsyncWithHttpInfo($x_application_id, $x_store_id, $generate_report_request)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function generateReportAsyncWithHttpInfo($x_application_id, $x_store_id, $generate_report_request)
    {
        $returnType = '\OpenAPI\Client\Model\GenerateReportResponse';
        $request = $this->generateReportRequest($x_application_id, $x_store_id, $generate_report_request);
     ...
     */
    public function generateReportRequest($x_application_id, $x_store_id, $generate_report_request)
    {
        ...
        if ($x_application_id === null || (is_array($x_application_id) && count($x_application_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $x_application_id when calling generateReport'
            );
        }
        // verify the required parameter 'x_store_id' is set
        if ($x_store_id === null || (is_array($x_store_id) && count($x_store_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $x_store_id when calling generateReport'
            );
        }
        // verify the required parameter 'generate_report_request' is set
        if ($generate_report_request === null || (is_array($generate_report_request) && count($generate_report_request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $generate_report_request when calling generateReport'
            );
        }
        ...
        // for model (json/xml)
        if (isset($generate_report_request)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($generate_report_request));
            } else {
                $httpBody = $generate_report_request;
            }
