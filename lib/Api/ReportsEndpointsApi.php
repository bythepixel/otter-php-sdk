...
/**
 * ReportsEndpointsApi Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
...
/**
    ...
    /**
     * Operation generateReportMulti
     *
     * Request a business report for multiple stores
     *
     * @param  \OpenAPI\Client\Model\GenerateReportMultiRequest $generate_report_multi_request generate_report_multi_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['generateReportMulti'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\GenerateReportResponse|\OpenAPI\Client\Model\ErrorMessage|\OpenAPI\Client\Model\ErrorMessage|\OpenAPI\Client\Model\ErrorMessage|\OpenAPI\Client\Model\ErrorMessage|\OpenAPI\Client\Model\ErrorMessage
     */
    public function generateReportMulti($generate_report_multi_request, string $contentType = self::contentTypes['generateReportMulti'][0])
    {
        list($response) = $this->generateReportMultiWithHttpInfo($generate_report_multi_request, $contentType);
        return $response;
    }

    /**
     * Operation generateReportMultiWithHttpInfo
     *
     * Request a business report for multiple stores
     *
     * @param  \OpenAPI\Client\Model\GenerateReportMultiRequest $generate_report_multi_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['generateReportMulti'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\GenerateReportResponse|\OpenAPI\Client\Model\ErrorMessage|\OpenAPI\Client\Model\ErrorMessage|\OpenAPI\Client\Model\ErrorMessage|\OpenAPI\Client\Model\ErrorMessage|\OpenAPI\Client\Model\ErrorMessage, HTTP status code, HTTP response headers (array of strings)
     */
    public function generateReportMultiWithHttpInfo($generate_report_multi_request, string $contentType = self::contentTypes['generateReportMulti'][0])
    {
        $request = $this->generateReportMultiRequest($generate_report_multi_request, $contentType);
    ...
    /**
     * Operation generateReportMultiAsync
     *
     * Request a business report for multiple stores
     *
     * @param  \OpenAPI\Client\Model\GenerateReportMultiRequest $generate_report_multi_request (required)
     ...
     */
    public function generateReportMultiAsync($generate_report_multi_request, string $contentType = self::contentTypes['generateReportMulti'][0])
    {
        return $this->generateReportMultiAsyncWithHttpInfo($generate_report_multi_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation generateReportMultiAsyncWithHttpInfo
     *
     * Request a business report for multiple stores
     *
     * @param  \OpenAPI\Client\Model\GenerateReportMultiRequest $generate_report_multi_request (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function generateReportMultiAsyncWithHttpInfo($generate_report_multi_request, string $contentType = self::contentTypes['generateReportMulti'][0])
    {
        $returnType = '\OpenAPI\Client\Model\GenerateReportResponse';
        $request = $this->generateReportMultiRequest($generate_report_multi_request, $contentType);
    ...
    /**
     * Create request for operation 'generateReportMulti'
     *
     * @param  \OpenAPI\Client\Model\GenerateReportMultiRequest $generate_report_multi_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['generateReportMulti'] to see the possible values for this operation
     *
     ...
     */
    public function generateReportMultiRequest($generate_report_multi_request, string $contentType = self::contentTypes['generateReportMulti'][0])
    {

        // verify the required parameter 'generate_report_multi_request' is set
        if ($generate_report_multi_request === null || (is_array($generate_report_multi_request) && count($generate_report_multi_request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $generate_report_multi_request when calling generateReportMulti'
            );
        }


        $resourcePath = '/v1/reports/generate';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($generate_report_multi_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($generate_report_multi_request));
            } else {
                $httpBody = $generate_report_multi_request;
            }
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\GetReportStatusResponse|\OpenAPI\Client\Model\ErrorMessage|\OpenAPI\Client\Model\ErrorMessage|\OpenAPI\Client\Model\ErrorMessage|\OpenAPI\Client\Model\ErrorMessage|\OpenAPI\Client\Model\ErrorMessage
     */
    public function getReportStatus($job_id, string $contentType = self::contentTypes['getReportStatus'][0])
    {
        list($response) = $this->getReportStatusWithHttpInfo($job_id, $contentType);
        return $response;
    }
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\GetReportStatusResponse|\OpenAPI\Client\Model\ErrorMessage|\OpenAPI\Client\Model\ErrorMessage|\OpenAPI\Client\Model\ErrorMessage|\OpenAPI\Client\Model\ErrorMessage|\OpenAPI\Client\Model\ErrorMessage, HTTP status code, HTTP response headers (array of strings)
     */
    public function getReportStatusWithHttpInfo($job_id, string $contentType = self::contentTypes['getReportStatus'][0])
    {
        $request = $this->getReportStatusRequest($job_id, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\GetReportStatusResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\GetReportStatusResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\GetReportStatusResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\OpenAPI\Client\Model\GetReportStatusResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\GetReportStatusResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getReportStatusAsync($job_id, string $contentType = self::contentTypes['getReportStatus'][0])
    {
        return $this->getReportStatusAsyncWithHttpInfo($job_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getReportStatusAsyncWithHttpInfo($job_id, string $contentType = self::contentTypes['getReportStatus'][0])
    {
        $returnType = '\OpenAPI\Client\Model\GetReportStatusResponse';
        $request = $this->getReportStatusRequest($job_id, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getReportStatusRequest($job_id, string $contentType = self::contentTypes['getReportStatus'][0])
    {

        // verify the required parameter 'job_id' is set
        if ($job_id === null || (is_array($job_id) && count($job_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $job_id when calling getReportStatus'
            );
        }


        $resourcePath = '/v1/reports/{jobId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
