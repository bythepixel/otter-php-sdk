...
class DeliveryEndpointsApi
{
     ...
     * @return void
     */
    public function acceptDeliveryCallback($x_application_id, $x_store_id, $x_event_id, $delivery_reference_id, $accept_delivery_callback_request)
    {
        $this->acceptDeliveryCallbackWithHttpInfo($x_application_id, $x_store_id, $x_event_id, $delivery_reference_id, $accept_delivery_callback_request);
    }
     ...
     */
    public function acceptDeliveryCallbackWithHttpInfo($x_application_id, $x_store_id, $x_event_id, $delivery_reference_id, $accept_delivery_callback_request)
    {
        $request = $this->acceptDeliveryCallbackRequest($x_application_id, $x_store_id, $x_event_id, $delivery_reference_id, $accept_delivery_callback_request);
     ...
     */
    public function acceptDeliveryCallbackAsync($x_application_id, $x_store_id, $x_event_id, $delivery_reference_id, $accept_delivery_callback_request)
    {
        return $this->acceptDeliveryCallbackAsyncWithHttpInfo($x_application_id, $x_store_id, $x_event_id, $delivery_reference_id, $accept_delivery_callback_request)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function acceptDeliveryCallbackAsyncWithHttpInfo($x_application_id, $x_store_id, $x_event_id, $delivery_reference_id, $accept_delivery_callback_request)
    {
        $returnType = '';
        $request = $this->acceptDeliveryCallbackRequest($x_application_id, $x_store_id, $x_event_id, $delivery_reference_id, $accept_delivery_callback_request);
     ...
     */
    public function acceptDeliveryCallbackRequest($x_application_id, $x_store_id, $x_event_id, $delivery_reference_id, $accept_delivery_callback_request)
    {
        ...
        if ($x_application_id === null || (is_array($x_application_id) && count($x_application_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $x_application_id when calling acceptDeliveryCallback'
            );
        }
        ...
        if (isset($accept_delivery_callback_request)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($accept_delivery_callback_request));
            } else {
     ...
     * @return void
     */
    public function cancelDeliveryCallback($x_application_id, $x_store_id, $x_event_id, $delivery_reference_id, $cancel_delivery_callback_request)
    {
        $this->cancelDeliveryCallbackWithHttpInfo($x_application_id, $x_store_id, $x_event_id, $delivery_reference_id, $cancel_delivery_callback_request);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function cancelDeliveryCallbackWithHttpInfo($x_application_id, $x_store_id, $x_event_id, $delivery_reference_id, $cancel_delivery_callback_request)
    {
        $request = $this->cancelDeliveryCallbackRequest($x_application_id, $x_store_id, $x_event_id, $delivery_reference_id, $cancel_delivery_callback_request);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function cancelDeliveryCallbackAsync($x_application_id, $x_store_id, $x_event_id, $delivery_reference_id, $cancel_delivery_callback_request)
    {
        return $this->cancelDeliveryCallbackAsyncWithHttpInfo($x_application_id, $x_store_id, $x_event_id, $delivery_reference_id, $cancel_delivery_callback_request)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function cancelDeliveryCallbackAsyncWithHttpInfo($x_application_id, $x_store_id, $x_event_id, $delivery_reference_id, $cancel_delivery_callback_request)
    {
        $returnType = '';
        $request = $this->cancelDeliveryCallbackRequest($x_application_id, $x_store_id, $x_event_id, $delivery_reference_id, $cancel_delivery_callback_request);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function cancelDeliveryCallbackRequest($x_application_id, $x_store_id, $x_event_id, $delivery_reference_id, $cancel_delivery_callback_request)
    {
        // verify the required parameter 'x_application_id' is set
        if ($x_application_id === null || (is_array($x_application_id) && count($x_application_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $x_application_id when calling cancelDeliveryCallback'
            );
        }
        // verify the required parameter 'x_store_id' is set
        if ($x_store_id === null || (is_array($x_store_id) && count($x_store_id) === 0)) {
        ...
        if (isset($cancel_delivery_callback_request)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($cancel_delivery_callback_request));
            } else {
     ...
     * @return void
     */
    public function deliveryCallbackError($x_store_id, $x_event_id, $event_callback_error)
    {
        $this->deliveryCallbackErrorWithHttpInfo($x_store_id, $x_event_id, $event_callback_error);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function deliveryCallbackErrorWithHttpInfo($x_store_id, $x_event_id, $event_callback_error)
    {
        $request = $this->deliveryCallbackErrorRequest($x_store_id, $x_event_id, $event_callback_error);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deliveryCallbackErrorAsync($x_store_id, $x_event_id, $event_callback_error)
    {
        return $this->deliveryCallbackErrorAsyncWithHttpInfo($x_store_id, $x_event_id, $event_callback_error)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deliveryCallbackErrorAsyncWithHttpInfo($x_store_id, $x_event_id, $event_callback_error)
    {
        $returnType = '';
        $request = $this->deliveryCallbackErrorRequest($x_store_id, $x_event_id, $event_callback_error);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function deliveryCallbackErrorRequest($x_store_id, $x_event_id, $event_callback_error)
    {
        // verify the required parameter 'x_store_id' is set
        if ($x_store_id === null || (is_array($x_store_id) && count($x_store_id) === 0)) {
            throw new \InvalidArgumentException(
        ...
        if (isset($event_callback_error)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($event_callback_error));
            } else {
     ...
     * @return void
     */
    public function requestDeliveryQuoteCallback($x_application_id, $x_store_id, $x_event_id, $delivery_reference_id, $request_delivery_quote_callback_request)
    {
        $this->requestDeliveryQuoteCallbackWithHttpInfo($x_application_id, $x_store_id, $x_event_id, $delivery_reference_id, $request_delivery_quote_callback_request);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function requestDeliveryQuoteCallbackWithHttpInfo($x_application_id, $x_store_id, $x_event_id, $delivery_reference_id, $request_delivery_quote_callback_request)
    {
        $request = $this->requestDeliveryQuoteCallbackRequest($x_application_id, $x_store_id, $x_event_id, $delivery_reference_id, $request_delivery_quote_callback_request);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function requestDeliveryQuoteCallbackAsync($x_application_id, $x_store_id, $x_event_id, $delivery_reference_id, $request_delivery_quote_callback_request)
    {
        return $this->requestDeliveryQuoteCallbackAsyncWithHttpInfo($x_application_id, $x_store_id, $x_event_id, $delivery_reference_id, $request_delivery_quote_callback_request)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function requestDeliveryQuoteCallbackAsyncWithHttpInfo($x_application_id, $x_store_id, $x_event_id, $delivery_reference_id, $request_delivery_quote_callback_request)
    {
        $returnType = '';
        $request = $this->requestDeliveryQuoteCallbackRequest($x_application_id, $x_store_id, $x_event_id, $delivery_reference_id, $request_delivery_quote_callback_request);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function requestDeliveryQuoteCallbackRequest($x_application_id, $x_store_id, $x_event_id, $delivery_reference_id, $request_delivery_quote_callback_request)
    {
        // verify the required parameter 'x_application_id' is set
        if ($x_application_id === null || (is_array($x_application_id) && count($x_application_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $x_application_id when calling requestDeliveryQuoteCallback'
            );
        }
        // verify the required parameter 'x_store_id' is set
        if ($x_store_id === null || (is_array($x_store_id) && count($x_store_id) === 0)) {
        ...
        if (isset($request_delivery_quote_callback_request)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($request_delivery_quote_callback_request));
            } else {
     ...
     * @return void
     */
    public function updateDeliveryStatus($x_application_id, $x_store_id, $delivery_reference_id, $delivery_status_update_request)
    {
        $this->updateDeliveryStatusWithHttpInfo($x_application_id, $x_store_id, $delivery_reference_id, $delivery_status_update_request);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateDeliveryStatusWithHttpInfo($x_application_id, $x_store_id, $delivery_reference_id, $delivery_status_update_request)
    {
        $request = $this->updateDeliveryStatusRequest($x_application_id, $x_store_id, $delivery_reference_id, $delivery_status_update_request);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateDeliveryStatusAsync($x_application_id, $x_store_id, $delivery_reference_id, $delivery_status_update_request)
    {
        return $this->updateDeliveryStatusAsyncWithHttpInfo($x_application_id, $x_store_id, $delivery_reference_id, $delivery_status_update_request)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateDeliveryStatusAsyncWithHttpInfo($x_application_id, $x_store_id, $delivery_reference_id, $delivery_status_update_request)
    {
        $returnType = '';
        $request = $this->updateDeliveryStatusRequest($x_application_id, $x_store_id, $delivery_reference_id, $delivery_status_update_request);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateDeliveryStatusRequest($x_application_id, $x_store_id, $delivery_reference_id, $delivery_status_update_request)
    {
        // verify the required parameter 'x_application_id' is set
        if ($x_application_id === null || (is_array($x_application_id) && count($x_application_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $x_application_id when calling updateDeliveryStatus'
            );
        }
        // verify the required parameter 'x_store_id' is set
        if ($x_store_id === null || (is_array($x_store_id) && count($x_store_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $x_store_id when calling updateDeliveryStatus'
            );
        }
        // verify the required parameter 'delivery_reference_id' is set
        if ($delivery_reference_id === null || (is_array($delivery_reference_id) && count($delivery_reference_id) === 0)) {
        ...
        if (isset($delivery_status_update_request)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($delivery_status_update_request));
            } else {
