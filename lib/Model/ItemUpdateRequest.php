...
class ItemUpdateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets id
     *
     * @param string $id Identifier of this Item.
     *
     * @return self
     */
     ...
     * Sets description
     *
     * @param string $description Description of this Item
     *
     * @return self
     */
     ...
     * Sets photo_urls
     *
     * @param string[]|null $photo_urls List of photoUrls to associate with the Item. This is used only for POST/PUT requests.
     *
     * @return self
     */
    public function setPhotoUrls($photo_urls)
    {
        if (is_null($photo_urls)) {
            array_push($this->openAPINullablesSetToNull, 'photo_urls');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('photo_urls', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
