...
/**
 * FulfillmentModeOverrideRuleAllOf Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class FulfillmentModeOverrideRuleAllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FulfillmentModeOverrideRule_allOf';
     ...
     *
     * @param string|null $fulfillment_mode The fulfillment mode for which the override rule should apply.
     *
     * @return self
     */
