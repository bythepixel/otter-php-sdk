...
class RequiredAddress implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['lines_of_address'] = $data['lines_of_address'] ?? null;
     ...
     *
     * @param string[]|null $lines_of_address Address lines only (e.g. street, PO Box, or company name). Null in cases where address data is single line address only. Use the fullAddress field for such cases.
     *
     * @return self
     */
