...
/**
 * RequiredAddress Class Doc Comment
 *
 * @category Class
 * @description Address.
 * @package  OpenAPI\Client
 ...
 */
class RequiredAddress implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RequiredAddress';
