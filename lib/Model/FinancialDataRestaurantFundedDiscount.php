<?php
/**
 * FinancialDataRestaurantFundedDiscount
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * FinancialDataRestaurantFundedDiscount Class Doc Comment
 *
 * @category Class
 ...
 */
class FinancialDataRestaurantFundedDiscount implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FinancialData_restaurantFundedDiscount';
    ...
    */
    ...
    public function setBreakdown($breakdown)
    {
        ...
        if ((count($breakdown) < 1)) {
            throw new \InvalidArgumentException('invalid length for $breakdown when calling FinancialDataRestaurantFundedDiscount., number of items must be greater than or equal to 1.');
        }
