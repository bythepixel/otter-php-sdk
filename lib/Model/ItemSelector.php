...
/**
 * ItemSelector Class Doc Comment
 *
 * @category Class
 ...
 */
class ItemSelector implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ItemSelector';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('is_modifier', $data ?? [], null);
    }
    ...
    */
    ...
    {
        return $this->container['is_modifier'];
    }

    /**
     * Sets is_modifier
     *
     * @param bool|null $is_modifier True, if the item is used as a modifier.
     *
     * @return self
     */
    public function setIsModifier($is_modifier)
    {
        if (is_null($is_modifier)) {
            throw new \InvalidArgumentException('non-nullable is_modifier cannot be null');
        }
        $this->container['is_modifier'] = $is_modifier;
