...
/**
 * FetchCredentialsEvent Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class FetchCredentialsEvent implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FetchCredentialsEvent';
    ...
    protected static $openAPITypes = [
        'credentials' => '\OpenAPI\Client\Model\ExistingCredential[]'
    ];
    ...
    */
     ...
     * Gets credentials
     *
     * @return \OpenAPI\Client\Model\ExistingCredential[]|null
     */
     ...
     * Sets credentials
     *
     * @param \OpenAPI\Client\Model\ExistingCredential[]|null $credentials Array of existing credentials added so far. It's used by multi step onboarding to verify if other credentials are needed based on existing ones values.
     *
     * @return self
     */
