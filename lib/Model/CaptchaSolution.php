...
/**
 * CaptchaSolution Class Doc Comment
 *
 * @category Class
 ...
 */
class CaptchaSolution implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CaptchaSolution';
     ...
     * Sets solution
     *
     * @param string|null $solution The captcha solution token
     *
     * @return self
     */
