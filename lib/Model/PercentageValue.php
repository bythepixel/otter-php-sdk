...
/**
 * PercentageValue Class Doc Comment
 *
 * @category Class
 ...
 */
class PercentageValue implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PercentageValue';
    ...
    {
        $this->container['decimal_value'] = $data['decimal_value'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['decimal_value'] === null) {
            $invalidProperties[] = "'decimal_value' can't be null";
        }
        if (($this->container['decimal_value'] < 0)) {
            $invalidProperties[] = "invalid value for 'decimal_value', must be bigger than or equal to 0.";
        }
     ...
     * Sets decimal_value
     *
     * @param float $decimal_value Percentage value in decimal format.
     *
     * @return self
     */
    public function setDecimalValue($decimal_value)
    {
        ...
        if (($decimal_value < 0)) {
            throw new \InvalidArgumentException('invalid value for $decimal_value when calling PercentageValue., must be bigger than or equal to 0.');
        }
