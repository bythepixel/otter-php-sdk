...
/**
 * AcceptDeliveryRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class AcceptDeliveryRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AcceptDeliveryRequest';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['wait_time'] = $data['wait_time'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['wait_time']) && ($this->container['wait_time'] < 0)) {
            $invalidProperties[] = "invalid value for 'wait_time', must be bigger than or equal to 0.";
        }
     ...
     * Sets quote_id
     *
     * @param string|null $quote_id Quote id from the requestQuote response.
     *
     * @return self
     */
     ...
     * Sets wait_time
     *
     * @param int|null $wait_time Wait time chosen for the delivery.
     *
     * @return self
     */
    public function setWaitTime($wait_time)
    {
        ...
        if (!is_null($wait_time) && ($wait_time < 0)) {
            throw new \InvalidArgumentException('invalid value for $wait_time when calling AcceptDeliveryRequest., must be bigger than or equal to 0.');
        }
