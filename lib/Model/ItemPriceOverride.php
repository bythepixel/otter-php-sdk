...
/**
 * ItemPriceOverride Class Doc Comment
 *
 * @category Class
 ...
 */
class ItemPriceOverride implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ItemPriceOverride';
    ...
    protected static $openAPITypes = [
        'rules' => '\OpenAPI\Client\Model\OverrideRule[]',
     ...
     * Gets rules
     *
     * @return \OpenAPI\Client\Model\OverrideRule[]
     */
     ...
     * Sets rules
     *
     * @param \OpenAPI\Client\Model\OverrideRule[] $rules Override rules for when this price override should be applied.
     *
     * @return self
     */
    public function setRules($rules)
    {
        ...
        if ((count($rules) < 1)) {
            throw new \InvalidArgumentException('invalid length for $rules when calling ItemPriceOverride., number of items must be greater than or equal to 1.');
        }
     ...
     * Sets currency_code
     *
     * @param string $currency_code The 3-letter currency code (ISO 4217) to use for all monetary values.
     *
     * @return self
     */
    public function setCurrencyCode($currency_code)
    {
        if ((mb_strlen($currency_code) > 3)) {
            throw new \InvalidArgumentException('invalid length for $currency_code when calling ItemPriceOverride., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($currency_code) < 3)) {
            throw new \InvalidArgumentException('invalid length for $currency_code when calling ItemPriceOverride., must be bigger than or equal to 3.');
        }
     ...
     * Sets amount
     *
     * @param float $amount Amount the Item costs
     *
     * @return self
     */
