...
/**
 * OrderItemIssue Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class OrderItemIssue implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OrderItemIssue';
    ...
    public const TYPE_WRONG_INGREDIENTS = 'WRONG_INGREDIENTS';
    public const TYPE_WRONG_SIZE = 'WRONG_SIZE';
    public const TYPE_WRONG_INSTRUCTIONS = 'WRONG_INSTRUCTIONS';
    public const TYPE_TEMPERATURE_COLD = 'TEMPERATURE_COLD';
    public const TYPE_WRONG_ORDER = 'WRONG_ORDER';
    public const TYPE_POOR_QUALITY = 'POOR_QUALITY';
    public const TYPE_HANDLED_POORLY = 'HANDLED_POORLY';
    public const TYPE_WRONG_ITEM = 'WRONG_ITEM';
    public const TYPE_WRONG_QUANTITY = 'WRONG_QUANTITY';
    public const TYPE_LATE_TO_COURIER = 'LATE_TO_COURIER';
    ...
    public function getTypeAllowableValues()
    {
        return [
            ...
            self::TYPE_WRONG_INGREDIENTS,
            self::TYPE_WRONG_SIZE,
            self::TYPE_WRONG_INSTRUCTIONS,
            self::TYPE_TEMPERATURE_COLD,
            self::TYPE_WRONG_ORDER,
            self::TYPE_POOR_QUALITY,
            self::TYPE_HANDLED_POORLY,
            self::TYPE_WRONG_ITEM,
            self::TYPE_WRONG_QUANTITY,
            self::TYPE_LATE_TO_COURIER,
     ...
     * Sets type
     *
     * @param string $type Order issue type.
     *
     * @return self
     */
