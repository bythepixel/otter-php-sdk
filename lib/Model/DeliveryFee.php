 ...
 */
class DeliveryFee implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DeliveryFee';
    ...
    */
     ...
     * Sets value
     *
     * @param float $value The delivery fee paid by the customer.
     *
     * @return self
     */
