...
/**
 * SignatureRequirement Class Doc Comment
 *
 * @category Class
 ...
 */
class SignatureRequirement implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SignatureRequirement';
    ...
    protected static $openAPIFormats = [
        'enabled' => null,
        'collect_signer_name' => null,
        'collect_signer_relationship' => null
    ];
    ...
    protected static $setters = [
        'enabled' => 'setEnabled',
        'collect_signer_name' => 'setCollectSignerName',
        'collect_signer_relationship' => 'setCollectSignerRelationship'
    ];
    ...
    protected static $getters = [
        'enabled' => 'getEnabled',
        'collect_signer_name' => 'getCollectSignerName',
        'collect_signer_relationship' => 'getCollectSignerRelationship'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('collect_signer_name', $data ?? [], null);
        $this->setIfExists('collect_signer_relationship', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets enabled
     *
     * @param bool|null $enabled Marks the signature requirement as required.
     *
     * @return self
     */
    ...
    /**
     * Gets collect_signer_name
     *
     * @return bool|null
     */
    public function getCollectSignerName()
    {
        return $this->container['collect_signer_name'];
    }

    /**
     * Sets collect_signer_name
     *
     * @param bool|null $collect_signer_name Whether the signer's name should be collected.
     *
     * @return self
     */
    public function setCollectSignerName($collect_signer_name)
    {
        if (is_null($collect_signer_name)) {
            throw new \InvalidArgumentException('non-nullable collect_signer_name cannot be null');
        }
        $this->container['collect_signer_name'] = $collect_signer_name;

        return $this;
    }

    /**
     * Gets collect_signer_relationship
     *
     * @return bool|null
     */
    public function getCollectSignerRelationship()
    {
        return $this->container['collect_signer_relationship'];
    }

    /**
     * Sets collect_signer_relationship
     *
     * @param bool|null $collect_signer_relationship Whether the signer's relationship with the intended recipient should be collected.
     *
     * @return self
     */
    public function setCollectSignerRelationship($collect_signer_relationship)
    {
        if (is_null($collect_signer_relationship)) {
            throw new \InvalidArgumentException('non-nullable collect_signer_relationship cannot be null');
        }
        $this->container['collect_signer_relationship'] = $collect_signer_relationship;
