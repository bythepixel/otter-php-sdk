...
/**
 * JobReference Class Doc Comment
 *
 * @category Class
 ...
 */
class JobReference implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'JobReference';
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id Unique identifier of the job.
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param string|null $status The status of the job.
     *
     * @return self
     */
