...
/**
 * OrderReadyEvent Class Doc Comment
 *
 * @category Class
 ...
 */
class OrderReadyEvent implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OrderReadyEvent';
