 ...
 */
class Item2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Item-2';
    ...
    */
     ...
     * Sets name
     *
     * @param string|null $name Human-readable name for this item.
     *
     * @return self
     */
     ...
     * Sets price
     *
     * @param float|null $price Per-unit price. This value excludes modifier prices.
     *
     * @return self
     */
     ...
     * Sets quantity
     *
     * @param float|null $quantity Number of units of this item being ordered.
     *
     * @return self
     */
     ...
     * Sets item_id
     *
     * @param string|null $item_id ID for this item.
     *
     * @return self
     */
     ...
     * Sets modifiers
     *
     * @param \OpenAPI\Client\Model\ModifierItem[]|null $modifiers Any modifiers attached to this item.
     *
     * @return self
     */
