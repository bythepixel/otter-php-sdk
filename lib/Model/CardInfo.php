...
class CardInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $setters = [
        'payment_network' => 'setPaymentNetwork',
        'type' => 'setType'
    ];
    ...
    protected static $getters = [
        'payment_network' => 'getPaymentNetwork',
        'type' => 'getType'
    ];
    ...
    public const PAYMENT_NETWORK_MASTERCARD = 'MASTERCARD';
    public const PAYMENT_NETWORK_MASTERCARD_MAESTRO = 'MASTERCARD_MAESTRO';
    public const PAYMENT_NETWORK_VISA = 'VISA';
    public const PAYMENT_NETWORK_AMEX = 'AMEX';
    public const PAYMENT_NETWORK_DINERS = 'DINERS';
    public const PAYMENT_NETWORK_ELO = 'ELO';
    public const PAYMENT_NETWORK_HIPERCARD = 'HIPERCARD';
    public const PAYMENT_NETWORK_BANRICOMPRAS = 'BANRICOMPRAS';
    public const PAYMENT_NETWORK_NUGO = 'NUGO';
    public const PAYMENT_NETWORK_GOODCARD = 'GOODCARD';
    public const PAYMENT_NETWORK_ELO_MAIS = 'ELO_MAIS';
    public const PAYMENT_NETWORK_GREENCARD = 'GREENCARD';
    public const PAYMENT_NETWORK_VEROCARD = 'VEROCARD';
    public const PAYMENT_NETWORK_COOPER = 'COOPER';
    public const PAYMENT_NETWORK_NUTRICARD = 'NUTRICARD';
    public const PAYMENT_NETWORK_VR = 'VR';
    public const PAYMENT_NETWORK_SODEXO = 'SODEXO';
    public const PAYMENT_NETWORK_OTHER = 'OTHER';
     ...
     * @return string[]
     */
    public function getPaymentNetworkAllowableValues()
    {
        return [
            self::PAYMENT_NETWORK_MASTERCARD,
            self::PAYMENT_NETWORK_MASTERCARD_MAESTRO,
            self::PAYMENT_NETWORK_VISA,
            self::PAYMENT_NETWORK_AMEX,
            self::PAYMENT_NETWORK_DINERS,
            self::PAYMENT_NETWORK_ELO,
            self::PAYMENT_NETWORK_HIPERCARD,
            self::PAYMENT_NETWORK_BANRICOMPRAS,
            self::PAYMENT_NETWORK_NUGO,
            self::PAYMENT_NETWORK_GOODCARD,
            self::PAYMENT_NETWORK_ELO_MAIS,
            self::PAYMENT_NETWORK_GREENCARD,
            self::PAYMENT_NETWORK_VEROCARD,
            self::PAYMENT_NETWORK_COOPER,
            self::PAYMENT_NETWORK_NUTRICARD,
            self::PAYMENT_NETWORK_VR,
            self::PAYMENT_NETWORK_SODEXO,
            self::PAYMENT_NETWORK_OTHER,
        ];
    }
    ...
    {
        $this->setIfExists('payment_network', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['payment_network'] === null) {
            $invalidProperties[] = "'payment_network' can't be null";
        }
        $allowedValues = $this->getPaymentNetworkAllowableValues();
        if (!is_null($this->container['payment_network']) && !in_array($this->container['payment_network'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'payment_network', must be one of '%s'",
                $this->container['payment_network'],
    ...
    /**
     * Gets payment_network
     *
     * @return string
     */
    public function getPaymentNetwork()
    {
        return $this->container['payment_network'];
    }

    /**
     * Sets payment_network
     *
     * @param string $payment_network The payment network (aka card brand or card scheme) for this card.
     *
     * @return self
     */
    public function setPaymentNetwork($payment_network)
    {
        $allowedValues = $this->getPaymentNetworkAllowableValues();
        if (!in_array($payment_network, $allowedValues, true)) {
        ...
        if (is_null($payment_network)) {
            throw new \InvalidArgumentException('non-nullable payment_network cannot be null');
        }

        $this->container['payment_network'] = $payment_network;
     ...
     * Sets type
     *
     * @param string $type The payment type of the card.
     *
     * @return self
     */
