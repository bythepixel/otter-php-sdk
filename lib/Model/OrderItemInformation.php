...
/**
 * OrderItemInformation Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class OrderItemInformation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OrderItemInformation';
    ...
    protected static $openAPITypes = [
        'id' => 'string',
        'name' => 'string',
        'issues' => '\OpenAPI\Client\Model\OrderItemIssue[]'
    ];
     ...
     * Sets id
     *
     * @param string $id Regular item identifier.
     *
     * @return self
     */
     ...
     * Gets issues
     *
     * @return \OpenAPI\Client\Model\OrderItemIssue[]|null
     */
     ...
     * Sets issues
     *
     * @param \OpenAPI\Client\Model\OrderItemIssue[]|null $issues Order issues that relate to this item.
     *
     * @return self
     */
