...
class ItemTax implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'percentage_value' => '\OpenAPI\Client\Model\PercentageValue',
        'is_value_added_tax' => 'bool'
    ];
    ...
    protected static $attributeMap = [
        ...
        'is_value_added_tax' => 'isValueAddedTax'
    ];
    ...
    protected static $setters = [
        ...
        'is_value_added_tax' => 'setIsValueAddedTax'
    ];
    ...
    protected static $getters = [
        ...
        'is_value_added_tax' => 'getIsValueAddedTax'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('is_value_added_tax', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['percentage_value'] === null) {
            $invalidProperties[] = "'percentage_value' can't be null";
        }
        if ($this->container['is_value_added_tax'] === null) {
            $invalidProperties[] = "'is_value_added_tax' can't be null";
        }
     ...
     *
     * @return \OpenAPI\Client\Model\PercentageValue
     */
     ...
     *
     * @param \OpenAPI\Client\Model\PercentageValue $percentage_value percentage_value
     *
     * @return self
     */
    ...
    /**
     * Gets is_value_added_tax
     *
     * @return bool
     */
    public function getIsValueAddedTax()
    {
        return $this->container['is_value_added_tax'];
    }

    /**
     * Sets is_value_added_tax
     *
     * @param bool $is_value_added_tax Whether this tax is a value-added tax.
     *
     * @return self
     */
    public function setIsValueAddedTax($is_value_added_tax)
    {

        if (is_null($is_value_added_tax)) {
            throw new \InvalidArgumentException('non-nullable is_value_added_tax cannot be null');
        }

        $this->container['is_value_added_tax'] = $is_value_added_tax;
