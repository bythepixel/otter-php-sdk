...
/**
 * RequiredEventResultMetadata Class Doc Comment
 *
 * @category Class
 ...
 */
class RequiredEventResultMetadata implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RequiredEventResultMetadata';
    ...
    protected static $openAPIFormats = [
        ...
        'operation_finished_at' => 'date-time'
    ];
    ...
    protected static $attributeMap = [
        ...
        'operation_finished_at' => 'operationFinishedAt'
    ];
    ...
    protected static $setters = [
        ...
        'operation_finished_at' => 'setOperationFinishedAt'
    ];
    ...
    protected static $getters = [
        ...
        'operation_finished_at' => 'getOperationFinishedAt'
    ];
    ...
    public const OPERATION_STATUS_SUCCEEDED = 'SUCCEEDED';
    public const OPERATION_STATUS_INTERNAL_ERROR = 'INTERNAL_ERROR';
    public const OPERATION_STATUS_AUTHENTICATION_FAILURE = 'AUTHENTICATION_FAILURE';
    public const OPERATION_STATUS_AUTHORIZATION_FAILURE = 'AUTHORIZATION_FAILURE';
    public const OPERATION_STATUS_UNKNOWN_FAILURE = 'UNKNOWN_FAILURE';
    public const OPERATION_STATUS_INVALID_STORE_STATE = 'INVALID_STORE_STATE';
    public const OPERATION_STATUS_INVALID_STORE_CONFIGURATION = 'INVALID_STORE_CONFIGURATION';
    public const OPERATION_STATUS_OPERATION_NOT_SUPPORTED = 'OPERATION_NOT_SUPPORTED';
    public const OPERATION_STATUS_IGNORED_ALREADY_IN_REQUESTED_STATE = 'IGNORED_ALREADY_IN_REQUESTED_STATE';
    public const OPERATION_STATUS_INVALID_REQUEST = 'INVALID_REQUEST';
    ...
    public function getOperationStatusAllowableValues()
    {
        return [
            ...
            self::OPERATION_STATUS_INTERNAL_ERROR,
            self::OPERATION_STATUS_AUTHENTICATION_FAILURE,
            self::OPERATION_STATUS_AUTHORIZATION_FAILURE,
            self::OPERATION_STATUS_UNKNOWN_FAILURE,
            self::OPERATION_STATUS_INVALID_STORE_STATE,
            self::OPERATION_STATUS_INVALID_STORE_CONFIGURATION,
            self::OPERATION_STATUS_OPERATION_NOT_SUPPORTED,
            self::OPERATION_STATUS_IGNORED_ALREADY_IN_REQUESTED_STATE,
            self::OPERATION_STATUS_INVALID_REQUEST,
        ];
    }
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('operation_finished_at', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['operation_status']) && !in_array($this->container['operation_status'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'operation_status', must be one of '%s'",
                $this->container['operation_status'],
     ...
     *
     * @param string|null $operation_status Status of the operation requested by an event.
     *
     * @return self
     */
    ...
    {
        $allowedValues = $this->getOperationStatusAllowableValues();
        if (!is_null($operation_status) && !in_array($operation_status, $allowedValues, true)) {
     ...
     *
     * @param string|null $additional_information Additional details about the event result, if available.
     *
     * @return self
     */
    ...
    /**
     * Gets operation_finished_at
     *
     * @return \DateTime|null
     */
    public function getOperationFinishedAt()
    {
        return $this->container['operation_finished_at'];
    }

    /**
     * Sets operation_finished_at
     *
     * @param \DateTime|null $operation_finished_at Time when the processing of the event finished.
     *
     * @return self
     */
    public function setOperationFinishedAt($operation_finished_at)
    {

        if (is_null($operation_finished_at)) {
            throw new \InvalidArgumentException('non-nullable operation_finished_at cannot be null');
        }

        $this->container['operation_finished_at'] = $operation_finished_at;
