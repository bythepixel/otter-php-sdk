 ...
 */
class CustomerTip implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CustomerTip';
    ...
    */
     ...
     * Sets value
     *
     * @param float $value The amount that the customer tipped.
     *
     * @return self
     */
