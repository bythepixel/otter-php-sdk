...
class Order implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'ordered_at' => '\DateTime',
        'customer' => '\OpenAPI\Client\Model\Person',
        'customer_note' => 'string',
        'delivery_info' => '\OpenAPI\Client\Model\DeliveryInfo',
        'order_total' => '\OpenAPI\Client\Model\OrderTotal',
        'order_total_v2' => '\OpenAPI\Client\Model\OrderTotalV2',
        'customer_payments' => '\OpenAPI\Client\Model\CustomerPayment[]',
        'fulfillment_info' => '\OpenAPI\Client\Model\FulfillmentInfo'
    ];
    ...
    protected static $setters = [
        'external_identifiers' => 'setExternalIdentifiers',
        ...
        'order_total_v2' => 'setOrderTotalV2',
    ...
    protected static $getters = [
        'external_identifiers' => 'getExternalIdentifiers',
        ...
        'order_total_v2' => 'getOrderTotalV2',
    ...
    {
        $this->setIfExists('external_identifiers', $data ?? [], null);
        ...
        $this->setIfExists('order_total_v2', $data ?? [], null);
        $this->setIfExists('customer_payments', $data ?? [], null);
        $this->setIfExists('fulfillment_info', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['external_identifiers'] === null) {
            $invalidProperties[] = "'external_identifiers' can't be null";
        }
    ...
    /**
     * Gets external_identifiers
     *
     * @return \OpenAPI\Client\Model\OrderExternalIdentifiers
     */
    public function getExternalIdentifiers()
    {
        return $this->container['external_identifiers'];
    }

    /**
     * Sets external_identifiers
     *
     * @param \OpenAPI\Client\Model\OrderExternalIdentifiers $external_identifiers external_identifiers
     *
     * @return self
     */
    public function setExternalIdentifiers($external_identifiers)
    {

        if (is_null($external_identifiers)) {
            throw new \InvalidArgumentException('non-nullable external_identifiers cannot be null');
        }

        $this->container['external_identifiers'] = $external_identifiers;
     ...
     * Sets currency_code
     *
     * @param string $currency_code The 3-letter currency code (ISO 4217) to use for all monetary values in this order.
     *
     * @return self
     */
    public function setCurrencyCode($currency_code)
    {
        ...
        if ((mb_strlen($currency_code) < 3)) {
            throw new \InvalidArgumentException('invalid length for $currency_code when calling Order., must be bigger than or equal to 3.');
        }
     ...
     * Sets items
     *
     * @param \OpenAPI\Client\Model\Item[]|null $items Items ordered.
     *
     * @return self
     */
    public function setItems($items)
    {
        ...
        if (!is_null($items) && (count($items) > 100)) {
            throw new \InvalidArgumentException('invalid value for $items when calling Order., number of items must be less than or equal to 100.');
        }
     ...
     * Sets ordered_at
     *
     * @param \DateTime|null $ordered_at The date (in UTC) when the order was placed by the customer.
     *
     * @return self
     */
     ...
     * Sets customer
     *
     * @param \OpenAPI\Client\Model\Person|null $customer customer
     *
     * @return self
     */
     ...
     * Sets customer_note
     *
     * @param string|null $customer_note An order-level note provided by the customer.
     *
     * @return self
     */
    public function setCustomerNote($customer_note)
    {
        ...
        if (is_null($customer_note)) {
            array_push($this->openAPINullablesSetToNull, 'customer_note');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('customer_note', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Gets delivery_info
     *
     * @return \OpenAPI\Client\Model\DeliveryInfo|null
     */
     ...
     * Sets delivery_info
     *
     * @param \OpenAPI\Client\Model\DeliveryInfo|null $delivery_info delivery_info
     *
     * @return self
     */
    public function setDeliveryInfo($delivery_info)
    {
        ...
        if (is_null($delivery_info)) {
            array_push($this->openAPINullablesSetToNull, 'delivery_info');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('delivery_info', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Sets order_total
     *
     * @param \OpenAPI\Client\Model\OrderTotal|null $order_total order_total
     *
     * @return self
     */
     ...
     * Gets order_total_v2
     *
     * @return \OpenAPI\Client\Model\OrderTotalV2|null
     */
    public function getOrderTotalV2()
    {
        return $this->container['order_total_v2'];
    }

    /**
     * Sets order_total_v2
     *
     * @param \OpenAPI\Client\Model\OrderTotalV2|null $order_total_v2 order_total_v2
     *
     * @return self
     */
    public function setOrderTotalV2($order_total_v2)
    {

        if (is_null($order_total_v2)) {
            array_push($this->openAPINullablesSetToNull, 'order_total_v2');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('order_total_v2', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        ...
        $this->container['order_total_v2'] = $order_total_v2;
     ...
     *
     * @param \OpenAPI\Client\Model\CustomerPayment[]|null $customer_payments Details about the payments made by the customer.
     *
     * @return self
     */
     ...
     *
     * @return \OpenAPI\Client\Model\FulfillmentInfo|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\FulfillmentInfo|null $fulfillment_info fulfillment_info
     *
     * @return self
     */
    public function setFulfillmentInfo($fulfillment_info)
    {
        ...
        if (is_null($fulfillment_info)) {
            array_push($this->openAPINullablesSetToNull, 'fulfillment_info');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('fulfillment_info', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
