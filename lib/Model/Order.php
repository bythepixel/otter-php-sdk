...
class Order implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->container['external_identifiers'] = $data['external_identifiers'] ?? null;
        $this->container['currency_code'] = $data['currency_code'] ?? null;
        $this->container['status'] = $data['status'] ?? null;
        $this->container['items'] = $data['items'] ?? null;
        $this->container['ordered_at'] = $data['ordered_at'] ?? null;
        ...
        $this->container['order_total_v2'] = $data['order_total_v2'] ?? null;
        $this->container['customer_payments'] = $data['customer_payments'] ?? null;
        $this->container['fulfillment_info'] = $data['fulfillment_info'] ?? null;
    }
