...
class FinancialTransaction implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FinancialTransaction';
    ...
    protected static $openAPITypes = [
        'order_identifiers' => '\OpenAPI\Client\Model\OrderIdentifierFinance',
        'id' => 'string',
        'pending' => 'bool',
        ...
        'notes' => 'string',
        'type' => 'string',
        'payout' => '\OpenAPI\Client\Model\PayoutInfo',
        'order_items' => '\OpenAPI\Client\Model\OrderItemInformation[]',
        'issues' => '\OpenAPI\Client\Model\OrderIssue[]',
        'data' => '\OpenAPI\Client\Model\FinancialData'
    ];
    ...
    protected static $setters = [
        'order_identifiers' => 'setOrderIdentifiers',
        'id' => 'setId',
        'pending' => 'setPending',
    ...
    protected static $getters = [
        'order_identifiers' => 'getOrderIdentifiers',
        'id' => 'getId',
        'pending' => 'getPending',
    ...
    {
        $this->setIfExists('order_identifiers', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['order_identifiers'] === null) {
            $invalidProperties[] = "'order_identifiers' can't be null";
        }
    ...
    /**
     * Gets order_identifiers
     *
     * @return \OpenAPI\Client\Model\OrderIdentifierFinance
     */
    public function getOrderIdentifiers()
    {
        return $this->container['order_identifiers'];
    }

    /**
     * Sets order_identifiers
     *
     * @param \OpenAPI\Client\Model\OrderIdentifierFinance $order_identifiers order_identifiers
     *
     * @return self
     */
    public function setOrderIdentifiers($order_identifiers)
    {

        if (is_null($order_identifiers)) {
            throw new \InvalidArgumentException('non-nullable order_identifiers cannot be null');
        }

        $this->container['order_identifiers'] = $order_identifiers;
     ...
     * Sets id
     *
     * @param string $id External financial transaction identifier.
     *
     * @return self
     */
     ...
     * Sets pending
     *
     * @param bool $pending Whether the transaction can be updated in the future.
     *
     * @return self
     */
    ...
    public function setCurrencyCode($currency_code)
    {
        if ((mb_strlen($currency_code) > 3)) {
            throw new \InvalidArgumentException('invalid length for $currency_code when calling FinancialTransaction., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($currency_code) < 3)) {
            throw new \InvalidArgumentException('invalid length for $currency_code when calling FinancialTransaction., must be bigger than or equal to 3.');
        }
     ...
     * Sets created_at
     *
     * @param \DateTime $created_at The date (in UTC) when the financial transaction was created.
     *
     * @return self
     */
     ...
     * Sets notes
     *
     * @param string|null $notes General notes about the financial transaction.
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param string $type Financial transaction operation type.
     *
     * @return self
     */
     ...
     * Gets payout
     *
     * @return \OpenAPI\Client\Model\PayoutInfo|null
     */
     ...
     * Sets payout
     *
     * @param \OpenAPI\Client\Model\PayoutInfo|null $payout payout
     *
     * @return self
     */
     ...
     * Gets order_items
     *
     * @return \OpenAPI\Client\Model\OrderItemInformation[]|null
     */
     ...
     * Sets order_items
     *
     * @param \OpenAPI\Client\Model\OrderItemInformation[]|null $order_items Detailed financial per order item.
     *
     * @return self
     */
     ...
     * Gets issues
     *
     * @return \OpenAPI\Client\Model\OrderIssue[]|null
     */
     ...
     * Sets issues
     *
     * @param \OpenAPI\Client\Model\OrderIssue[]|null $issues List of issues that might have happened with the order.
     *
     * @return self
     */
     ...
     * Gets data
     *
     * @return \OpenAPI\Client\Model\FinancialData
     */
     ...
     * Sets data
     *
     * @param \OpenAPI\Client\Model\FinancialData $data data
     *
     * @return self
     */
