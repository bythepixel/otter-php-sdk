...
/**
 * UpsertFullMenuEventCallback Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class UpsertFullMenuEventCallback implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpsertFullMenuEventCallback';
    ...
    protected static $openAPITypes = [
        'requested_to_created_entity_ids' => 'array<string,string>'
    ];
    ...
    protected static $openAPIFormats = [
        'requested_to_created_entity_ids' => null
    ];
    ...
    protected static array $openAPINullables = [
        'requested_to_created_entity_ids' => false
    ];
    ...
    protected static $attributeMap = [
        'requested_to_created_entity_ids' => 'requestedToCreatedEntityIds'
    ];
    ...
    protected static $setters = [
        'requested_to_created_entity_ids' => 'setRequestedToCreatedEntityIds'
    ];
    ...
    protected static $getters = [
        'requested_to_created_entity_ids' => 'getRequestedToCreatedEntityIds'
    ];
    ...
    {
        $this->setIfExists('requested_to_created_entity_ids', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['requested_to_created_entity_ids'] === null) {
            $invalidProperties[] = "'requested_to_created_entity_ids' can't be null";
        }
    ...
    /**
     * Gets requested_to_created_entity_ids
     *
     * @return array<string,string>
     */
    public function getRequestedToCreatedEntityIds()
    {
        return $this->container['requested_to_created_entity_ids'];
    }

    /**
     * Sets requested_to_created_entity_ids
     *
     * @param array<string,string> $requested_to_created_entity_ids A map for entities created by the Upsert containing the IDs of the requested entities mapped to the IDs of entities created by the request. Our system will use the IDs returned in this map to send updates to these entities in future requests. **NOTE -** A empty map can be used on requestedToCreatedEntityIds to use the same menu IDs that were previously defined.
     *
     * @return self
     */
    public function setRequestedToCreatedEntityIds($requested_to_created_entity_ids)
    {
        if (is_null($requested_to_created_entity_ids)) {
            throw new \InvalidArgumentException('non-nullable requested_to_created_entity_ids cannot be null');
        }
        $this->container['requested_to_created_entity_ids'] = $requested_to_created_entity_ids;
