...
/**
 * MenuPublishEvent Class Doc Comment
 *
 * @category Class
 ...
 */
class MenuPublishEvent implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MenuPublishEvent';
