<?php
/**
 * GetReportStatusResponsePayload
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * GetReportStatusResponsePayload Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class GetReportStatusResponsePayload implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetReportStatusResponse_payload';
    ...
    */
     ...
     * Sets report_url
     *
     * @param string|null $report_url Url to download the report. It will be available only if status is \"READY\"
     *
     * @return self
     */
     ...
     * Sets error_message
     *
     * @param string|null $error_message Error message. It will be available only if status is \"ERROR\"
     *
     * @return self
     */
