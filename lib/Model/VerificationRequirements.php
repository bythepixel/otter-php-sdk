...
/**
 * VerificationRequirements Class Doc Comment
 *
 * @category Class
 ...
 */
class VerificationRequirements implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'VerificationRequirements';
    ...
    protected static $openAPITypes = [
        'signature_requirement' => '\OpenAPI\Client\Model\SignatureRequirement',
        'picture_requirement' => '\OpenAPI\Client\Model\PictureRequirement'
    ];
    ...
    protected static $setters = [
        'signature_requirement' => 'setSignatureRequirement',
        'picture_requirement' => 'setPictureRequirement'
    ];
    ...
    protected static $getters = [
        'signature_requirement' => 'getSignatureRequirement',
        'picture_requirement' => 'getPictureRequirement'
    ];
    ...
    {
        $this->setIfExists('signature_requirement', $data ?? [], null);
        $this->setIfExists('picture_requirement', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets signature_requirement
     *
     * @return \OpenAPI\Client\Model\SignatureRequirement|null
     */
    public function getSignatureRequirement()
    {
        return $this->container['signature_requirement'];
    }

    /**
     * Sets signature_requirement
     *
     * @param \OpenAPI\Client\Model\SignatureRequirement|null $signature_requirement signature_requirement
     *
     * @return self
     */
    public function setSignatureRequirement($signature_requirement)
    {

        if (is_null($signature_requirement)) {
            array_push($this->openAPINullablesSetToNull, 'signature_requirement');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('signature_requirement', $nullablesSetToNull);
            if ($index !== FALSE) {
        ...
        $this->container['signature_requirement'] = $signature_requirement;

        return $this;
    }

    /**
     * Gets picture_requirement
     *
     * @return \OpenAPI\Client\Model\PictureRequirement|null
     */
    public function getPictureRequirement()
    {
        return $this->container['picture_requirement'];
    }

    /**
     * Sets picture_requirement
     *
     * @param \OpenAPI\Client\Model\PictureRequirement|null $picture_requirement picture_requirement
     *
     * @return self
     */
    public function setPictureRequirement($picture_requirement)
    {

        if (is_null($picture_requirement)) {
            array_push($this->openAPINullablesSetToNull, 'picture_requirement');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('picture_requirement', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        ...
        $this->container['picture_requirement'] = $picture_requirement;
