...
/**
 * PosOrderIssues Class Doc Comment
 *
 * @category Class
 ...
 */
class PosOrderIssues implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PosOrderIssues';
    ...
    protected static $openAPITypes = [
        'pos_order_issues' => '\OpenAPI\Client\Model\PosOrderIssue[]',
        'pos_item_issues' => '\OpenAPI\Client\Model\PosItemIssues[]'
    ];
    ...
    protected static $setters = [
        ...
        'pos_item_issues' => 'setPosItemIssues'
    ];
    ...
    protected static $getters = [
        ...
        'pos_item_issues' => 'getPosItemIssues'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('pos_item_issues', $data ?? [], null);
    }
    ...
    */
     ...
     *
     * @return \OpenAPI\Client\Model\PosOrderIssue[]|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\PosOrderIssue[]|null $pos_order_issues The specific issues with this order
     *
     * @return self
     */
    ...
    /**
     * Gets pos_item_issues
     *
     * @return \OpenAPI\Client\Model\PosItemIssues[]|null
     */
    public function getPosItemIssues()
    {
        return $this->container['pos_item_issues'];
    }

    /**
     * Sets pos_item_issues
     *
     * @param \OpenAPI\Client\Model\PosItemIssues[]|null $pos_item_issues The specific issues with individual items or modifiers on this orde
     *
     * @return self
     */
    public function setPosItemIssues($pos_item_issues)
    {

        if (is_null($pos_item_issues)) {
            throw new \InvalidArgumentException('non-nullable pos_item_issues cannot be null');
        }

        $this->container['pos_item_issues'] = $pos_item_issues;
