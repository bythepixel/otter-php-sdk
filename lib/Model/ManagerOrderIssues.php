...
/**
 * ManagerOrderIssues Class Doc Comment
 *
 * @category Class
 ...
 */
class ManagerOrderIssues implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ManagerOrderIssues';
    ...
    protected static $openAPITypes = [
        'order_issues' => '\OpenAPI\Client\Model\ManagerOrderIssue[]',
        'item_issues' => '\OpenAPI\Client\Model\ManagerItemIssues[]'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('item_issues', $data ?? [], null);
    }
    ...
    */
     ...
     * Gets order_issues
     *
     * @return \OpenAPI\Client\Model\ManagerOrderIssue[]|null
     */
     ...
     * Sets order_issues
     *
     * @param \OpenAPI\Client\Model\ManagerOrderIssue[]|null $order_issues The specific issues with this order
     *
     * @return self
     */
     ...
     * Gets item_issues
     *
     * @return \OpenAPI\Client\Model\ManagerItemIssues[]|null
     */
    public function getItemIssues()
    {
        return $this->container['item_issues'];
    }

    /**
     * Sets item_issues
     *
     * @param \OpenAPI\Client\Model\ManagerItemIssues[]|null $item_issues The specific issues with individual items or modifiers on this order
     *
     * @return self
     */
    public function setItemIssues($item_issues)
    {
        if (is_null($item_issues)) {
            throw new \InvalidArgumentException('non-nullable item_issues cannot be null');
        }
        $this->container['item_issues'] = $item_issues;
