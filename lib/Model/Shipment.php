...
class Shipment implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'id' => 'string',
        'delivery_info' => '\OpenAPI\Client\Model\ShipmentDeliveryInfo',
        'line_items' => '\OpenAPI\Client\Model\ShipmentLineItem[]',
        'state_changes' => '\OpenAPI\Client\Model\ShipmentStateChange[]'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('state_changes', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['delivery_info'] === null) {
            $invalidProperties[] = "'delivery_info' can't be null";
        }
        if ($this->container['line_items'] === null) {
            $invalidProperties[] = "'line_items' can't be null";
        }
        if ($this->container['state_changes'] === null) {
            $invalidProperties[] = "'state_changes' can't be null";
        }
        if ((count($this->container['state_changes']) < 1)) {
            $invalidProperties[] = "invalid value for 'state_changes', number of items must be greater than or equal to 1.";
        }
     ...
     * Sets id
     *
     * @param string $id A UUID for the shipment.
     *
     * @return self
     */
     ...
     * Gets delivery_info
     *
     * @return \OpenAPI\Client\Model\ShipmentDeliveryInfo
     */
     ...
     * Sets delivery_info
     *
     * @param \OpenAPI\Client\Model\ShipmentDeliveryInfo $delivery_info delivery_info
     *
     * @return self
     */
     ...
     * Gets line_items
     *
     * @return \OpenAPI\Client\Model\ShipmentLineItem[]
     */
     ...
     * Sets line_items
     *
     * @param \OpenAPI\Client\Model\ShipmentLineItem[] $line_items A list of the shipment line items.
     *
     * @return self
     */
     ...
     * Gets state_changes
     *
     * @return \OpenAPI\Client\Model\ShipmentStateChange[]
     */
     ...
     * Sets state_changes
     *
     * @param \OpenAPI\Client\Model\ShipmentStateChange[] $state_changes The state changes for the shipment. The final state change represents the current state of the shipment.
     *
     * @return self
     */
    public function setStateChanges($state_changes)
    {
        ...
        if ((count($state_changes) < 1)) {
            throw new \InvalidArgumentException('invalid length for $state_changes when calling Shipment., number of items must be greater than or equal to 1.');
        }

        if (is_null($state_changes)) {
            throw new \InvalidArgumentException('non-nullable state_changes cannot be null');
        }
