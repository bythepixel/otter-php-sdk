...
/**
 * FinancialDataFoodSales Class Doc Comment
 *
 * @category Class
 ...
 */
class FinancialDataFoodSales implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FinancialData_foodSales';
    ...
    */
    ...
    public function setBreakdown($breakdown)
    {
        ...
        if ((count($breakdown) < 1)) {
            throw new \InvalidArgumentException('invalid length for $breakdown when calling FinancialDataFoodSales., number of items must be greater than or equal to 1.');
        }
