...
/**
 * StorefrontTimeRange Class Doc Comment
 *
 * @category Class
 ...
 */
class StorefrontTimeRange implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Storefront_TimeRange';
    ...
    */
     ...
     * Sets start_time
     *
     * @param string|null $start_time Start time of the range in 24 hour format.
     *
     * @return self
     */
     ...
     * Sets end_time
     *
     * @param string|null $end_time End time of the range in 24 hour format.
     *
     * @return self
     */
