...
/**
 * EventCallbackError Class Doc Comment
 *
 * @category Class
 ...
 */
class EventCallbackError implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EventCallbackError';
     ...
     * Sets error_code
     *
     * @param string|null $error_code Errors that occur processing the webhook, modeled after Google's gRPC error codes.
     *
     * @return self
     */
     ...
     * Sets error_message
     *
     * @param string|null $error_message Additional information about the error.
     *
     * @return self
     */
