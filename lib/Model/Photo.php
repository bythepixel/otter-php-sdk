...
class Photo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets id
     *
     * @param string $id Identifier of the Photo.
     *
     * @return self
     */
     ...
     * Sets content_type
     *
     * @param string $content_type The media type of the file. Deprecated: Use the media type served from the photo URL instead.
     *
     * @return self
     * @deprecated
     */
