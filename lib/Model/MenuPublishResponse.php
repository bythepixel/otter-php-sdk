...
/**
 * MenuPublishResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class MenuPublishResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MenuPublishResponse';
    ...
    protected static $openAPITypes = [
        ...
        'job_id' => 'string',
        'menu_publish_targets' => '\OpenAPI\Client\Model\MenuPublishResponseMenuPublishTargets'
    ];
    ...
    protected static $attributeMap = [
        ...
        'job_id' => 'jobId',
        'menu_publish_targets' => 'menuPublishTargets'
    ];
    ...
    protected static $setters = [
        'request_submitted' => 'setRequestSubmitted',
        'job_id' => 'setJobId',
        'menu_publish_targets' => 'setMenuPublishTargets'
    ];
    ...
    protected static $getters = [
        'request_submitted' => 'getRequestSubmitted',
        'job_id' => 'getJobId',
        'menu_publish_targets' => 'getMenuPublishTargets'
    ];
    ...
    {
        $this->setIfExists('request_submitted', $data ?? [], null);
        $this->setIfExists('job_id', $data ?? [], null);
        $this->setIfExists('menu_publish_targets', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets request_submitted
     *
     * @return bool|null
     */
    public function getRequestSubmitted()
    {
        return $this->container['request_submitted'];
    }

    /**
     * Sets request_submitted
     *
     * @param bool|null $request_submitted Whether the request was submitted or not.
     *
     * @return self
     */
    public function setRequestSubmitted($request_submitted)
    {

        if (is_null($request_submitted)) {
            throw new \InvalidArgumentException('non-nullable request_submitted cannot be null');
        }

        $this->container['request_submitted'] = $request_submitted;
     ...
     * Sets job_id
     *
     * @param string|null $job_id Only present if the request succeeds. Job ID to check on the status with the MenuAsyncJob endpoint.
     *
     * @return self
     */
    ...
    /**
     * Gets menu_publish_targets
     *
     * @return \OpenAPI\Client\Model\MenuPublishResponseMenuPublishTargets|null
     */
    public function getMenuPublishTargets()
    {
        return $this->container['menu_publish_targets'];
    }

    /**
     * Sets menu_publish_targets
     *
     * @param \OpenAPI\Client\Model\MenuPublishResponseMenuPublishTargets|null $menu_publish_targets menu_publish_targets
     *
     * @return self
     */
    public function setMenuPublishTargets($menu_publish_targets)
    {

        if (is_null($menu_publish_targets)) {
            array_push($this->openAPINullablesSetToNull, 'menu_publish_targets');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('menu_publish_targets', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        ...
        $this->container['menu_publish_targets'] = $menu_publish_targets;
