 ...
 */
class MenuItem3PD implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MenuItem_3PD';
    ...
    protected static $openAPITypes = [
        ...
        'price_overrides' => '\OpenAPI\Client\Model\PriceOverride[]',
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['price_overrides'] === null) {
            $invalidProperties[] = "'price_overrides' can't be null";
        }
    ...
    public function setId($id)
    {
        ...
        if ((mb_strlen($id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $id when calling MenuItem3PD., must be bigger than or equal to 1.');
        }
     ...
     *
     * @return \OpenAPI\Client\Model\PriceOverride[]
     */
     ...
     *
     * @param \OpenAPI\Client\Model\PriceOverride[] $price_overrides Specify price overrides.
     *
     * @return self
     */
    public function setPriceOverrides($price_overrides)
    {
        ...
        if (is_null($price_overrides)) {
            throw new \InvalidArgumentException('non-nullable price_overrides cannot be null');
        }
