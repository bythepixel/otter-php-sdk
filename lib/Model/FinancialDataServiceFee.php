...
/**
 * FinancialDataServiceFee Class Doc Comment
 *
 * @category Class
 ...
 */
class FinancialDataServiceFee implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FinancialData_serviceFee';
    ...
    */
    ...
    public function setBreakdown($breakdown)
    {
        ...
        if ((count($breakdown) < 1)) {
            throw new \InvalidArgumentException('invalid length for $breakdown when calling FinancialDataServiceFee., number of items must be greater than or equal to 1.');
        }
