...
class POSConfirmOrderRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->container['order_external_identifiers'] = $data['order_external_identifiers'] ?? null;
        $this->container['estimated_prep_time_minutes'] = $data['estimated_prep_time_minutes'] ?? null;
    }
