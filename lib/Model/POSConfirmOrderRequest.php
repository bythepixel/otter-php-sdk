...
/**
 * POSConfirmOrderRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class POSConfirmOrderRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'POSConfirmOrderRequest';
    ...
    protected static $openAPITypes = [
        'order_external_identifiers' => '\OpenAPI\Client\Model\OrderIdentifier',
    ...
    protected static array $openAPINullables = [
		...
		'estimated_prep_time_minutes' => true
    ];
    ...
    protected static $setters = [
        ...
        'estimated_prep_time_minutes' => 'setEstimatedPrepTimeMinutes'
    ];
    ...
    protected static $getters = [
        ...
        'estimated_prep_time_minutes' => 'getEstimatedPrepTimeMinutes'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('estimated_prep_time_minutes', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['order_external_identifiers'] === null) {
            $invalidProperties[] = "'order_external_identifiers' can't be null";
        }
     ...
     *
     * @return \OpenAPI\Client\Model\OrderIdentifier
     */
     ...
     *
     * @param \OpenAPI\Client\Model\OrderIdentifier $order_external_identifiers order_external_identifiers
     *
     * @return self
     */
    ...
    /**
     * Gets estimated_prep_time_minutes
     *
     * @return int|null
     */
    public function getEstimatedPrepTimeMinutes()
    {
        return $this->container['estimated_prep_time_minutes'];
    }

    /**
     * Sets estimated_prep_time_minutes
     *
     * @param int|null $estimated_prep_time_minutes Estimated order preparation time in minutes.
     *
     * @return self
     */
    public function setEstimatedPrepTimeMinutes($estimated_prep_time_minutes)
    {

        if (is_null($estimated_prep_time_minutes)) {
            array_push($this->openAPINullablesSetToNull, 'estimated_prep_time_minutes');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('estimated_prep_time_minutes', $nullablesSetToNull);
            if ($index !== FALSE) {
        ...
        $this->container['estimated_prep_time_minutes'] = $estimated_prep_time_minutes;
