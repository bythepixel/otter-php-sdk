<?php
/**
 * RequestDeliveryQuoteEventDestinationAddress
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * RequestDeliveryQuoteEventDestinationAddress Class Doc Comment
 *
 * @category Class
 ...
 */
class RequestDeliveryQuoteEventDestinationAddress implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RequestDeliveryQuoteEvent_destinationAddress';
    ...
    protected static $attributeMap = [
        ...
        'lines_of_address' => 'linesOfAddress',
        'location' => 'location'
    ];
    ...
    protected static $setters = [
        ...
        'lines_of_address' => 'setLinesOfAddress',
    ...
    protected static $getters = [
        ...
        'lines_of_address' => 'getLinesOfAddress',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('lines_of_address', $data ?? [], null);
    ...
    */
     ...
     * Sets full_address
     *
     * @param string|null $full_address Full, human comprehensible address. It is usually formatted in the order appropriate for your locale. Currently only populated for cases in which only single-line address is available.
     *
     * @return self
     */
     ...
     * Sets city
     *
     * @param string|null $city The city/town portion of the address.
     *
     * @return self
     */
     ...
     * Sets state
     *
     * @param string|null $state Highest administrative subdivision which is used for postal addresses of a country or region. For example, this can be a state, a province, or a prefecture.
     *
     * @return self
     */
     ...
     * Sets country_code
     *
     * @param string|null $country_code CLDR country code. See http://cldr.unicode.org/
     *
     * @return self
     */
     ...
     * Sets address_lines
     *
     * @param string[]|null $address_lines Address lines (e.g. street, PO Box, or company name) or the full single line address (e.g. street, city, state, country, zip).
     *
     * @return self
     */
    ...
    /**
     * Gets lines_of_address
     *
     * @return string[]|null
     * @deprecated
     */
    public function getLinesOfAddress()
    {
        return $this->container['lines_of_address'];
    }

    /**
     * Sets lines_of_address
     *
     * @param string[]|null $lines_of_address Deprecated: use addressLines. Address lines (e.g. street, PO Box, or company name) or the full single line address (e.g. street, city, state, country, zip).
     *
     * @return self
     * @deprecated
     */
    public function setLinesOfAddress($lines_of_address)
    {
        if (is_null($lines_of_address)) {
            array_push($this->openAPINullablesSetToNull, 'lines_of_address');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('lines_of_address', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['lines_of_address'] = $lines_of_address;
