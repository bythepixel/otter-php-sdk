...
/**
 * InventorySummariesResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InventorySummariesResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InventorySummariesResponse';
    ...
    protected static $openAPITypes = [
        'inventory_summaries' => '\OpenAPI\Client\Model\InventorySummary[]',
        'next_token' => 'string'
    ];
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['inventory_summaries']) && (count($this->container['inventory_summaries']) > 100)) {
            $invalidProperties[] = "invalid value for 'inventory_summaries', number of items must be less than or equal to 100.";
        }
     ...
     *
     * @return \OpenAPI\Client\Model\InventorySummary[]|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\InventorySummary[]|null $inventory_summaries A list of the inventory summaries.
     *
     * @return self
     */
    public function setInventorySummaries($inventory_summaries)
    {
        ...
        if (!is_null($inventory_summaries) && (count($inventory_summaries) > 100)) {
            throw new \InvalidArgumentException('invalid value for $inventory_summaries when calling InventorySummariesResponse., number of items must be less than or equal to 100.');
        }
     ...
     * Sets next_token
     *
     * @param string|null $next_token Opaque token used to fetch the following page. If set, pass the value of nextToken to the next request. If not set, no more results are available.
     *
     * @return self
     */
