...
/**
 * FinancialDataBagFee Class Doc Comment
 *
 * @category Class
 ...
 */
class FinancialDataBagFee implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FinancialData_bagFee';
    ...
    */
    ...
    public function setBreakdown($breakdown)
    {
        ...
        if ((count($breakdown) < 1)) {
            throw new \InvalidArgumentException('invalid length for $breakdown when calling FinancialDataBagFee., number of items must be greater than or equal to 1.');
        }
