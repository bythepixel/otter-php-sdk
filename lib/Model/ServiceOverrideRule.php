...
/**
 * ServiceOverrideRule Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ServiceOverrideRule extends OverrideRule3PD
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ServiceOverrideRule';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['service_slug'] === null) {
            $invalidProperties[] = "'service_slug' can't be null";
        }
     ...
     * Sets service_slug
     *
     * @param string $service_slug The service for which the override rule should apply. The list of relevant service slugs can be provided by your integration partner. This feature is only available to  point-of-sale system providers.
     *
     * @return self
     */
