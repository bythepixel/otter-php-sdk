...
/**
 * CancelDeliveryResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class CancelDeliveryResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CancelDeliveryResponse';
    ...
    */
     ...
     * Sets processed_time
     *
     * @param \DateTime|null $processed_time Time that the delivery was canceled.
     *
     * @return self
     */
