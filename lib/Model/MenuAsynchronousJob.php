...
/**
 * MenuAsynchronousJob Class Doc Comment
 *
 * @category Class
 ...
 */
class MenuAsynchronousJob implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MenuAsynchronousJob';
    ...
    protected static $openAPITypes = [
        'job_reference' => '\OpenAPI\Client\Model\JobReference',
        'job_type' => 'string',
        'publish_job_state' => 'array<string,\OpenAPI\Client\Model\MenuPublishJobState>'
    ];
    ...
    protected static $setters = [
        ...
        'job_type' => 'setJobType',
        'publish_job_state' => 'setPublishJobState'
    ];
    ...
    protected static $getters = [
        ...
        'job_type' => 'getJobType',
        'publish_job_state' => 'getPublishJobState'
    ];
    ...
    public const JOB_TYPE_UPSERT = 'UPSERT';
    public const JOB_TYPE_PUBLISH = 'PUBLISH';
    public const JOB_TYPE_UNKNOWN = 'UNKNOWN';
    ...
    {
        return [
            self::JOB_TYPE_UPSERT,
            self::JOB_TYPE_PUBLISH,
            self::JOB_TYPE_UNKNOWN,
        ];
    }
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('publish_job_state', $data ?? [], null);
    }
    ...
    */
     ...
     * Gets job_reference
     *
     * @return \OpenAPI\Client\Model\JobReference|null
     */
     ...
     * Sets job_reference
     *
     * @param \OpenAPI\Client\Model\JobReference|null $job_reference job_reference
     *
     * @return self
     */
     ...
     * Sets job_type
     *
     * @param string|null $job_type Type of job.
     *
     * @return self
     */
    ...
    /**
     * Gets publish_job_state
     *
     * @return array<string,\OpenAPI\Client\Model\MenuPublishJobState>|null
     */
    public function getPublishJobState()
    {
        return $this->container['publish_job_state'];
    }

    /**
     * Sets publish_job_state
     *
     * @param array<string,\OpenAPI\Client\Model\MenuPublishJobState>|null $publish_job_state Only present if the MenuJobType is PUBLISH. Contains a map of MenuPublishTarget services to their corresponding statuses.
     *
     * @return self
     */
    public function setPublishJobState($publish_job_state)
    {

        if (is_null($publish_job_state)) {
            array_push($this->openAPINullablesSetToNull, 'publish_job_state');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('publish_job_state', $nullablesSetToNull);
            if ($index !== FALSE) {
        ...
        $this->container['publish_job_state'] = $publish_job_state;
