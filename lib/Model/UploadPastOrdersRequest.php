...
/**
 * UploadPastOrdersRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class UploadPastOrdersRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UploadPastOrdersRequest';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((count($this->container['orders']) > 100)) {
     ...
     * Sets orders
     *
     * @param \OpenAPI\Client\Model\Order[] $orders The past orders you are trying to upload
     *
     * @return self
     */
    public function setOrders($orders)
    {
        ...
        if ((count($orders) > 100)) {
            throw new \InvalidArgumentException('invalid value for $orders when calling UploadPastOrdersRequest., number of items must be less than or equal to 100.');
        }
