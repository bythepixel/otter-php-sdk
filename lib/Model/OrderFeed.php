 ...
 */
class OrderFeed implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OrderFeed';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('offset_token', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets orders
     *
     * @param \OpenAPI\Client\Model\Order[] $orders Array of Orders
     *
     * @return self
     */
     ...
     * @return string|null
     */
    public function getOffsetToken()
    {
        return $this->container['offset_token'];
    }

    /**
     * Sets offset_token
     *
     * @param string|null $offset_token Opaque token used to fetch the following page. If not set, no more orders are available.
     *
     * @return self
     */
    public function setOffsetToken($offset_token)
    {

        if (is_null($offset_token)) {
            throw new \InvalidArgumentException('non-nullable offset_token cannot be null');
        }

        $this->container['offset_token'] = $offset_token;
