...
class InventorySummary implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPINullables = [
		...
		'gtin' => false,
		'name' => false,
		'sellable_quantity' => false,
		'unsellable_quantity' => false,
		'inbound_quantity' => false
    ];
    ...
    protected static $setters = [
        ...
        'unsellable_quantity' => 'setUnsellableQuantity',
        'inbound_quantity' => 'setInboundQuantity'
    ];
    ...
    protected static $getters = [
        ...
        'unsellable_quantity' => 'getUnsellableQuantity',
        'inbound_quantity' => 'getInboundQuantity'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('unsellable_quantity', $data ?? [], null);
        $this->setIfExists('inbound_quantity', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets gtin
     *
     * @param string|null $gtin A 14 digit Global Trade Item Number (GTIN). For GTIN values that are shorter than 14 digits, value will be padded with leading zeroes.
     *
     * @return self
     */
     ...
     *
     * @param int $sellable_quantity The total quantity of the product ready to be sold. Does not include pending or in-progress shipments.
     *
     * @return self
     */
    public function setSellableQuantity($sellable_quantity)
    {

        if (is_null($sellable_quantity)) {
            throw new \InvalidArgumentException('non-nullable sellable_quantity cannot be null');
        }
    ...
    /**
     * Gets unsellable_quantity
     *
     * @return int|null
     */
    public function getUnsellableQuantity()
    {
        return $this->container['unsellable_quantity'];
    }

    /**
     * Sets unsellable_quantity
     *
     * @param int|null $unsellable_quantity The total quantity of the product that is in the facility but unable to be sold. This will include inventory that is damaged, expired or otherwise unsellable.
     *
     * @return self
     */
    public function setUnsellableQuantity($unsellable_quantity)
    {

        if (is_null($unsellable_quantity)) {
            throw new \InvalidArgumentException('non-nullable unsellable_quantity cannot be null');
        }

        $this->container['unsellable_quantity'] = $unsellable_quantity;

        return $this;
    }

    /**
     * Gets inbound_quantity
     *
     * @return int|null
     */
    public function getInboundQuantity()
    {
        return $this->container['inbound_quantity'];
    }

    /**
     * Sets inbound_quantity
     *
     * @param int|null $inbound_quantity The total quantity of the product inbound to the facility or waiting at the facility to be processed.
     *
     * @return self
     */
    public function setInboundQuantity($inbound_quantity)
    {

        if (is_null($inbound_quantity)) {
            throw new \InvalidArgumentException('non-nullable inbound_quantity cannot be null');
        }

        $this->container['inbound_quantity'] = $inbound_quantity;
