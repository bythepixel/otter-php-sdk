...
/**
 * UpsertStorelinkEventResultRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class UpsertStorelinkEventResultRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpsertStorelinkEventResultRequest';
    ...
    protected static $openAPITypes = [
        'success' => 'bool',
        'store_id' => 'string',
        'error_message' => '\OpenAPI\Client\Model\UpsertStorelinkEventResultRequestErrorMessage'
    ];
    ...
    */
     ...
     * Sets success
     *
     * @param bool $success Indicates if the partner application successfully created and validated the credential provided through the `Upsert Store Webhook`.
     *
     * @return self
     */
     ...
     * Gets error_message
     *
     * @return \OpenAPI\Client\Model\UpsertStorelinkEventResultRequestErrorMessage|null
     */
     ...
     * Sets error_message
     *
     * @param \OpenAPI\Client\Model\UpsertStorelinkEventResultRequestErrorMessage|null $error_message error_message
     *
     * @return self
     */
