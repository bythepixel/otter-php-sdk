...
/**
 * GetReportStatusResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class GetReportStatusResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetReportStatusResponse';
    ...
    protected static $openAPITypes = [
        'status' => 'string',
        'payload' => '\OpenAPI\Client\Model\GetReportStatusResponsePayload'
    ];
    ...
    */
     ...
     * Sets status
     *
     * @param string|null $status Report export status
     *
     * @return self
     */
     ...
     * Gets payload
     *
     * @return \OpenAPI\Client\Model\GetReportStatusResponsePayload|null
     */
     ...
     * Sets payload
     *
     * @param \OpenAPI\Client\Model\GetReportStatusResponsePayload|null $payload payload
     *
     * @return self
     */
