...
/**
 * SourceExternalIdentifiers Class Doc Comment
 *
 * @category Class
 ...
 */
class SourceExternalIdentifiers implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SourceExternalIdentifiers';
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id Unique ID for the order that was placed.
     *
     * @return self
     */
     ...
     * Sets friendly_id
     *
     * @param string|null $friendly_id ID used for driver pickup and restaurant management.
     *
     * @return self
     */
