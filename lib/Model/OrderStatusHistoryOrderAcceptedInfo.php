...
/**
 * OrderStatusHistoryOrderAcceptedInfo Class Doc Comment
 *
 * @category Class
 ...
 */
class OrderStatusHistoryOrderAcceptedInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OrderStatusHistory_orderAcceptedInfo';
    ...
    protected static array $openAPINullables = [
        'preparation_time_in_minutes' => false
    ];
    ...
    protected static $setters = [
        'preparation_time_in_minutes' => 'setPreparationTimeInMinutes'
    ];
    ...
    protected static $getters = [
        'preparation_time_in_minutes' => 'getPreparationTimeInMinutes'
    ];
    ...
    {
        $this->setIfExists('preparation_time_in_minutes', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['preparation_time_in_minutes'] === null) {
            $invalidProperties[] = "'preparation_time_in_minutes' can't be null";
        }
    ...
    /**
     * Gets preparation_time_in_minutes
     *
     * @return int
     */
    public function getPreparationTimeInMinutes()
    {
        return $this->container['preparation_time_in_minutes'];
    }

    /**
     * Sets preparation_time_in_minutes
     *
     * @param int $preparation_time_in_minutes [NEW] The time in minutes the restaurant says it will take to prepare the order.
     *
     * @return self
     */
    public function setPreparationTimeInMinutes($preparation_time_in_minutes)
    {
        if (is_null($preparation_time_in_minutes)) {
            throw new \InvalidArgumentException('non-nullable preparation_time_in_minutes cannot be null');
        }
        $this->container['preparation_time_in_minutes'] = $preparation_time_in_minutes;
