...
/**
 * OverrideRule Class Doc Comment
 *
 * @category Class
 ...
 */
class OverrideRule implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OverrideRule';
    ...
    protected static $attributeMap = [
        'external_service_slug' => 'externalServiceSlug'
    ];
    ...
    protected static $setters = [
        'external_service_slug' => 'setExternalServiceSlug'
    ];
    ...
    protected static $getters = [
        'external_service_slug' => 'getExternalServiceSlug'
    ];
    ...
    {
        $this->setIfExists('external_service_slug', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['external_service_slug'] === null) {
            $invalidProperties[] = "'external_service_slug' can't be null";
        }
    ...
    /**
     * Gets external_service_slug
     *
     * @return string
     */
    public function getExternalServiceSlug()
    {
        return $this->container['external_service_slug'];
    }

    /**
     * Sets external_service_slug
     *
     * @param string $external_service_slug The service slug for which this rule should apply. E.g.: If externalServiceSlug is UberEats, then the priceOverride should be applied to UberEats.
     *
     * @return self
     */
    public function setExternalServiceSlug($external_service_slug)
    {
        if (is_null($external_service_slug)) {
            throw new \InvalidArgumentException('non-nullable external_service_slug cannot be null');
        }
        $this->container['external_service_slug'] = $external_service_slug;
