...
/**
 * SuspensionStatus Class Doc Comment
 *
 * @category Class
 ...
 */
class SuspensionStatus implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SuspensionStatus';
    ...
    {
        $this->setIfExists('is_indefinite', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['is_indefinite'] === null) {
            $invalidProperties[] = "'is_indefinite' can't be null";
        }
    ...
    {
        return $this->container['is_indefinite'];
    }

    /**
     * Sets is_indefinite
     *
     * @param bool $is_indefinite True if the suspension is indefinite
     *
     * @return self
     */
    public function setIsIndefinite($is_indefinite)
    {

        if (is_null($is_indefinite)) {
            throw new \InvalidArgumentException('non-nullable is_indefinite cannot be null');
        }

        $this->container['is_indefinite'] = $is_indefinite;
