...
/**
 * EventNotificationNoPayload Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class EventNotificationNoPayload implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EventNotificationNoPayload';
    ...
    protected static $openAPITypes = [
        ...
        'event_time' => '\DateTime',
        'event_type' => 'string',
        'metadata' => '\OpenAPI\Client\Model\MetadataObjectNoPayload'
    ];
     ...
     * Sets event_id
     *
     * @param string $event_id Unique identifier of the event.
     *
     * @return self
     */
     ...
     * Sets event_time
     *
     * @param \DateTime $event_time Date of event occurrence.
     *
     * @return self
     */
     ...
     * Gets metadata
     *
     * @return \OpenAPI\Client\Model\MetadataObjectNoPayload
     */
     ...
     * Sets metadata
     *
     * @param \OpenAPI\Client\Model\MetadataObjectNoPayload $metadata metadata
     *
     * @return self
     */
