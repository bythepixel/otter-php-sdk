...
/**
 * FinancialDataSmallOrderFee Class Doc Comment
 *
 * @category Class
 ...
 */
class FinancialDataSmallOrderFee implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FinancialData_smallOrderFee';
    ...
    */
    ...
    public function setBreakdown($breakdown)
    {
        ...
        if ((count($breakdown) < 1)) {
            throw new \InvalidArgumentException('invalid length for $breakdown when calling FinancialDataSmallOrderFee., number of items must be greater than or equal to 1.');
        }
