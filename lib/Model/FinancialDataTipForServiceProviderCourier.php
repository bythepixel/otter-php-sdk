<?php
/**
 * FinancialDataTipForServiceProviderCourier
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * FinancialDataTipForServiceProviderCourier Class Doc Comment
 *
 * @category Class
 ...
 */
class FinancialDataTipForServiceProviderCourier implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FinancialData_tipForServiceProviderCourier';
    ...
    */
    ...
    public function setBreakdown($breakdown)
    {
        ...
        if ((count($breakdown) < 1)) {
            throw new \InvalidArgumentException('invalid length for $breakdown when calling FinancialDataTipForServiceProviderCourier., number of items must be greater than or equal to 1.');
        }
