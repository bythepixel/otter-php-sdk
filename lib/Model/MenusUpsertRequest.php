...
/**
 * MenusUpsertRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class MenusUpsertRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MenusUpsertRequest';
    ...
    protected static $openAPITypes = [
        'categories' => 'array<string,\OpenAPI\Client\Model\Category>',
        'modifier_groups' => 'array<string,\OpenAPI\Client\Model\ModifierGroupUpdateRequest>',
        'menus' => 'array<string,\OpenAPI\Client\Model\MenuPOS>',
        'items' => 'array<string,\OpenAPI\Client\Model\ItemUpdateRequest>'
    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['modifier_groups'] === null) {
            $invalidProperties[] = "'modifier_groups' can't be null";
        }
        if ($this->container['menus'] === null) {
            $invalidProperties[] = "'menus' can't be null";
        }
        if ((count($this->container['menus']) < 1)) {
            $invalidProperties[] = "invalid value for 'menus', number of items must be greater than or equal to 1.";
        }
     ...
     * Gets categories
     *
     * @return array<string,\OpenAPI\Client\Model\Category>
     */
     ...
     * Sets categories
     *
     * @param array<string,\OpenAPI\Client\Model\Category> $categories categories
     *
     * @return self
     */
     ...
     *
     * @return array<string,\OpenAPI\Client\Model\ModifierGroupUpdateRequest>
     */
     ...
     *
     * @param array<string,\OpenAPI\Client\Model\ModifierGroupUpdateRequest> $modifier_groups modifier_groups
     *
     * @return self
     */
     ...
     * Gets menus
     *
     * @return array<string,\OpenAPI\Client\Model\MenuPOS>
     */
     ...
     * Sets menus
     *
     * @param array<string,\OpenAPI\Client\Model\MenuPOS> $menus menus
     *
     * @return self
     */
    public function setMenus($menus)
    {
        ...
        if ((count($menus) < 1)) {
            throw new \InvalidArgumentException('invalid length for $menus when calling MenusUpsertRequest., number of items must be greater than or equal to 1.');
        }
     ...
     * Gets items
     *
     * @return array<string,\OpenAPI\Client\Model\ItemUpdateRequest>|null
     */
     ...
     * Sets items
     *
     * @param array<string,\OpenAPI\Client\Model\ItemUpdateRequest>|null $items items
     *
     * @return self
     */
