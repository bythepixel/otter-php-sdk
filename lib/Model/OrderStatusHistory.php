...
class OrderStatusHistory implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'order_status_history' => '\OpenAPI\Client\Model\OrderStatusEvent[]',
        'order_accepted_info' => '\OpenAPI\Client\Model\OrderStatusHistoryOrderAcceptedInfo'
    ];
    ...
    protected static $attributeMap = [
        ...
        'order_accepted_info' => 'orderAcceptedInfo'
    ];
    ...
    protected static $setters = [
        'order_status_history' => 'setOrderStatusHistory',
        'order_accepted_info' => 'setOrderAcceptedInfo'
    ];
    ...
    protected static $getters = [
        ...
        'order_accepted_info' => 'getOrderAcceptedInfo'
    ];
    ...
    {
        $this->setIfExists('order_status_history', $data ?? [], null);
        $this->setIfExists('order_accepted_info', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets order_status_history
     *
     * @return \OpenAPI\Client\Model\OrderStatusEvent[]|null
     */
    public function getOrderStatusHistory()
    {
        return $this->container['order_status_history'];
    }

    /**
     * Sets order_status_history
     *
     * @param \OpenAPI\Client\Model\OrderStatusEvent[]|null $order_status_history Array of OrderStatusEvent
     *
     * @return self
     */
    public function setOrderStatusHistory($order_status_history)
    {
        if (is_null($order_status_history)) {
            throw new \InvalidArgumentException('non-nullable order_status_history cannot be null');
        }
        $this->container['order_status_history'] = $order_status_history;

        return $this;
    }

    /**
     * Gets order_accepted_info
     *
     * @return \OpenAPI\Client\Model\OrderStatusHistoryOrderAcceptedInfo|null
     */
    public function getOrderAcceptedInfo()
    {
        return $this->container['order_accepted_info'];
    }

    /**
     * Sets order_accepted_info
     *
     * @param \OpenAPI\Client\Model\OrderStatusHistoryOrderAcceptedInfo|null $order_accepted_info order_accepted_info
     *
     * @return self
     */
    public function setOrderAcceptedInfo($order_accepted_info)
    {
        if (is_null($order_accepted_info)) {
            array_push($this->openAPINullablesSetToNull, 'order_accepted_info');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('order_accepted_info', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['order_accepted_info'] = $order_accepted_info;
