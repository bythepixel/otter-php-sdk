...
class OrderTotal implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OrderTotal';
    ...
    protected static $setters = [
        ...
        'claimed_subtotal' => 'setClaimedSubtotal',
    ...
    protected static $getters = [
        ...
        'claimed_subtotal' => 'getClaimedSubtotal',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('claimed_subtotal', $data ?? [], null);
    ...
    */
     ...
     * Sets subtotal
     *
     * @param float $subtotal The order's subtotal, as the sum of all item and modifier prices.
     *
     * @return self
     */
    ...
    /**
     * Gets claimed_subtotal
     *
     * @return float|null
     */
    public function getClaimedSubtotal()
    {
        return $this->container['claimed_subtotal'];
    }

    /**
     * Sets claimed_subtotal
     *
     * @param float|null $claimed_subtotal The order's claimed subtotal, without guaranteeing this will match calculated subtotal.
     *
     * @return self
     */
    public function setClaimedSubtotal($claimed_subtotal)
    {
        if (is_null($claimed_subtotal)) {
            array_push($this->openAPINullablesSetToNull, 'claimed_subtotal');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('claimed_subtotal', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['claimed_subtotal'] = $claimed_subtotal;
     ...
     * Sets discount
     *
     * @param float|null $discount Any discount amount for the order.
     *
     * @return self
     */
     ...
     * Sets tax
     *
     * @param float|null $tax Tax paid by the customer.
     *
     * @return self
     */
     ...
     * Sets tip
     *
     * @param float|null $tip Tip paid by the customer.
     *
     * @return self
     */
    ...
    {
        if (is_null($tip)) {
            array_push($this->openAPINullablesSetToNull, 'tip');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('tip', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Sets delivery_fee
     *
     * @param float|null $delivery_fee Delivery fee.
     *
     * @return self
     */
     ...
     * Sets total
     *
     * @param float|null $total Order total including everything paid by the customer.
     *
     * @return self
     */
     ...
     * Sets coupon_code
     *
     * @param string|null $coupon_code Coupon code applied to the order.
     *
     * @return self
     */
