...
/**
 * CaptchaRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class CaptchaRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CaptchaRequest';
    ...
    protected static $setters = [
        ...
        'recaptcha_site_key' => 'setRecaptchaSiteKey',
        'service_slug' => 'setServiceSlug',
        'action' => 'setAction'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('recaptcha_site_key', $data ?? [], null);
        $this->setIfExists('service_slug', $data ?? [], null);
    ...
    */
     ...
     * Sets website_url
     *
     * @param string|null $website_url The URL that generated the captcha site key
     *
     * @return self
     */
    ...
    /**
     * Gets recaptcha_site_key
     *
     * @return string|null
     */
    public function getRecaptchaSiteKey()
    {
        return $this->container['recaptcha_site_key'];
    }

    /**
     * Sets recaptcha_site_key
     *
     * @param string|null $recaptcha_site_key The captcha key
     *
     * @return self
     */
    public function setRecaptchaSiteKey($recaptcha_site_key)
    {

        if (is_null($recaptcha_site_key)) {
            throw new \InvalidArgumentException('non-nullable recaptcha_site_key cannot be null');
        }

        $this->container['recaptcha_site_key'] = $recaptcha_site_key;
    ...
    {
        return $this->container['service_slug'];
    }

    /**
     * Sets service_slug
     *
     * @param string|null $service_slug The slug of the service which is requesting the captcha
     *
     * @return self
     */
    public function setServiceSlug($service_slug)
    {
        ...
        if (is_null($service_slug)) {
            throw new \InvalidArgumentException('non-nullable service_slug cannot be null');
        }

        $this->container['service_slug'] = $service_slug;
     ...
     * Sets action
     *
     * @param string|null $action The captcha action available when solving a reCaptcha V3 captcha
     *
     * @return self
     */
