...
class Item implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['modifiers']) && (count($this->container['modifiers']) > 50)) {
            $invalidProperties[] = "invalid value for 'modifiers', number of items must be less than or equal to 50.";
        }
     ...
     * Sets quantity
     *
     * @param int $quantity The quantity of the item ordered by the customer.
     *
     * @return self
     */
    public function setQuantity($quantity)
    {
        ...
        if (($quantity > 1000)) {
            throw new \InvalidArgumentException('invalid value for $quantity when calling Item., must be smaller than or equal to 1000.');
        }
        if (($quantity < 1)) {
    ...
    public function setSkuPrice($sku_price)
    {
        ...
        if (is_null($sku_price)) {
            array_push($this->openAPINullablesSetToNull, 'sku_price');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('sku_price', $nullablesSetToNull);
            if ($index !== FALSE) {
     ...
     * Sets id
     *
     * @param string|null $id The unique ID of the item.
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name The name of the item as displayed to the customer.
     *
     * @return self
     */
     ...
     * Sets note
     *
     * @param string|null $note An optional item-level note provided by the customer.
     *
     * @return self
     */
     ...
     * Sets category_id
     *
     * @param string|null $category_id The unique ID of the category of this item.
     *
     * @return self
     */
     ...
     * Sets category_name
     *
     * @param string|null $category_name The name of the category of this item.
     *
     * @return self
     */
     ...
     * Sets price
     *
     * @param float|null $price The price of the sold item.
     *
     * @return self
     */
     ...
     * Sets modifiers
     *
     * @param \OpenAPI\Client\Model\ItemModifier[]|null $modifiers Modifiers to the base item.
     *
     * @return self
     */
    public function setModifiers($modifiers)
    {
        ...
        if (!is_null($modifiers) && (count($modifiers) > 50)) {
            throw new \InvalidArgumentException('invalid value for $modifiers when calling Item., number of items must be less than or equal to 50.');
        }
