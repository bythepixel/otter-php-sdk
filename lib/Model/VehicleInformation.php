...
/**
 * VehicleInformation Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class VehicleInformation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'VehicleInformation';
    ...
    public const VEHICLE_TYPE_WALKER = 'WALKER';
    public const VEHICLE_TYPE_MOTORCYCLE = 'MOTORCYCLE';
    public const VEHICLE_TYPE_BICYCLE = 'BICYCLE';
    ...
    {
        return [
            self::VEHICLE_TYPE_WALKER,
            self::VEHICLE_TYPE_MOTORCYCLE,
            self::VEHICLE_TYPE_BICYCLE,
    ...
    {
        $this->container['vehicle_type'] = $data['vehicle_type'] ?? null;
     ...
     * Sets vehicle_type
     *
     * @param string|null $vehicle_type The type of vehicle used to fulfill the delivery.
     *
     * @return self
     */
     ...
     * Sets license_plate
     *
     * @param string|null $license_plate The license plate of the vehicle used to fulfill the delivery.
     *
     * @return self
     */
     ...
     * Sets make_model
     *
     * @param string|null $make_model The make and model of the vehicle used to fulfill the delivery.
     *
     * @return self
     */
