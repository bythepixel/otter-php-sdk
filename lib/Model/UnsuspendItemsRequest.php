...
/**
 * UnsuspendItemsRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class UnsuspendItemsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UnsuspendItemsRequest';
     ...
     * Sets entity_ids
     *
     * @param string[]|null $entity_ids Entity IDs to unsuspend. These should be the IDs as you represent them in your system.
     *
     * @return self
     */
     ...
     * Sets note
     *
     * @param string|null $note The reason you are unsuspending the items.
     *
     * @return self
     */
