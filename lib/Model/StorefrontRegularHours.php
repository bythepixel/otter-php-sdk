...
/**
 * StorefrontRegularHours Class Doc Comment
 *
 * @category Class
 ...
 */
class StorefrontRegularHours implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Storefront_RegularHours';
     ...
     * Sets time_ranges
     *
     * @param \OpenAPI\Client\Model\StorefrontTimeRange[] $time_ranges Hours range applied to the provided day of the week
     *
     * @return self
     */
    public function setTimeRanges($time_ranges)
    {
        ...
        if ((count($time_ranges) < 1)) {
            throw new \InvalidArgumentException('invalid length for $time_ranges when calling StorefrontRegularHours., number of items must be greater than or equal to 1.');
        }
