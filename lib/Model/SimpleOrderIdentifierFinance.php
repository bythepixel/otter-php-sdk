...
/**
 * SimpleOrderIdentifierFinance Class Doc Comment
 *
 * @category Class
 ...
 */
class SimpleOrderIdentifierFinance implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SimpleOrderIdentifierFinance';
