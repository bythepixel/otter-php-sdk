...
/**
 * SimpleFinanceLine Class Doc Comment
 *
 * @category Class
 ...
 */
class SimpleFinanceLine implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SimpleFinanceLine';
    ...
    public const SUB_TYPE_VALUE = 'VALUE';
    public const SUB_TYPE_TAX = 'TAX';
    public const SUB_TYPE_VALUE_WITH_TAX = 'VALUE_WITH_TAX';
    public const SUB_TYPE_VAT = 'VAT';
     ...
     * Sets sub_type
     *
     * @param string $sub_type type of the finance line.
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string $name name of the finance line.
     *
     * @return self
     */
