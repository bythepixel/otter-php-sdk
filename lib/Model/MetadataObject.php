 ...
 */
class MetadataObject implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MetadataObject';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('resource_href', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets store_id
     *
     * @param string|null $store_id The unique identifier of the store in the partner application. This ID, along with the `Application ID`, will be used to match the correct store when performing operations. It cannot be longer than 255 characters and must only contain printable ASCII characters.
     *
     * @return self
     */
     ...
     * Sets application_id
     *
     * @param string|null $application_id The plain-text Application ID, provided at partner onboarding, also available on Developer Portal.
     *
     * @return self
     */
     ...
     * Sets resource_id
     *
     * @param string|null $resource_id Identifier of the resource that this event refers to, if needed.
     *
     * @return self
     */
     ...
     * Sets payload
     *
     * @param object|null $payload Object containing details of the given event, if needed.
     *
     * @return self
     */
    ...
    {
        return $this->container['resource_href'];
    }

    /**
     * Sets resource_href
     *
     * @param string|null $resource_href The full endpoint to fetch the details of the resource, if needed.
     *
     * @return self
     */
    public function setResourceHref($resource_href)
    {
        if (is_null($resource_href)) {
            throw new \InvalidArgumentException('non-nullable resource_href cannot be null');
        }
        $this->container['resource_href'] = $resource_href;
