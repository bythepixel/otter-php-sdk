...
class MetadataObject implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['resource_href'] = $data['resource_href'] ?? null;
    }
     ...
     * Sets store_id
     *
     * @param string|null $store_id The unique identifier of the store on `Partner Application`. This ID, along with the `Application ID`, will be used to match the correct store when performing operations. It cannot be longer than 255 characters and must only contain printable ASCII characters.
     *
     * @return self
     */
