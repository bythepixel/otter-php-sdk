...
class CustomerPaymentV2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->container['customer_payment_due'] = $data['customer_payment_due'] ?? null;
        $this->container['customer_prepayment'] = $data['customer_prepayment'] ?? null;
        $this->container['customer_amount_to_return'] = $data['customer_amount_to_return'] ?? null;
        $this->container['payment_due_to_restaurant'] = $data['payment_due_to_restaurant'] ?? null;
    }
     ...
     *
     * @param float|null $customer_payment_due payment due by customer.
     *
     * @return self
     */
     ...
     *
     * @param float|null $customer_prepayment amount pre-paid by customer.
     *
     * @return self
     */
     ...
     *
     * @param float|null $customer_amount_to_return amount to return to customer.
     *
     * @return self
     */
     ...
     *
     * @param float|null $payment_due_to_restaurant payment due to the restaurant.
     *
     * @return self
     */
