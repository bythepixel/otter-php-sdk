...
/**
 * MenuPublishResponseMenuPublishTargets Class Doc Comment
 *
 * @category Class
 ...
 */
class MenuPublishResponseMenuPublishTargets implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MenuPublishResponseMenuPublishTargets';
    ...
    protected static $openAPITypes = [
        'menu_publish_targets' => 'array<string,\OpenAPI\Client\Model\MenuPublishTarget>'
    ];
    ...
    */
     ...
     *
     * @return array<string,\OpenAPI\Client\Model\MenuPublishTarget>|null
     */
     ...
     *
     * @param array<string,\OpenAPI\Client\Model\MenuPublishTarget>|null $menu_publish_targets Map of MenuPublishTarget names to their targets. The target can only be published to if the status is READY.
     *
     * @return self
     */
    public function setMenuPublishTargets($menu_publish_targets)
    {
        ...
        if (is_null($menu_publish_targets)) {
            throw new \InvalidArgumentException('non-nullable menu_publish_targets cannot be null');
        }
