...
/**
 * PictureRequirement Class Doc Comment
 *
 * @category Class
 ...
 */
class PictureRequirement implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PictureRequirement';
    ...
    */
     ...
     * Sets enabled
     *
     * @param bool|null $enabled Marks the picture requirement as required.
     *
     * @return self
     */
