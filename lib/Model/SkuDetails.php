...
class SkuDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->container['sku_slug'] = $data['sku_slug'] ?? null;
        $this->container['barcodes'] = $data['barcodes'] ?? null;
        $this->container['dietary_classifications'] = $data['dietary_classifications'] ?? null;
        $this->container['allergen_classifications'] = $data['allergen_classifications'] ?? null;
        $this->container['contains_alcohol'] = $data['contains_alcohol'] ?? null;
        $this->container['nutritional_info'] = $data['nutritional_info'] ?? null;
