...
/**
 * OrderExternalIdentifiers Class Doc Comment
 *
 * @category Class
 ...
 */
class OrderExternalIdentifiers implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OrderExternalIdentifiers';
    ...
    protected static $openAPITypes = [
        ...
        'source' => 'string',
        'source_type' => 'string',
        'source_external_identifiers' => '\OpenAPI\Client\Model\SourceExternalIdentifiers'
    ];
    ...
    protected static $openAPIFormats = [
        ...
        'source' => null,
        'source_type' => null,
        'source_external_identifiers' => null
    ];
    ...
    protected static array $openAPINullables = [
		...
		'source' => true,
		'source_type' => true,
		'source_external_identifiers' => true
    ];
    ...
    protected static $setters = [
        ...
        'source_external_identifiers' => 'setSourceExternalIdentifiers'
    ];
    ...
    protected static $getters = [
        ...
        'source_external_identifiers' => 'getSourceExternalIdentifiers'
    ];
    ...
    public const SOURCE_TYPE_POINT_OF_SALE = 'POINT_OF_SALE';
    public const SOURCE_TYPE_ORDERING_MARKETPLACE = 'ORDERING_MARKETPLACE';
    public const SOURCE_TYPE_AGGREGATOR = 'AGGREGATOR';
    ...
    {
        return [
            self::SOURCE_TYPE_POINT_OF_SALE,
            self::SOURCE_TYPE_ORDERING_MARKETPLACE,
            self::SOURCE_TYPE_AGGREGATOR,
        ];
    }
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('friendly_id', $data ?? [], null);
        $this->setIfExists('source', $data ?? [], null);
        $this->setIfExists('source_type', $data ?? [], null);
        $this->setIfExists('source_external_identifiers', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['friendly_id'] === null) {
            $invalidProperties[] = "'friendly_id' can't be null";
        }
     ...
     * Sets id
     *
     * @param string $id Unique ID for the order that was placed.
     *
     * @return self
     */
     ...
     * Sets friendly_id
     *
     * @param string $friendly_id ID used for driver pickup and restaurant management.
     *
     * @return self
     */
    public function setFriendlyId($friendly_id)
    {
        if (is_null($friendly_id)) {
            throw new \InvalidArgumentException('non-nullable friendly_id cannot be null');
        }
     ...
     * Sets source
     *
     * @param string|null $source Describes the source of the order, typically from a food ordering marketplace.
     *
     * @return self
     */
     ...
     * Sets source_type
     *
     * @param string|null $source_type source type of the order
     *
     * @return self
     */
    ...
    /**
     * Gets source_external_identifiers
     *
     * @return \OpenAPI\Client\Model\SourceExternalIdentifiers|null
     */
    public function getSourceExternalIdentifiers()
    {
        return $this->container['source_external_identifiers'];
    }

    /**
     * Sets source_external_identifiers
     *
     * @param \OpenAPI\Client\Model\SourceExternalIdentifiers|null $source_external_identifiers source_external_identifiers
     *
     * @return self
     */
    public function setSourceExternalIdentifiers($source_external_identifiers)
    {
        if (is_null($source_external_identifiers)) {
            array_push($this->openAPINullablesSetToNull, 'source_external_identifiers');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('source_external_identifiers', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['source_external_identifiers'] = $source_external_identifiers;
