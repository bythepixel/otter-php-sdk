...
/**
 * OrderHandedOffEvent Class Doc Comment
 *
 * @category Class
 ...
 */
class OrderHandedOffEvent implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OrderHandedOffEvent';
    ...
    protected static $openAPITypes = [
        ...
        'courier_body_temp_fahrenheit' => 'float',
        'is_courier_wearing_mask' => 'bool'
    ];
    ...
    protected static $openAPIFormats = [
        'order_id' => null,
        'courier_phone' => null,
        'courier_body_temp_fahrenheit' => null,
        'is_courier_wearing_mask' => null
    ];
    ...
    protected static array $openAPINullables = [
        'order_id' => false,
		'courier_phone' => true,
		'courier_body_temp_fahrenheit' => true,
		'is_courier_wearing_mask' => true
    ];
    ...
    protected static $attributeMap = [
        ...
        'courier_body_temp_fahrenheit' => 'courierBodyTempFahrenheit',
        'is_courier_wearing_mask' => 'isCourierWearingMask'
    ];
    ...
    protected static $setters = [
        ...
        'courier_body_temp_fahrenheit' => 'setCourierBodyTempFahrenheit',
        'is_courier_wearing_mask' => 'setIsCourierWearingMask'
    ];
    ...
    protected static $getters = [
        ...
        'courier_body_temp_fahrenheit' => 'getCourierBodyTempFahrenheit',
        'is_courier_wearing_mask' => 'getIsCourierWearingMask'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('courier_body_temp_fahrenheit', $data ?? [], null);
        $this->setIfExists('is_courier_wearing_mask', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets order_id
     *
     * @param string|null $order_id Unique ID for the order that was placed.
     *
     * @return self
     */
     ...
     * Sets courier_phone
     *
     * @param string|null $courier_phone The phone number of the courier.
     *
     * @return self
     */
    ...
    /**
     * Gets courier_body_temp_fahrenheit
     *
     * @return float|null
     */
    public function getCourierBodyTempFahrenheit()
    {
        return $this->container['courier_body_temp_fahrenheit'];
    }

    /**
     * Sets courier_body_temp_fahrenheit
     *
     * @param float|null $courier_body_temp_fahrenheit The temperature of the courier in fahrenheit.
     *
     * @return self
     */
    public function setCourierBodyTempFahrenheit($courier_body_temp_fahrenheit)
    {
        if (is_null($courier_body_temp_fahrenheit)) {
            array_push($this->openAPINullablesSetToNull, 'courier_body_temp_fahrenheit');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('courier_body_temp_fahrenheit', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['courier_body_temp_fahrenheit'] = $courier_body_temp_fahrenheit;

        return $this;
    }

    /**
     * Gets is_courier_wearing_mask
     *
     * @return bool|null
     */
    public function getIsCourierWearingMask()
    {
        return $this->container['is_courier_wearing_mask'];
    }

    /**
     * Sets is_courier_wearing_mask
     *
     * @param bool|null $is_courier_wearing_mask Whether or not the courier is wearing a mask.
     *
     * @return self
     */
    public function setIsCourierWearingMask($is_courier_wearing_mask)
    {
        if (is_null($is_courier_wearing_mask)) {
            array_push($this->openAPINullablesSetToNull, 'is_courier_wearing_mask');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('is_courier_wearing_mask', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['is_courier_wearing_mask'] = $is_courier_wearing_mask;
