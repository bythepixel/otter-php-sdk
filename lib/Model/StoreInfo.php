...
class StoreInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $setters = [
        ...
        'internal_store_id' => 'setInternalStoreId'
    ];
    ...
    protected static $getters = [
        ...
        'internal_store_id' => 'getInternalStoreId'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('internal_store_id', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['internal_store_id'] === null) {
            $invalidProperties[] = "'internal_store_id' can't be null";
        }
     ...
     * Sets currency_code
     *
     * @param string $currency_code The currency code for the store.
     *
     * @return self
     */
     ...
     * Sets timezone
     *
     * @param string $timezone The store timezone.
     *
     * @return self
     */
    ...
    /**
     * Gets internal_store_id
     *
     * @return string
     */
    public function getInternalStoreId()
    {
        return $this->container['internal_store_id'];
    }

    /**
     * Sets internal_store_id
     *
     * @param string $internal_store_id Our internal store identifier, also known as \"SkuSku ID\".
     *
     * @return self
     */
    public function setInternalStoreId($internal_store_id)
    {

        if (is_null($internal_store_id)) {
            throw new \InvalidArgumentException('non-nullable internal_store_id cannot be null');
        }

        $this->container['internal_store_id'] = $internal_store_id;
