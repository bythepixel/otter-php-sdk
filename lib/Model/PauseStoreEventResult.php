...
/**
 * PauseStoreEventResult Class Doc Comment
 *
 * @category Class
 ...
 */
class PauseStoreEventResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PauseStoreEventResult';
    ...
    protected static $openAPITypes = [
        'closure_id' => 'string',
        'event_result_metadata' => '\OpenAPI\Client\Model\RequiredEventResultMetadata'
    ];
    ...
    {
        $this->setIfExists('closure_id', $data ?? [], null);
    ...
    */
    ...
    {
        return $this->container['closure_id'];
    }

    /**
     * Sets closure_id
     *
     * @param string|null $closure_id ID required to unpause a store, if available
     *
     * @return self
     */
    public function setClosureId($closure_id)
    {

        if (is_null($closure_id)) {
            throw new \InvalidArgumentException('non-nullable closure_id cannot be null');
        }

        $this->container['closure_id'] = $closure_id;
     ...
     *
     * @return \OpenAPI\Client\Model\RequiredEventResultMetadata|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\RequiredEventResultMetadata|null $event_result_metadata event_result_metadata
     *
     * @return self
     */
    public function setEventResultMetadata($event_result_metadata)
    {
        ...
        if (is_null($event_result_metadata)) {
            throw new \InvalidArgumentException('non-nullable event_result_metadata cannot be null');
        }
