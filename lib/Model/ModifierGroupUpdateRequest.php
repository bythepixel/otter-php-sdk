...
/**
 * ModifierGroupUpdateRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class ModifierGroupUpdateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ModifierGroupUpdateRequest';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['minimum_selections'] = $data['minimum_selections'] ?? null;
        $this->container['maximum_selections'] = $data['maximum_selections'] ?? null;
        $this->container['max_per_modifier_selection_quantity'] = $data['max_per_modifier_selection_quantity'] ?? null;
     ...
     * Sets id
     *
     * @param string $id Identifier for ModifierGroup.
     *
     * @return self
     */
    ...
    public function setMinimumSelections($minimum_selections)
    {
        ...
        if (!is_null($minimum_selections) && ($minimum_selections < 0)) {
            throw new \InvalidArgumentException('invalid value for $minimum_selections when calling ModifierGroupUpdateRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setMaximumSelections($maximum_selections)
    {
        ...
        if (!is_null($maximum_selections) && ($maximum_selections < 0)) {
            throw new \InvalidArgumentException('invalid value for $maximum_selections when calling ModifierGroupUpdateRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setMaxPerModifierSelectionQuantity($max_per_modifier_selection_quantity)
    {
        ...
        if (!is_null($max_per_modifier_selection_quantity) && ($max_per_modifier_selection_quantity < 0)) {
            throw new \InvalidArgumentException('invalid value for $max_per_modifier_selection_quantity when calling ModifierGroupUpdateRequest., must be bigger than or equal to 0.');
        }
     ...
     * Sets description
     *
     * @param string|null $description Description for this ModifierGroup.
     *
     * @return self
     */
