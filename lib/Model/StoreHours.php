 ...
 */
class StoreHours implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'StoreHours';
    ...
    protected static $openAPITypes = [
        'regular_hours' => '\OpenAPI\Client\Model\StorefrontRegularHours[]',
        'special_hours' => '\OpenAPI\Client\Model\StorefrontSpecialHours[]'
    ];
    ...
    */
     ...
     * Gets regular_hours
     *
     * @return \OpenAPI\Client\Model\StorefrontRegularHours[]|null
     */
     ...
     * Sets regular_hours
     *
     * @param \OpenAPI\Client\Model\StorefrontRegularHours[]|null $regular_hours List of regular hours configuration.
     *
     * @return self
     */
     ...
     * Gets special_hours
     *
     * @return \OpenAPI\Client\Model\StorefrontSpecialHours[]|null
     */
     ...
     * Sets special_hours
     *
     * @param \OpenAPI\Client\Model\StorefrontSpecialHours[]|null $special_hours List of special hours configuration.
     *
     * @return self
     */
    public function setSpecialHours($special_hours)
    {
        ...
        if (is_null($special_hours)) {
            array_push($this->openAPINullablesSetToNull, 'special_hours');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('special_hours', $nullablesSetToNull);
            if ($index !== FALSE) {
