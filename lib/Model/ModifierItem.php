 ...
 */
class ModifierItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'price' => 'float',
        'quantity' => 'float',
        'modifiers' => '\OpenAPI\Client\Model\ModifierItem[]'
    ];
    ...
    */
     ...
     * Sets modifier_id
     *
     * @param string|null $modifier_id ID for this modifier.
     *
     * @return self
     */
    public function setModifierId($modifier_id)
    {
        if (is_null($modifier_id)) {
            array_push($this->openAPINullablesSetToNull, 'modifier_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('modifier_id', $nullablesSetToNull);
            if ($index !== FALSE) {
     ...
     * Sets name
     *
     * @param string|null $name Human-readable name for this modifier.
     *
     * @return self
     */
     ...
     * Sets price
     *
     * @param float|null $price Per-unit price of this modifier.
     *
     * @return self
     */
     ...
     * Sets quantity
     *
     * @param float|null $quantity Number of units of this modifier being added to the item.
     *
     * @return self
     */
     ...
     * Sets modifiers
     *
     * @param \OpenAPI\Client\Model\ModifierItem[]|null $modifiers Nested modifier items.
     *
     * @return self
     */
