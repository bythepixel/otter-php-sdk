...
class DeliveryCost implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('extra_cost', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets base_cost
     *
     * @param float|null $base_cost Base delivery cost value.
     *
     * @return self
     */
     ...
     * Sets extra_cost
     *
     * @param float|null $extra_cost Extra delivery cost value.
     *
     * @return self
     */
    public function setExtraCost($extra_cost)
    {
        ...
        if (is_null($extra_cost)) {
            throw new \InvalidArgumentException('non-nullable extra_cost cannot be null');
        }
