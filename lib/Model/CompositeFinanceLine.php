...
/**
 * CompositeFinanceLine Class Doc Comment
 *
 * @category Class
 ...
 */
class CompositeFinanceLine implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CompositeFinanceLine';
    ...
    */
    ...
    public function setBreakdown($breakdown)
    {
        ...
        if ((count($breakdown) < 1)) {
            throw new \InvalidArgumentException('invalid length for $breakdown when calling CompositeFinanceLine., number of items must be greater than or equal to 1.');
        }
