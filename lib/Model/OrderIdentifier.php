 ...
 */
class OrderIdentifier implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets source
     *
     * @param string $source Describes the source of the order, typically from a food ordering marketplace.
     *
     * @return self
     */
