...
/**
 * UpsertStorelinkEvent Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class UpsertStorelinkEvent implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpsertStorelinkEvent';
    ...
    protected static $openAPITypes = [
        'credentials_schema_version' => 'string',
        'credentials' => '\OpenAPI\Client\Model\FulfilledCredential[]',
    ...
    protected static $openAPIFormats = [
        'credentials_schema_version' => null,
        'credentials' => null,
        'store_info' => null
    ];
    ...
    protected static array $openAPINullables = [
        'credentials_schema_version' => false,
		'credentials' => false,
		'store_info' => false
    ];
    ...
    protected static $attributeMap = [
        'credentials_schema_version' => 'credentialsSchemaVersion',
    ...
    protected static $setters = [
        'credentials_schema_version' => 'setCredentialsSchemaVersion',
    ...
    protected static $getters = [
        'credentials_schema_version' => 'getCredentialsSchemaVersion',
    ...
    {
        $this->setIfExists('credentials_schema_version', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['credentials_schema_version'] === null) {
            $invalidProperties[] = "'credentials_schema_version' can't be null";
        }
        if ($this->container['credentials'] === null) {
            $invalidProperties[] = "'credentials' can't be null";
        }
        if ($this->container['store_info'] === null) {
            $invalidProperties[] = "'store_info' can't be null";
        }
    ...
    /**
     * Gets credentials_schema_version
     *
     * @return string
     */
    public function getCredentialsSchemaVersion()
    {
        return $this->container['credentials_schema_version'];
    }

    /**
     * Sets credentials_schema_version
     *
     * @param string $credentials_schema_version The version of the credentials schema.
     *
     * @return self
     */
    public function setCredentialsSchemaVersion($credentials_schema_version)
    {

        if (is_null($credentials_schema_version)) {
            throw new \InvalidArgumentException('non-nullable credentials_schema_version cannot be null');
        }

        $this->container['credentials_schema_version'] = $credentials_schema_version;
     ...
     * Gets credentials
     *
     * @return \OpenAPI\Client\Model\FulfilledCredential[]
     */
     ...
     * Sets credentials
     *
     * @param \OpenAPI\Client\Model\FulfilledCredential[] $credentials Array of fulfilled credentials containing its keys and values.
     *
     * @return self
     */
     ...
     * Gets store_info
     *
     * @return \OpenAPI\Client\Model\StoreInfo
     */
     ...
     * Sets store_info
     *
     * @param \OpenAPI\Client\Model\StoreInfo $store_info store_info
     *
     * @return self
     */
