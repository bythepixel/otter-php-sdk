...
/**
 * RequestDeliveryQuoteCallbackRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class RequestDeliveryQuoteCallbackRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RequestDeliveryQuoteCallbackRequest';
    ...
    protected static $openAPITypes = [
        'min_pickup_duration' => 'int',
        'max_pickup_duration' => 'int',
    ...
    protected static $openAPIFormats = [
        'min_pickup_duration' => 'int32',
        'max_pickup_duration' => 'int32',
    ...
    protected static array $openAPINullables = [
        'min_pickup_duration' => false,
		'max_pickup_duration' => true,
    ...
    protected static $attributeMap = [
        'min_pickup_duration' => 'minPickupDuration',
        'max_pickup_duration' => 'maxPickupDuration',
    ...
    protected static $setters = [
        'min_pickup_duration' => 'setMinPickupDuration',
        'max_pickup_duration' => 'setMaxPickupDuration',
    ...
    protected static $getters = [
        'min_pickup_duration' => 'getMinPickupDuration',
        'max_pickup_duration' => 'getMaxPickupDuration',
    ...
    {
        $this->setIfExists('min_pickup_duration', $data ?? [], null);
        $this->setIfExists('max_pickup_duration', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['min_pickup_duration']) && ($this->container['min_pickup_duration'] < 0)) {
            $invalidProperties[] = "invalid value for 'min_pickup_duration', must be bigger than or equal to 0.";
        }
    ...
    /**
     * Gets min_pickup_duration
     *
     * @return int|null
     */
    public function getMinPickupDuration()
    {
        return $this->container['min_pickup_duration'];
    }

    /**
     * Sets min_pickup_duration
     *
     * @param int|null $min_pickup_duration Minimum time required for courier to arrive at pickup location in minutes It is an estimation.
     *
     * @return self
     */
    public function setMinPickupDuration($min_pickup_duration)
    {

        if (!is_null($min_pickup_duration) && ($min_pickup_duration < 0)) {
            throw new \InvalidArgumentException('invalid value for $min_pickup_duration when calling RequestDeliveryQuoteCallbackRequest., must be bigger than or equal to 0.');
        }


        if (is_null($min_pickup_duration)) {
            throw new \InvalidArgumentException('non-nullable min_pickup_duration cannot be null');
        }

        $this->container['min_pickup_duration'] = $min_pickup_duration;

        return $this;
    }

    /**
     * Gets max_pickup_duration
     *
     * @return int|null
     */
    public function getMaxPickupDuration()
    {
        return $this->container['max_pickup_duration'];
    }

    /**
     * Sets max_pickup_duration
     *
     * @param int|null $max_pickup_duration Maximum time that the courier's arrival at pick up location can be delayed. If not provided, it will default to 60 minutes or minPickUpDuration, whichever is greater. This value is an estimation and expressed in minutes.
     *
     * @return self
     */
    public function setMaxPickupDuration($max_pickup_duration)
    {

        if (is_null($max_pickup_duration)) {
            array_push($this->openAPINullablesSetToNull, 'max_pickup_duration');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('max_pickup_duration', $nullablesSetToNull);
            if ($index !== FALSE) {
        ...
        $this->container['max_pickup_duration'] = $max_pickup_duration;
    ...
    public function setCurrencyCode($currency_code)
    {
        if (!is_null($currency_code) && (mb_strlen($currency_code) > 3)) {
            throw new \InvalidArgumentException('invalid length for $currency_code when calling RequestDeliveryQuoteCallbackRequest., must be smaller than or equal to 3.');
        }
        if (!is_null($currency_code) && (mb_strlen($currency_code) < 3)) {
            throw new \InvalidArgumentException('invalid length for $currency_code when calling RequestDeliveryQuoteCallbackRequest., must be bigger than or equal to 3.');
        }
     ...
     * Sets created_at
     *
     * @param \DateTime|null $created_at The time that the quote was created.
     *
     * @return self
     */
     ...
     *
     * @param float|null $account_balance The remaining account balance of the requester for the delivery provider.
     *
     * @return self
     */
