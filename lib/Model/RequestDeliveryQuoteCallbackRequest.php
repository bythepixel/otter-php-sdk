...
class RequestDeliveryQuoteCallbackRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->container['min_pickup_duration'] = $data['min_pickup_duration'] ?? null;
        $this->container['max_pickup_duration'] = $data['max_pickup_duration'] ?? null;
        $this->container['delivery_distance'] = $data['delivery_distance'] ?? null;
        ...
        $this->container['account_balance'] = $data['account_balance'] ?? null;
    }
     ...
     *
     * @param int|null $max_pickup_duration Maximum time that the courier's arrival at pick up location can be delayed. If not provided, we will treat as if there is no limit. This value is an estimation and expressed in minutes.
     *
     * @return self
     */
