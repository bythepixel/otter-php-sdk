...
class Hours implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'intervals' => '\OpenAPI\Client\Model\HourInterval[]'
    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if ((count($this->container['intervals']) < 1)) {
            $invalidProperties[] = "invalid value for 'intervals', number of items must be greater than or equal to 1.";
        }
     ...
     * Gets intervals
     *
     * @return \OpenAPI\Client\Model\HourInterval[]
     */
     ...
     * Sets intervals
     *
     * @param \OpenAPI\Client\Model\HourInterval[] $intervals List of HourIntervals.
     *
     * @return self
     */
    public function setIntervals($intervals)
    {
        ...
        if ((count($intervals) < 1)) {
            throw new \InvalidArgumentException('invalid length for $intervals when calling Hours., number of items must be greater than or equal to 1.');
        }
