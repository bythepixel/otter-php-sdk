...
/**
 * FinancialDataPackingFee Class Doc Comment
 *
 * @category Class
 ...
 */
class FinancialDataPackingFee implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FinancialData_packingFee';
    ...
    */
    ...
    public function setBreakdown($breakdown)
    {
        ...
        if ((count($breakdown) < 1)) {
            throw new \InvalidArgumentException('invalid length for $breakdown when calling FinancialDataPackingFee., number of items must be greater than or equal to 1.');
        }
