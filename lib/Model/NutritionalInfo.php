...
/**
 * NutritionalInfo Class Doc Comment
 *
 * @category Class
 ...
 */
class NutritionalInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NutritionalInfo';
    ...
    protected static $openAPITypes = [
        'energy_kcal' => '\OpenAPI\Client\Model\EnergyKcal'
    ];
    ...
    {
        $this->setIfExists('energy_kcal', $data ?? [], null);
    }
    ...
    */
     ...
     * Gets energy_kcal
     *
     * @return \OpenAPI\Client\Model\EnergyKcal|null
     */
    public function getEnergyKcal()
    {
        return $this->container['energy_kcal'];
    }

    /**
     * Sets energy_kcal
     *
     * @param \OpenAPI\Client\Model\EnergyKcal|null $energy_kcal energy_kcal
     *
     * @return self
     */
    public function setEnergyKcal($energy_kcal)
    {
        if (is_null($energy_kcal)) {
            throw new \InvalidArgumentException('non-nullable energy_kcal cannot be null');
        }
        $this->container['energy_kcal'] = $energy_kcal;
