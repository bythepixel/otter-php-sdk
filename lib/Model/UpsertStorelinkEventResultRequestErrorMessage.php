...
/**
 * UpsertStorelinkEventResultRequestErrorMessage Class Doc Comment
 *
 * @category Class
 ...
 */
class UpsertStorelinkEventResultRequestErrorMessage implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpsertStorelinkEventResultRequest_errorMessage';
    ...
    */
     ...
     * Sets message
     *
     * @param string|null $message The error description.
     *
     * @return self
     */
     ...
     * Sets details
     *
     * @param \OpenAPI\Client\Model\ErrorDetail[]|null $details The error details.
     *
     * @return self
     */
