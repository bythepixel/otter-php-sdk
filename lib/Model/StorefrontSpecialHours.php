...
/**
 * StorefrontSpecialHours Class Doc Comment
 *
 * @category Class
 ...
 */
class StorefrontSpecialHours implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Storefront_SpecialHours';
    ...
    protected static $openAPITypes = [
        'date' => '\DateTime',
        'time_ranges' => '\OpenAPI\Client\Model\StorefrontTimeRange[]',
        'special_hour_type' => 'string'
    ];
    ...
    protected static $setters = [
        ...
        'special_hour_type' => 'setSpecialHourType'
    ];
    ...
    protected static $getters = [
        ...
        'special_hour_type' => 'getSpecialHourType'
    ];
    ...
    public const SPECIAL_HOUR_TYPE_OPEN = 'OPEN';
    public const SPECIAL_HOUR_TYPE_CLOSED = 'CLOSED';
     ...
     * @return string[]
     */
    public function getSpecialHourTypeAllowableValues()
    {
        return [
            self::SPECIAL_HOUR_TYPE_OPEN,
            self::SPECIAL_HOUR_TYPE_CLOSED,
        ];
    }
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('special_hour_type', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['time_ranges'] === null) {
            $invalidProperties[] = "'time_ranges' can't be null";
        }
        if ((count($this->container['time_ranges']) < 1)) {
            $invalidProperties[] = "invalid value for 'time_ranges', number of items must be greater than or equal to 1.";
        }

        if ($this->container['special_hour_type'] === null) {
            $invalidProperties[] = "'special_hour_type' can't be null";
        }
        $allowedValues = $this->getSpecialHourTypeAllowableValues();
        if (!is_null($this->container['special_hour_type']) && !in_array($this->container['special_hour_type'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'special_hour_type', must be one of '%s'",
                $this->container['special_hour_type'],
     ...
     * Sets date
     *
     * @param \DateTime $date Date the special hour configuration applies.
     *
     * @return self
     */
     ...
     * Gets time_ranges
     *
     * @return \OpenAPI\Client\Model\StorefrontTimeRange[]
     */
     ...
     * Sets time_ranges
     *
     * @param \OpenAPI\Client\Model\StorefrontTimeRange[] $time_ranges Hours range applied to configured date.
     *
     * @return self
     */
    public function setTimeRanges($time_ranges)
    {
        ...
        if ((count($time_ranges) < 1)) {
            throw new \InvalidArgumentException('invalid length for $time_ranges when calling StorefrontSpecialHours., number of items must be greater than or equal to 1.');
        }
    ...
    /**
     * Gets special_hour_type
     *
     * @return string
     */
    public function getSpecialHourType()
    {
        return $this->container['special_hour_type'];
    }

    /**
     * Sets special_hour_type
     *
     * @param string $special_hour_type Store state that should be applied during the configured special hour.
     *
     * @return self
     */
    public function setSpecialHourType($special_hour_type)
    {
        if (is_null($special_hour_type)) {
            throw new \InvalidArgumentException('non-nullable special_hour_type cannot be null');
        }
        $allowedValues = $this->getSpecialHourTypeAllowableValues();
        if (!in_array($special_hour_type, $allowedValues, true)) {
        ...
        $this->container['special_hour_type'] = $special_hour_type;
