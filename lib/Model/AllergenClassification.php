...
/**
 * AllergenClassification Class Doc Comment
 *
 * @category Class
 ...
 */
class AllergenClassification implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AllergenClassification';
    ...
    protected static $attributeMap = [
        'tag' => 'tag',
        'contains_allergen' => 'containsAllergen'
    ];
    ...
    protected static $setters = [
        'tag' => 'setTag',
        'contains_allergen' => 'setContainsAllergen'
    ];
    ...
    protected static $getters = [
        'tag' => 'getTag',
        'contains_allergen' => 'getContainsAllergen'
    ];
    ...
    public const TAG_GLUTEN = 'GLUTEN';
    public const TAG_DAIRY = 'DAIRY';
    public const TAG_WHEAT = 'WHEAT';
    public const TAG_RYE = 'RYE';
    public const TAG_BARLEY = 'BARLEY';
    public const TAG_OAT = 'OAT';
    public const TAG_SPELT = 'SPELT';
    public const TAG_KAMUT = 'KAMUT';
    public const TAG_CRUSTACEAN = 'CRUSTACEAN';
    public const TAG_MOLLUSK = 'MOLLUSK';
    public const TAG_EGG = 'EGG';
    public const TAG_FISH = 'FISH';
    public const TAG_PEANUT = 'PEANUT';
    public const TAG_SOYBEAN = 'SOYBEAN';
    public const TAG_NUT = 'NUT';
    public const TAG_ALMOND = 'ALMOND';
    public const TAG_HAZELNUT = 'HAZELNUT';
    public const TAG_WALNUT = 'WALNUT';
    public const TAG_CASHEW = 'CASHEW';
    public const TAG_PECAN = 'PECAN';
    public const TAG_BRAZIL_NUT = 'BRAZIL_NUT';
    public const TAG_PISTACHIO = 'PISTACHIO';
    public const TAG_MACADAMIA_NUT = 'MACADAMIA_NUT';
    public const TAG_QUEENSLAND_NUT = 'QUEENSLAND_NUT';
    public const TAG_LUPIN = 'LUPIN';
    public const TAG_CELERY = 'CELERY';
    public const TAG_MUSTARD = 'MUSTARD';
    public const TAG_SESAME_SEED = 'SESAME_SEED';
    public const TAG_SULFITE = 'SULFITE';
    ...
    public function getTagAllowableValues()
    {
        return [
            ...
            self::TAG_BRAZIL_NUT,
            self::TAG_PISTACHIO,
            self::TAG_MACADAMIA_NUT,
            self::TAG_QUEENSLAND_NUT,
            self::TAG_LUPIN,
            self::TAG_CELERY,
            self::TAG_MUSTARD,
            self::TAG_SESAME_SEED,
            self::TAG_SULFITE,
        ];
    }
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('contains_allergen', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets tag
     *
     * @param string|null $tag The type of allergen classification.
     *
     * @return self
     */
    public function setTag($tag)
    {
        ...
        $allowedValues = $this->getTagAllowableValues();
        if (!in_array($tag, $allowedValues, true)) {
    ...
    /**
     * Gets contains_allergen
     *
     * @return bool|null
     */
    public function getContainsAllergen()
    {
        return $this->container['contains_allergen'];
    }

    /**
     * Sets contains_allergen
     *
     * @param bool|null $contains_allergen Indication of whether or not the product contains this allergen. If the status of the allergen is unknown, a classification should not be provided for this product.
     *
     * @return self
     */
    public function setContainsAllergen($contains_allergen)
    {
        if (is_null($contains_allergen)) {
            throw new \InvalidArgumentException('non-nullable contains_allergen cannot be null');
        }
        $this->container['contains_allergen'] = $contains_allergen;
