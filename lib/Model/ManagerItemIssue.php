...
/**
 * ManagerItemIssue Class Doc Comment
 *
 * @category Class
 ...
 */
class ManagerItemIssue implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ManagerItemIssue';
    ...
    public const CODE_ITEM_MISMATCH = 'ITEM_MISMATCH';
    public const CODE_INCOMPLETE_MENU = 'INCOMPLETE_MENU';
    public const CODE_NO_PARENT_ENTITY = 'NO_PARENT_ENTITY';
    public const CODE_MULTIPLE_PARENT_ENTITIES = 'MULTIPLE_PARENT_ENTITIES';
    public const CODE_MISCONFIGURED_INTEGRATION = 'MISCONFIGURED_INTEGRATION';
    public const CODE_INVALID_PARENT_ENTITY_SETUP = 'INVALID_PARENT_ENTITY_SETUP';
    public const CODE_CATEGORY_MISSING = 'CATEGORY_MISSING';
    public const CODE_EXTERNAL_MODIFIER_GROUP_MISSING = 'EXTERNAL_MODIFIER_GROUP_MISSING';
    public const CODE_INTERNAL_MODIFIER_GROUP_MISSING = 'INTERNAL_MODIFIER_GROUP_MISSING';
    ...
    public function getCodeAllowableValues()
    {
        return [
            self::CODE_UNKNOWN,
            self::CODE_ITEM_MISMATCH,
            self::CODE_INCOMPLETE_MENU,
            self::CODE_NO_PARENT_ENTITY,
            self::CODE_MULTIPLE_PARENT_ENTITIES,
            self::CODE_MISCONFIGURED_INTEGRATION,
            self::CODE_INVALID_PARENT_ENTITY_SETUP,
