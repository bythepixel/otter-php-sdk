...
/**
 * UploadPastOrdersResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class UploadPastOrdersResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UploadPastOrdersResponse';
    ...
    protected static $openAPITypes = [
        'order_references' => '\OpenAPI\Client\Model\OrderReference[]'
    ];
    ...
    */
     ...
     *
     * @return \OpenAPI\Client\Model\OrderReference[]
     */
     ...
     *
     * @param \OpenAPI\Client\Model\OrderReference[] $order_references References for orders that were successfully uploaded.
     *
     * @return self
     */
