...
/**
 * OrderWithPosInfo Class Doc Comment
 *
 * @category Class
 ...
 */
class OrderWithPosInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OrderWithPosInfo';
    ...
    protected static $openAPITypes = [
        ...
        'pos_order_cancel_details' => '\OpenAPI\Client\Model\PosOrderCancelDetails',
        'injection_event' => 'string',
        'pos_order_issues' => '\OpenAPI\Client\Model\PosOrderIssues'
    ];
    ...
    protected static $openAPIFormats = [
        ...
        'pos_order_cancel_details' => null,
        'injection_event' => null,
        'pos_order_issues' => null
    ];
    ...
    protected static array $openAPINullables = [
		...
		'pos_order_cancel_details' => false,
		'injection_event' => false,
		'pos_order_issues' => false
    ];
    ...
    protected static $attributeMap = [
        ...
        'pos_order_cancel_details' => 'posOrderCancelDetails',
        'injection_event' => 'injectionEvent',
        'pos_order_issues' => 'posOrderIssues'
    ];
    ...
    protected static $setters = [
        ...
        'pos_order_cancel_details' => 'setPosOrderCancelDetails',
        'injection_event' => 'setInjectionEvent',
        'pos_order_issues' => 'setPosOrderIssues'
    ];
    ...
    protected static $getters = [
        ...
        'pos_order_cancel_details' => 'getPosOrderCancelDetails',
        'injection_event' => 'getInjectionEvent',
        'pos_order_issues' => 'getPosOrderIssues'
    ];
    ...
    public const INJECTION_STATE_INJECTION_STATE_UNKNOWN = 'INJECTION_STATE_UNKNOWN';
    public const INJECTION_STATE_INJECTION_PENDING = 'INJECTION_PENDING';
    public const INJECTION_STATE_INJECTION_SUCCEEDED = 'INJECTION_SUCCEEDED';
    public const INJECTION_STATE_INJECTION_FAILED_ATTEMPT = 'INJECTION_FAILED_ATTEMPT';
    public const INJECTION_STATE_INJECTION_MANUAL_INJECTION_SUCCEEDED = 'INJECTION_MANUAL_INJECTION_SUCCEEDED';
    public const INJECTION_STATE_INJECTION_MANUAL_INJECTION_REQUIRED = 'INJECTION_MANUAL_INJECTION_REQUIRED';
    public const INJECTION_STATE_INJECTION_SUCCEEDED_WITH_OPEN_ITEMS = 'INJECTION_SUCCEEDED_WITH_OPEN_ITEMS';
    public const INJECTION_STATE_INJECTED_ORDER_CANCELED = 'INJECTED_ORDER_CANCELED';
    public const INJECTION_STATE_INJECTED_ORDER_CANCEL_FAILED = 'INJECTED_ORDER_CANCEL_FAILED';
    public const INJECTION_STATE_INJECTED_ORDER_REJECTED = 'INJECTED_ORDER_REJECTED';
    public const INJECTION_STATE_INJECTED_ORDER_REJECT_FAILED = 'INJECTED_ORDER_REJECT_FAILED';
    ...
    public const INJECTION_EVENT_UNKNOWN = 'INJECTION_EVENT_UNKNOWN';
    public const INJECTION_EVENT_ORDER_CREATE = 'INJECTION_EVENT_ORDER_CREATE';
    public const INJECTION_EVENT_ORDER_ACCEPT = 'INJECTION_EVENT_ORDER_ACCEPT';
    public const INJECTION_EVENT_ORDER_IMPORT = 'INJECTION_EVENT_ORDER_IMPORT';
    public const INJECTION_EVENT_ORDER_RE_INJECT = 'INJECTION_EVENT_ORDER_RE_INJECT';
    ...
    {
        return [
            self::INJECTION_STATE_INJECTION_STATE_UNKNOWN,
            self::INJECTION_STATE_INJECTION_PENDING,
            self::INJECTION_STATE_INJECTION_SUCCEEDED,
            self::INJECTION_STATE_INJECTION_FAILED_ATTEMPT,
            self::INJECTION_STATE_INJECTION_MANUAL_INJECTION_SUCCEEDED,
            self::INJECTION_STATE_INJECTION_MANUAL_INJECTION_REQUIRED,
            self::INJECTION_STATE_INJECTION_SUCCEEDED_WITH_OPEN_ITEMS,
            self::INJECTION_STATE_INJECTED_ORDER_CANCELED,
            self::INJECTION_STATE_INJECTED_ORDER_CANCEL_FAILED,
            self::INJECTION_STATE_INJECTED_ORDER_REJECTED,
            self::INJECTION_STATE_INJECTED_ORDER_REJECT_FAILED,
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('pos_order_cancel_details', $data ?? [], null);
        $this->setIfExists('injection_event', $data ?? [], null);
        $this->setIfExists('pos_order_issues', $data ?? [], null);
    }
    ...
    */
     ...
     *
     * @param string $injection_state Current Pos injection state
     *
     * @return self
     */
    ...
    /**
     * Gets pos_order_cancel_details
     *
     * @return \OpenAPI\Client\Model\PosOrderCancelDetails|null
     */
    public function getPosOrderCancelDetails()
    {
        return $this->container['pos_order_cancel_details'];
    }

    /**
     * Sets pos_order_cancel_details
     *
     * @param \OpenAPI\Client\Model\PosOrderCancelDetails|null $pos_order_cancel_details pos_order_cancel_details
     *
     * @return self
     */
    public function setPosOrderCancelDetails($pos_order_cancel_details)
    {
        if (is_null($pos_order_cancel_details)) {
            throw new \InvalidArgumentException('non-nullable pos_order_cancel_details cannot be null');
        }
        $this->container['pos_order_cancel_details'] = $pos_order_cancel_details;
     ...
     *
     * @param string $injection_event The order event that triggered order injection into Pos
     *
     * @return self
     */
    ...
    /**
     * Gets pos_order_issues
     *
     * @return \OpenAPI\Client\Model\PosOrderIssues|null
     */
    public function getPosOrderIssues()
    {
        return $this->container['pos_order_issues'];
    }

    /**
     * Sets pos_order_issues
     *
     * @param \OpenAPI\Client\Model\PosOrderIssues|null $pos_order_issues pos_order_issues
     *
     * @return self
     */
    public function setPosOrderIssues($pos_order_issues)
    {
        if (is_null($pos_order_issues)) {
            throw new \InvalidArgumentException('non-nullable pos_order_issues cannot be null');
        }
        $this->container['pos_order_issues'] = $pos_order_issues;
