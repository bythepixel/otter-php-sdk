...
class OrderWithPosInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['injection_state'] = $data['injection_state'] ?? null;
        $this->container['pos_order_cancel_details'] = $data['pos_order_cancel_details'] ?? null;
        $this->container['injection_event'] = $data['injection_event'] ?? null;
        $this->container['pos_order_issues'] = $data['pos_order_issues'] ?? null;
    }
