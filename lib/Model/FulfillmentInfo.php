...
class FulfillmentInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->container['pickup_time'] = $data['pickup_time'] ?? null;
        $this->container['delivery_time'] = $data['delivery_time'] ?? null;
        $this->container['fulfillment_mode'] = $data['fulfillment_mode'] ?? 'DELIVERY';
        $this->container['scheduling_type'] = $data['scheduling_type'] ?? null;
        $this->container['courier_status'] = $data['courier_status'] ?? null;
    }
    ...
    {
        $allowedValues = $this->getFulfillmentModeAllowableValues();
        if (!is_null($fulfillment_mode) && !in_array($fulfillment_mode, $allowedValues, true)) {
