...
/**
 * ListShipmentsResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ListShipmentsResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ListShipmentsResponse';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['shipments']) && (count($this->container['shipments']) > 50)) {
            $invalidProperties[] = "invalid value for 'shipments', number of items must be less than or equal to 50.";
        }
     ...
     * Sets shipments
     *
     * @param \OpenAPI\Client\Model\Shipment[]|null $shipments A list of shipments.
     *
     * @return self
     */
    public function setShipments($shipments)
    {
        ...
        if (!is_null($shipments) && (count($shipments) > 50)) {
            throw new \InvalidArgumentException('invalid value for $shipments when calling ListShipmentsResponse., number of items must be less than or equal to 50.');
        }
