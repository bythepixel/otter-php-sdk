 ...
 */
class PongObject implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PongObject';
     ...
     * Sets response
     *
     * @param string|null $response A text response.
     *
     * @return self
     */
     ...
     * Sets current_time
     *
     * @param \DateTime|null $current_time The current timestamp.
     *
     * @return self
     */
