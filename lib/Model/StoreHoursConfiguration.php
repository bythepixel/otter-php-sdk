...
/**
 * StoreHoursConfiguration Class Doc Comment
 *
 * @category Class
 ...
 */
class StoreHoursConfiguration implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'StoreHoursConfiguration';
    ...
    protected static $openAPITypes = [
        'delivery_hours' => '\OpenAPI\Client\Model\StoreHours',
        'pickup_hours' => '\OpenAPI\Client\Model\StoreHours',
        'timezone' => 'string'
    ];
    ...
    {
        $this->setIfExists('delivery_hours', $data ?? [], null);
        $this->setIfExists('pickup_hours', $data ?? [], null);
    ...
    */
     ...
     * Gets delivery_hours
     *
     * @return \OpenAPI\Client\Model\StoreHours|null
     */
     ...
     * Sets delivery_hours
     *
     * @param \OpenAPI\Client\Model\StoreHours|null $delivery_hours delivery_hours
     *
     * @return self
     */
    public function setDeliveryHours($delivery_hours)
    {
        ...
        if (is_null($delivery_hours)) {
            array_push($this->openAPINullablesSetToNull, 'delivery_hours');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('delivery_hours', $nullablesSetToNull);
            if ($index !== FALSE) {
     ...
     * Sets pickup_hours
     *
     * @param \OpenAPI\Client\Model\StoreHours|null $pickup_hours pickup_hours
     *
     * @return self
     */
    public function setPickupHours($pickup_hours)
    {
        ...
        if (is_null($pickup_hours)) {
            array_push($this->openAPINullablesSetToNull, 'pickup_hours');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('pickup_hours', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Sets timezone
     *
     * @param string $timezone The store time zone identifier. (e.g. America/New_York)
     *
     * @return self
     */
