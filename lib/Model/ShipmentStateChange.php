...
/**
 * ShipmentStateChange Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ShipmentStateChange implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ShipmentStateChange';
    ...
    protected static $openAPITypes = [
        'state' => '\OpenAPI\Client\Model\ShipmentState',
        'timestamp' => '\DateTime'
    ];
    ...
    */
     ...
     * Gets state
     *
     * @return \OpenAPI\Client\Model\ShipmentState
     */
     ...
     * Sets state
     *
     * @param \OpenAPI\Client\Model\ShipmentState $state state
     *
     * @return self
     */
     ...
     * Sets timestamp
     *
     * @param \DateTime $timestamp ISO-8601 timestamp representing when the state change occurred.
     *
     * @return self
     */
