...
/**
 * FinancialDataNetPayout Class Doc Comment
 *
 * @category Class
 ...
 */
class FinancialDataNetPayout implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FinancialData_netPayout';
    ...
    */
    ...
    public function setBreakdown($breakdown)
    {
        ...
        if ((count($breakdown) < 1)) {
            throw new \InvalidArgumentException('invalid length for $breakdown when calling FinancialDataNetPayout., number of items must be greater than or equal to 1.');
        }
