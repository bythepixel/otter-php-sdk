...
/**
 * PersonalIdentifiers Class Doc Comment
 *
 * @category Class
 ...
 */
class PersonalIdentifiers implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PersonalIdentifiers';
    ...
    {
        $this->container['tax_identification_number'] = $data['tax_identification_number'] ?? null;
    }
     ...
     *
     * @param string|null $tax_identification_number Person tax identification number.
     *
     * @return self
     */
