...
/**
 * FinancialDataTipForRestaurant Class Doc Comment
 *
 * @category Class
 ...
 */
class FinancialDataTipForRestaurant implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FinancialData_tipForRestaurant';
    ...
    */
    ...
    public function setBreakdown($breakdown)
    {
        ...
        if ((count($breakdown) < 1)) {
            throw new \InvalidArgumentException('invalid length for $breakdown when calling FinancialDataTipForRestaurant., number of items must be greater than or equal to 1.');
        }
