...
/**
 * ReportGeneratedEvent Class Doc Comment
 *
 * @category Class
 ...
 */
class ReportGeneratedEvent implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ReportGeneratedEvent';
    ...
    */
     ...
     * Sets report_url
     *
     * @param string|null $report_url Public URL to download generated report
     *
     * @return self
     */
     ...
     * Sets job_id
     *
     * @param string|null $job_id Job id as returned by /v1/reports call
     *
     * @return self
     */
