...
/**
 * OrderFulfilledEvent Class Doc Comment
 *
 * @category Class
 ...
 */
class OrderFulfilledEvent implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OrderFulfilledEvent';
