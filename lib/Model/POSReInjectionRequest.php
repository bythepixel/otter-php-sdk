...
/**
 * POSReInjectionRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class POSReInjectionRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'POSReInjectionRequest';
