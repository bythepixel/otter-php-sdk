...
class ShipmentLineItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'received_sellable_quantity' => 'int',
        'received_unsellable_quantity' => 'int'
    ];
    ...
    protected static $openAPIFormats = [
        'id' => null,
        'manifest_quantity' => null,
        'received_sellable_quantity' => null,
        'received_unsellable_quantity' => null
    ];
    ...
    protected static array $openAPINullables = [
        'id' => false,
		'manifest_quantity' => false,
		'received_sellable_quantity' => false,
		'received_unsellable_quantity' => false
    ];
    ...
    protected static $attributeMap = [
        ...
        'received_sellable_quantity' => 'receivedSellableQuantity',
        'received_unsellable_quantity' => 'receivedUnsellableQuantity'
    ];
    ...
    protected static $setters = [
        'id' => 'setId',
        'manifest_quantity' => 'setManifestQuantity',
        'received_sellable_quantity' => 'setReceivedSellableQuantity',
        'received_unsellable_quantity' => 'setReceivedUnsellableQuantity'
    ];
    ...
    protected static $getters = [
        'id' => 'getId',
        'manifest_quantity' => 'getManifestQuantity',
        'received_sellable_quantity' => 'getReceivedSellableQuantity',
        'received_unsellable_quantity' => 'getReceivedUnsellableQuantity'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('manifest_quantity', $data ?? [], null);
        $this->setIfExists('received_sellable_quantity', $data ?? [], null);
        $this->setIfExists('received_unsellable_quantity', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['manifest_quantity'] === null) {
            $invalidProperties[] = "'manifest_quantity' can't be null";
        }
     ...
     * Sets id
     *
     * @param string $id A CSS SKU UUID for the product.
     *
     * @return self
     */
    ...
    /**
     * Gets manifest_quantity
     *
     * @return int
     */
    public function getManifestQuantity()
    {
        return $this->container['manifest_quantity'];
    }

    /**
     * Sets manifest_quantity
     *
     * @param int $manifest_quantity The expected quantity of the product in the shipment.
     *
     * @return self
     */
    public function setManifestQuantity($manifest_quantity)
    {
        if (is_null($manifest_quantity)) {
            throw new \InvalidArgumentException('non-nullable manifest_quantity cannot be null');
        }
        $this->container['manifest_quantity'] = $manifest_quantity;

        return $this;
    }

    /**
     * Gets received_sellable_quantity
     *
     * @return int|null
     */
    public function getReceivedSellableQuantity()
    {
        return $this->container['received_sellable_quantity'];
    }

    /**
     * Sets received_sellable_quantity
     *
     * @param int|null $received_sellable_quantity The quantity of the product in the shipment received that was sellable.
     *
     * @return self
     */
    public function setReceivedSellableQuantity($received_sellable_quantity)
    {
        if (is_null($received_sellable_quantity)) {
            throw new \InvalidArgumentException('non-nullable received_sellable_quantity cannot be null');
        }
        $this->container['received_sellable_quantity'] = $received_sellable_quantity;

        return $this;
    }

    /**
     * Gets received_unsellable_quantity
     *
     * @return int|null
     */
    public function getReceivedUnsellableQuantity()
    {
        return $this->container['received_unsellable_quantity'];
    }

    /**
     * Sets received_unsellable_quantity
     *
     * @param int|null $received_unsellable_quantity The quantity of the product in the shipment received that was unsellable (damaged, expired, etc.).
     *
     * @return self
     */
    public function setReceivedUnsellableQuantity($received_unsellable_quantity)
    {
        if (is_null($received_unsellable_quantity)) {
            throw new \InvalidArgumentException('non-nullable received_unsellable_quantity cannot be null');
        }
        $this->container['received_unsellable_quantity'] = $received_unsellable_quantity;
