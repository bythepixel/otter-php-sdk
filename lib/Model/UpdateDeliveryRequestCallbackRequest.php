...
/**
 * UpdateDeliveryRequestCallbackRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class UpdateDeliveryRequestCallbackRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateDeliveryRequestCallbackRequest';
    ...
    */
    ...
    public function setCurrencyCode($currency_code)
    {
        if (!is_null($currency_code) && (mb_strlen($currency_code) > 3)) {
            throw new \InvalidArgumentException('invalid length for $currency_code when calling UpdateDeliveryRequestCallbackRequest., must be smaller than or equal to 3.');
        }
        if (!is_null($currency_code) && (mb_strlen($currency_code) < 3)) {
            throw new \InvalidArgumentException('invalid length for $currency_code when calling UpdateDeliveryRequestCallbackRequest., must be bigger than or equal to 3.');
        }
