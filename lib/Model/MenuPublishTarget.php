...
/**
 * MenuPublishTarget Class Doc Comment
 *
 * @category Class
 ...
 */
class MenuPublishTarget implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MenuPublishTarget';
    ...
    public const STATUS_PUBLISH_IN_PROGRESS = 'PUBLISH_IN_PROGRESS';
    ...
    public function getStatusAllowableValues()
    {
        return [
            self::STATUS_READY,
            self::STATUS_PUBLISH_IN_PROGRESS,
            self::STATUS_ERROR,
        ];
    }
    ...
    */
     ...
     * Sets status
     *
     * @param string|null $status The status of a menu publish target.
     *
     * @return self
     */
