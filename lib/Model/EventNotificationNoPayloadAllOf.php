...
/**
 * EventNotificationNoPayloadAllOf Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class EventNotificationNoPayloadAllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EventNotificationNoPayload_allOf';
     ...
     * Gets metadata
     *
     * @return \OpenAPI\Client\Model\MetadataObjectNoPayload|null
     */
     ...
     * Sets metadata
     *
     * @param \OpenAPI\Client\Model\MetadataObjectNoPayload|null $metadata metadata
     *
     * @return self
     */
