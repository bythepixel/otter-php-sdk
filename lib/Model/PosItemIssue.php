...
/**
 * PosItemIssue Class Doc Comment
 *
 * @category Class
 ...
 */
class PosItemIssue implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PosItemIssue';
    ...
    public const CODE_UNKNOWN = 'ITEM_ISSUE_UNKNOWN';
    public const CODE_CUSTOMER_ITEM_MISMATCH = 'ITEM_ISSUE_CUSTOMER_ITEM_MISMATCH';
    public const CODE_MENU_IMPORT_INCOMPLETE = 'ITEM_ISSUE_MENU_IMPORT_INCOMPLETE';
    public const CODE_NO_MENU_ENTITY_PATH = 'ITEM_ISSUE_NO_MENU_ENTITY_PATH';
    public const CODE_MULTIPLE_ENTITY_PATHS = 'ITEM_ISSUE_MULTIPLE_ENTITY_PATHS';
    public const CODE_MISSING_EXTERNAL_DATA_FOR_POS = 'ITEM_ISSUE_MISSING_EXTERNAL_DATA_FOR_POS';
    public const CODE_ENTITY_PATH_INVALID = 'ITEM_ISSUE_ENTITY_PATH_INVALID';
    public const CODE_CATEGORY_MISSING = 'ITEM_ISSUE_CATEGORY_MISSING';
    public const CODE_EXTERNAL_MODIFIER_GROUP_MISSING = 'ITEM_ISSUE_EXTERNAL_MODIFIER_GROUP_MISSING';
    public const CODE_INTERNAL_MODIFIER_GROUP_MISSING = 'ITEM_ISSUE_INTERNAL_MODIFIER_GROUP_MISSING';
    ...
    public function getCodeAllowableValues()
    {
        return [
            self::CODE_UNKNOWN,
            self::CODE_CUSTOMER_ITEM_MISMATCH,
            self::CODE_MENU_IMPORT_INCOMPLETE,
            self::CODE_NO_MENU_ENTITY_PATH,
            self::CODE_MULTIPLE_ENTITY_PATHS,
            self::CODE_MISSING_EXTERNAL_DATA_FOR_POS,
            self::CODE_ENTITY_PATH_INVALID,
            self::CODE_CATEGORY_MISSING,
            self::CODE_EXTERNAL_MODIFIER_GROUP_MISSING,
            self::CODE_INTERNAL_MODIFIER_GROUP_MISSING,
        ];
    }
