...
/**
 * FinancialInvoice Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class FinancialInvoice implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FinancialInvoice';
    ...
    protected static $openAPITypes = [
        ...
        'payout' => '\OpenAPI\Client\Model\InvoicePayoutInfo',
        'financial_transactions' => '\OpenAPI\Client\Model\SimpleFinancialTransaction[]',
    ...
    protected static $setters = [
        ...
        'payout' => 'setPayout',
        'financial_transactions' => 'setFinancialTransactions',
    ...
    protected static $getters = [
        ...
        'payout' => 'getPayout',
        'financial_transactions' => 'getFinancialTransactions',
    ...
    {
        $this->setIfExists('source_service', $data ?? [], null);
        $this->setIfExists('payout', $data ?? [], null);
        $this->setIfExists('financial_transactions', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['financial_transactions'] === null) {
            $invalidProperties[] = "'financial_transactions' can't be null";
        }
     ...
     * Sets source_service
     *
     * @param string|null $source_service Describes the source of the order, typically from a food ordering marketplace.
     *
     * @return self
     */
    public function setSourceService($source_service)
    {
        if (is_null($source_service)) {
            array_push($this->openAPINullablesSetToNull, 'source_service');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('source_service', $nullablesSetToNull);
            if ($index !== FALSE) {
     ...
     * Gets payout
     *
     * @return \OpenAPI\Client\Model\InvoicePayoutInfo
     */
     ...
     * Sets payout
     *
     * @param \OpenAPI\Client\Model\InvoicePayoutInfo $payout payout
     *
     * @return self
     */
    ...
    /**
     * Gets financial_transactions
     *
     * @return \OpenAPI\Client\Model\SimpleFinancialTransaction[]
     */
    public function getFinancialTransactions()
    {
        return $this->container['financial_transactions'];
    }

    /**
     * Sets financial_transactions
     *
     * @param \OpenAPI\Client\Model\SimpleFinancialTransaction[] $financial_transactions List of financial transactions related to this invoice.
     *
     * @return self
     */
    public function setFinancialTransactions($financial_transactions)
    {
        if (is_null($financial_transactions)) {
            throw new \InvalidArgumentException('non-nullable financial_transactions cannot be null');
        }
        $this->container['financial_transactions'] = $financial_transactions;
     ...
     * Sets currency_code
     *
     * @param string|null $currency_code The 3-letter currency code (ISO 4217) to use for all monetary values in this order.
     *
     * @return self
     */
    public function setCurrencyCode($currency_code)
    {
        ...
        if ((mb_strlen($currency_code) > 3)) {
            throw new \InvalidArgumentException('invalid length for $currency_code when calling FinancialInvoice., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($currency_code) < 3)) {
            throw new \InvalidArgumentException('invalid length for $currency_code when calling FinancialInvoice., must be bigger than or equal to 3.');
        }
