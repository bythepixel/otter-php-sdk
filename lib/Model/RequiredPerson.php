...
/**
 * RequiredPerson Class Doc Comment
 *
 * @category Class
 ...
 */
class RequiredPerson implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RequiredPerson';
    ...
    protected static $openAPITypes = [
        ...
        'phone_code' => 'string',
        'email' => 'string',
        'personal_identifiers' => '\OpenAPI\Client\Model\PersonalIdentifiers'
    ];
    ...
    protected static $setters = [
        ...
        'email' => 'setEmail',
        'personal_identifiers' => 'setPersonalIdentifiers'
    ];
    ...
    protected static $getters = [
        ...
        'email' => 'getEmail',
        'personal_identifiers' => 'getPersonalIdentifiers'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('personal_identifiers', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets name
     *
     * @param string|null $name The person's name as it should be displayed.
     *
     * @return self
     */
     ...
     * Sets phone
     *
     * @param string|null $phone The person's phone number.
     *
     * @return self
     */
     ...
     * Sets phone_code
     *
     * @param string|null $phone_code A code or extension of the phone number.
     *
     * @return self
     */
    ...
    /**
     * Gets personal_identifiers
     *
     * @return \OpenAPI\Client\Model\PersonalIdentifiers|null
     */
    public function getPersonalIdentifiers()
    {
        return $this->container['personal_identifiers'];
    }

    /**
     * Sets personal_identifiers
     *
     * @param \OpenAPI\Client\Model\PersonalIdentifiers|null $personal_identifiers personal_identifiers
     *
     * @return self
     */
    public function setPersonalIdentifiers($personal_identifiers)
    {

        if (is_null($personal_identifiers)) {
            array_push($this->openAPINullablesSetToNull, 'personal_identifiers');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('personal_identifiers', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        ...
        $this->container['personal_identifiers'] = $personal_identifiers;
