...
/**
 * IntentToCancelEvent Class Doc Comment
 *
 * @category Class
 ...
 */
class IntentToCancelEvent implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'IntentToCancelEvent';
    ...
    */
     ...
     *
     * @param \OpenAPI\Client\Model\OrderExternalIdentifiers|null $external_identifiers external_identifiers
     *
     * @return self
     */
     ...
     *
     * @param string|null $cancellation_reason The reason for a cancellation.
     *
     * @return self
     */
