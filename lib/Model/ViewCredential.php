...
/**
 * ViewCredential Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ViewCredential implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ViewCredential';
    ...
    public const INPUT_TYPE_MULTI_SELECT = 'MULTI_SELECT';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('select_options', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets label
     *
     * @param string $label The friendly name of the credential.
     *
     * @return self
     */
     ...
     * Sets value
     *
     * @param string|null $value The value of the credential. Only returned if the Store ID was provided in the request.
     *
     * @return self
     */
     ...
     * Sets input_type
     *
     * @param string|null $input_type The type of input
     *
     * @return self
     */
     ...
     * Sets select_options
     *
     * @param string[]|null $select_options options to select when type is `SELECT` or `MULTI_SELECT`
     *
     * @return self
     */
    public function setSelectOptions($select_options)
    {
        ...
        if (is_null($select_options)) {
            throw new \InvalidArgumentException('non-nullable select_options cannot be null');
        }
