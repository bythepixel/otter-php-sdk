...
/**
 * DeliveryStatusUpdateEvent Class Doc Comment
 *
 * @category Class
 ...
 */
class DeliveryStatusUpdateEvent implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DeliveryStatusUpdateEvent';
     ...
     * Sets provider
     *
     * @param string|null $provider Describes the provider of the delivery.
     *
     * @return self
     */
    ...
    public function setCurrencyCode($currency_code)
    {
        if (!is_null($currency_code) && (mb_strlen($currency_code) > 3)) {
            throw new \InvalidArgumentException('invalid length for $currency_code when calling DeliveryStatusUpdateEvent., must be smaller than or equal to 3.');
        }
        if (!is_null($currency_code) && (mb_strlen($currency_code) < 3)) {
            throw new \InvalidArgumentException('invalid length for $currency_code when calling DeliveryStatusUpdateEvent., must be bigger than or equal to 3.');
        }
     ...
     * Sets base_fee
     *
     * @param double|null $base_fee base_fee
     *
     * @return self
     */
     ...
     * Sets extra_fee
     *
     * @param double|null $extra_fee extra_fee
     *
     * @return self
     */
     ...
     * Sets total_fee
     *
     * @param double|null $total_fee total_fee
     *
     * @return self
     */
     ...
     * Sets updated_time
     *
     * @param \DateTime|null $updated_time The time that the delivery status was updated.
     *
     * @return self
     */
