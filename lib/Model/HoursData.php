 ...
 */
class HoursData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'HoursData';
    ...
    protected static $openAPITypes = [
        'time_zone' => 'string',
        'regular_hours' => '\OpenAPI\Client\Model\RegularHours[]',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['regular_hours'] = $data['regular_hours'] ?? null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['regular_hours'] === null) {
            $invalidProperties[] = "'regular_hours' can't be null";
        }
        if ($this->container['special_hours'] === null) {
            $invalidProperties[] = "'special_hours' can't be null";
        }
     ...
     * Sets time_zone
     *
     * @param string $time_zone TimeZone of all times under it. (https://www.joda.org/joda-time/timezones.html)
     *
     * @return self
     */
     ...
     * Gets regular_hours
     *
     * @return \OpenAPI\Client\Model\RegularHours[]
     */
     ...
     * Sets regular_hours
     *
     * @param \OpenAPI\Client\Model\RegularHours[] $regular_hours List of regular hours configuration.
     *
     * @return self
     */
     ...
     * Gets special_hours
     *
     * @return \OpenAPI\Client\Model\SpecialHours[]
     */
     ...
     * Sets special_hours
     *
     * @param \OpenAPI\Client\Model\SpecialHours[] $special_hours List of special hours configuration, for occasions like Christmas, Thanksgiving, or any other holidays.
     *
     * @return self
     */
