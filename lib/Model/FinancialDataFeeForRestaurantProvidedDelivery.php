<?php
/**
 * FinancialDataFeeForRestaurantProvidedDelivery
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * FinancialDataFeeForRestaurantProvidedDelivery Class Doc Comment
 *
 * @category Class
 ...
 */
class FinancialDataFeeForRestaurantProvidedDelivery implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FinancialData_feeForRestaurantProvidedDelivery';
    ...
    protected static $openAPITypes = [
        'breakdown' => '\OpenAPI\Client\Model\SimpleFinanceLine[]'
    ];
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((count($this->container['breakdown']) < 1)) {
            $invalidProperties[] = "invalid value for 'breakdown', number of items must be greater than or equal to 1.";
        }
     ...
     * Gets breakdown
     *
     * @return \OpenAPI\Client\Model\SimpleFinanceLine[]
     */
     ...
     * Sets breakdown
     *
     * @param \OpenAPI\Client\Model\SimpleFinanceLine[] $breakdown Breakdown values for the finance line.
     *
     * @return self
     */
    public function setBreakdown($breakdown)
    {
        ...
        if ((count($breakdown) < 1)) {
            throw new \InvalidArgumentException('invalid length for $breakdown when calling FinancialDataFeeForRestaurantProvidedDelivery., number of items must be greater than or equal to 1.');
        }
