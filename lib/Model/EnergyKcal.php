 ...
 */
class EnergyKcal implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EnergyKcal';
     ...
     * Sets low
     *
     * @param float|null $low The minimum calorie value for an item.
     *
     * @return self
     */
     ...
     * Sets high
     *
     * @param float|null $high The maximum calorie value for an item.
     *
     * @return self
     */
