...
/**
 * FinancialDataAdjustments Class Doc Comment
 *
 * @category Class
 ...
 */
class FinancialDataAdjustments implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FinancialData_adjustments';
    ...
    */
    ...
    public function setBreakdown($breakdown)
    {
        ...
        if ((count($breakdown) < 1)) {
            throw new \InvalidArgumentException('invalid length for $breakdown when calling FinancialDataAdjustments., number of items must be greater than or equal to 1.');
        }
