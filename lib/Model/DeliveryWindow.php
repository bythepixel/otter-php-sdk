...
class DeliveryWindow implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets start
     *
     * @param \DateTime $start ISO-8601 timestamp representing the start of the time range.
     *
     * @return self
     */
     ...
     * Sets end
     *
     * @param \DateTime $end ISO-8601 timestamp representing the end of the time range.
     *
     * @return self
     */
