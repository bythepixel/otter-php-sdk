...
/**
 * MenuPublishRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class MenuPublishRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MenuPublishRequest';
    ...
    */
     ...
     *
     * @param string[]|null $menu_publish_targets MenuPublishTargets to publish to.
     *
     * @return self
     */
