...
/**
 * SelfDropDeliveryInfoAllOf Class Doc Comment
 *
 * @category Class
 ...
 */
class SelfDropDeliveryInfoAllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SelfDropDeliveryInfo_allOf';
