...
/**
 * ManagerOrderIssue Class Doc Comment
 *
 * @category Class
 ...
 */
class ManagerOrderIssue implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ManagerOrderIssue';
    ...
    public const CODE_MENU_RESOLUTION_FAILED = 'MENU_RESOLUTION_FAILED';
    public const CODE_NO_SUPPORTED_POS = 'NO_SUPPORTED_POS';
    public const CODE_VALIDATION_ONLY = 'VALIDATION_ONLY';
    public const CODE_POS_VENDOR_ERROR = 'POS_VENDOR_ERROR';
    public const CODE_INTERNAL_ERROR = 'INTERNAL_ERROR';
    public const CODE_MISCONFIGURED_INTEGRATION = 'MISCONFIGURED_INTEGRATION';
    public const CODE_CANCEL_FAILED = 'CANCEL_FAILED';
