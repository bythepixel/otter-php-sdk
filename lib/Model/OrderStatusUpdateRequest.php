...
/**
 * OrderStatusUpdateRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class OrderStatusUpdateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OrderStatusUpdateRequest';
