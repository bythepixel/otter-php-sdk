...
/**
 * VerificationProof Class Doc Comment
 *
 * @category Class
 ...
 */
class VerificationProof implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'VerificationProof';
    ...
    protected static $openAPITypes = [
        'signature_proof' => '\OpenAPI\Client\Model\SignatureProof',
        'picture_proof' => '\OpenAPI\Client\Model\PictureProof'
    ];
    ...
    protected static $setters = [
        'signature_proof' => 'setSignatureProof',
        'picture_proof' => 'setPictureProof'
    ];
    ...
    protected static $getters = [
        'signature_proof' => 'getSignatureProof',
        'picture_proof' => 'getPictureProof'
    ];
    ...
    {
        $this->setIfExists('signature_proof', $data ?? [], null);
        $this->setIfExists('picture_proof', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets signature_proof
     *
     * @return \OpenAPI\Client\Model\SignatureProof|null
     */
    public function getSignatureProof()
    {
        return $this->container['signature_proof'];
    }

    /**
     * Sets signature_proof
     *
     * @param \OpenAPI\Client\Model\SignatureProof|null $signature_proof signature_proof
     *
     * @return self
     */
    public function setSignatureProof($signature_proof)
    {

        if (is_null($signature_proof)) {
            array_push($this->openAPINullablesSetToNull, 'signature_proof');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('signature_proof', $nullablesSetToNull);
            if ($index !== FALSE) {
        ...
        $this->container['signature_proof'] = $signature_proof;
     ...
     * Gets picture_proof
     *
     * @return \OpenAPI\Client\Model\PictureProof|null
     */
    public function getPictureProof()
    {
        return $this->container['picture_proof'];
    }

    /**
     * Sets picture_proof
     *
     * @param \OpenAPI\Client\Model\PictureProof|null $picture_proof picture_proof
     *
     * @return self
     */
    public function setPictureProof($picture_proof)
    {

        if (is_null($picture_proof)) {
            array_push($this->openAPINullablesSetToNull, 'picture_proof');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('picture_proof', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        ...
        $this->container['picture_proof'] = $picture_proof;
