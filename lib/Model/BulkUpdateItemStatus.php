...
/**
 * BulkUpdateItemStatus Class Doc Comment
 *
 * @category Class
 ...
 */
class BulkUpdateItemStatus implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BulkUpdateItemStatus';
    ...
    protected static $openAPITypes = [
        'updates' => '\OpenAPI\Client\Model\UpdateItemStatusEntry[]'
    ];
     ...
     * Gets updates
     *
     * @return \OpenAPI\Client\Model\UpdateItemStatusEntry[]
     */
     ...
     * Sets updates
     *
     * @param \OpenAPI\Client\Model\UpdateItemStatusEntry[] $updates List of item status updates.
     *
     * @return self
     */
    public function setUpdates($updates)
    {
        ...
        if ((count($updates) < 1)) {
            throw new \InvalidArgumentException('invalid length for $updates when calling BulkUpdateItemStatus., number of items must be greater than or equal to 1.');
        }
