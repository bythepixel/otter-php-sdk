...
/**
 * UpdateStorelinkStatusRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class UpdateStorelinkStatusRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateStorelinkStatusRequest';
     ...
     * Sets status
     *
     * @param string $status The new status of the store. ACTIVE: store ready to perform operations again; SUSPENDED: temporarily disables the store; INVALID: current credentials will no longer work, new credentials needed.
     *
     * @return self
     */
     ...
     * Sets message
     *
     * @param string|null $message Optional message to explain the reason of the status update.
     *
     * @return self
     */
