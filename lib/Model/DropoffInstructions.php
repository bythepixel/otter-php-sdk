...
/**
 * DropoffInstructions Class Doc Comment
 *
 * @category Class
 ...
 */
class DropoffInstructions implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DropoffInstructions';
    ...
    protected static $openAPITypes = [
        'dropoff_type' => 'string',
        'verification_requirements' => '\OpenAPI\Client\Model\VerificationRequirements'
    ];
    ...
    protected static $setters = [
        'dropoff_type' => 'setDropoffType',
        'verification_requirements' => 'setVerificationRequirements'
    ];
    ...
    protected static $getters = [
        'dropoff_type' => 'getDropoffType',
        'verification_requirements' => 'getVerificationRequirements'
    ];
    ...
    public const DROPOFF_TYPE_MEET_AT_DOOR = 'MEET_AT_DOOR';
    public const DROPOFF_TYPE_LEAVE_AT_DOOR = 'LEAVE_AT_DOOR';
    public const DROPOFF_TYPE_MEET_IN_LOBBY = 'MEET_IN_LOBBY';
    ...
    {
        return [
            self::DROPOFF_TYPE_MEET_AT_DOOR,
            self::DROPOFF_TYPE_LEAVE_AT_DOOR,
            self::DROPOFF_TYPE_MEET_IN_LOBBY,
        ];
    }
    ...
    {
        $this->setIfExists('dropoff_type', $data ?? [], null);
        $this->setIfExists('verification_requirements', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['dropoff_type']) && !in_array($this->container['dropoff_type'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'dropoff_type', must be one of '%s'",
                $this->container['dropoff_type'],
    ...
    {
        return $this->container['dropoff_type'];
    }

    /**
     * Sets dropoff_type
     *
     * @param string|null $dropoff_type The drop-off type for the delivery.
     *
     * @return self
     */
    public function setDropoffType($dropoff_type)
    {
        $allowedValues = $this->getDropoffTypeAllowableValues();
        if (!is_null($dropoff_type) && !in_array($dropoff_type, $allowedValues, true)) {
        ...
        if (is_null($dropoff_type)) {
            throw new \InvalidArgumentException('non-nullable dropoff_type cannot be null');
        }

        $this->container['dropoff_type'] = $dropoff_type;

        return $this;
    }

    /**
     * Gets verification_requirements
     *
     * @return \OpenAPI\Client\Model\VerificationRequirements|null
     */
    public function getVerificationRequirements()
    {
        return $this->container['verification_requirements'];
    }

    /**
     * Sets verification_requirements
     *
     * @param \OpenAPI\Client\Model\VerificationRequirements|null $verification_requirements verification_requirements
     *
     * @return self
     */
    public function setVerificationRequirements($verification_requirements)
    {

        if (is_null($verification_requirements)) {
            array_push($this->openAPINullablesSetToNull, 'verification_requirements');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('verification_requirements', $nullablesSetToNull);
            if ($index !== FALSE) {
        ...
        $this->container['verification_requirements'] = $verification_requirements;
