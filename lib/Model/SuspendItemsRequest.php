...
/**
 * SuspendItemsRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SuspendItemsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SuspendItemsRequest';
    ...
    protected static $openAPITypes = [
        'entity_ids' => 'string[]',
        'note' => 'string',
        'status' => '\OpenAPI\Client\Model\SuspensionStatus'
    ];
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['entity_ids'] === null) {
            $invalidProperties[] = "'entity_ids' can't be null";
        }
     ...
     * Sets entity_ids
     *
     * @param string[] $entity_ids Entity IDs to suspend. These should be the IDs as you represent them in your system.
     *
     * @return self
     */
     ...
     * Sets note
     *
     * @param string $note The reason you are suspending the items.
     *
     * @return self
     */
     ...
     * Gets status
     *
     * @return \OpenAPI\Client\Model\SuspensionStatus
     */
     ...
     * Sets status
     *
     * @param \OpenAPI\Client\Model\SuspensionStatus $status status
     *
     * @return self
     */
