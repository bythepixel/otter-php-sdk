...
class Payout implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->container['payout_from_service_provider'] = $data['payout_from_service_provider'] ?? null;
        $this->container['payout_from3rd_party'] = $data['payout_from3rd_party'] ?? null;
        $this->container['cash_payout'] = $data['cash_payout'] ?? null;
    }
     ...
     *
     * @param float|null $payout_from_service_provider payout amount from service provider.
     *
     * @return self
     */
     ...
     *
     * @param float|null $payout_from3rd_party payout amount from 3rd party.
     *
     * @return self
     */
     ...
     * Sets cash_payout
     *
     * @param float|null $cash_payout amount of payout by cash.
     *
     * @return self
     */
