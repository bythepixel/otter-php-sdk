 ...
 */
class PickUpInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PickUpInfo';
    ...
    {
        $this->setIfExists('ready_at_time', $data ?? [], null);
    }
    ...
    */
     ...
     */
    public function getReadyAtTime()
    {
        return $this->container['ready_at_time'];
    }

    /**
     * Sets ready_at_time
     *
     * @param \DateTime|null $ready_at_time The timestamp the order(s) became ready for pick up by a courier. If not provided, the order is not yet ready to be picked up.
     *
     * @return self
     */
    public function setReadyAtTime($ready_at_time)
    {

        if (is_null($ready_at_time)) {
            throw new \InvalidArgumentException('non-nullable ready_at_time cannot be null');
        }

        $this->container['ready_at_time'] = $ready_at_time;
