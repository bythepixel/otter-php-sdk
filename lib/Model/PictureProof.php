...
/**
 * PictureProof Class Doc Comment
 *
 * @category Class
 ...
 */
class PictureProof implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PictureProof';
    ...
    */
     ...
     * Sets picture_url
     *
     * @param string|null $picture_url Image url.
     *
     * @return self
     */
