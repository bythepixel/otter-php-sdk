...
/**
 * OrderCustomerPaymentUpdateRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class OrderCustomerPaymentUpdateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OrderCustomerPaymentUpdateRequest';
    ...
    protected static $openAPITypes = [
        ...
        'customer_payment' => '\OpenAPI\Client\Model\CustomerPayment[]',
        'order_total' => '\OpenAPI\Client\Model\OrderTotal',
        'order_totals_v2' => '\OpenAPI\Client\Model\OrderTotalV2'
    ];
    ...
    protected static $setters = [
        ...
        'order_totals_v2' => 'setOrderTotalsV2'
    ];
    ...
    protected static $getters = [
        ...
        'order_totals_v2' => 'getOrderTotalsV2'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('order_totals_v2', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['customer_payment'] === null) {
            $invalidProperties[] = "'customer_payment' can't be null";
        }
    ...
    public function setCurrencyCode($currency_code)
    {
        if ((mb_strlen($currency_code) > 3)) {
            throw new \InvalidArgumentException('invalid length for $currency_code when calling OrderCustomerPaymentUpdateRequest., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($currency_code) < 3)) {
            throw new \InvalidArgumentException('invalid length for $currency_code when calling OrderCustomerPaymentUpdateRequest., must be bigger than or equal to 3.');
        }
     ...
     *
     * @param \OpenAPI\Client\Model\CustomerPayment[] $customer_payment The requested customer payment to transition the order to.
     *
     * @return self
     */
    ...
    /**
     * Gets order_totals_v2
     *
     * @return \OpenAPI\Client\Model\OrderTotalV2|null
     */
    public function getOrderTotalsV2()
    {
        return $this->container['order_totals_v2'];
    }

    /**
     * Sets order_totals_v2
     *
     * @param \OpenAPI\Client\Model\OrderTotalV2|null $order_totals_v2 order_totals_v2
     *
     * @return self
     */
    public function setOrderTotalsV2($order_totals_v2)
    {

        if (is_null($order_totals_v2)) {
            array_push($this->openAPINullablesSetToNull, 'order_totals_v2');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('order_totals_v2', $nullablesSetToNull);
            if ($index !== FALSE) {
        ...
        $this->container['order_totals_v2'] = $order_totals_v2;
