...
/**
 * SignatureProof Class Doc Comment
 *
 * @category Class
 ...
 */
class SignatureProof implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SignatureProof';
    ...
    protected static array $openAPINullables = [
        'signature_image_url' => false,
		'signer_name' => true,
		'signer_relationship' => true
    ];
    ...
    protected static $setters = [
        'signature_image_url' => 'setSignatureImageUrl',
        'signer_name' => 'setSignerName',
        'signer_relationship' => 'setSignerRelationship'
    ];
    ...
    protected static $getters = [
        'signature_image_url' => 'getSignatureImageUrl',
        'signer_name' => 'getSignerName',
        'signer_relationship' => 'getSignerRelationship'
    ];
    ...
    {
        $this->setIfExists('signature_image_url', $data ?? [], null);
        $this->setIfExists('signer_name', $data ?? [], null);
        $this->setIfExists('signer_relationship', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets signature_image_url
     *
     * @return string|null
     */
    public function getSignatureImageUrl()
    {
        return $this->container['signature_image_url'];
    }

    /**
     * Sets signature_image_url
     *
     * @param string|null $signature_image_url Signature image url.
     *
     * @return self
     */
    public function setSignatureImageUrl($signature_image_url)
    {

        if (is_null($signature_image_url)) {
            throw new \InvalidArgumentException('non-nullable signature_image_url cannot be null');
        }

        $this->container['signature_image_url'] = $signature_image_url;
    ...
    /**
     * Gets signer_relationship
     *
     * @return string|null
     */
    public function getSignerRelationship()
    {
        return $this->container['signer_relationship'];
    }

    /**
     * Sets signer_relationship
     *
     * @param string|null $signer_relationship The relationship of signer to the intended recipient.
     *
     * @return self
     */
    public function setSignerRelationship($signer_relationship)
    {

        if (is_null($signer_relationship)) {
            array_push($this->openAPINullablesSetToNull, 'signer_relationship');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('signer_relationship', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        ...
        $this->container['signer_relationship'] = $signer_relationship;
