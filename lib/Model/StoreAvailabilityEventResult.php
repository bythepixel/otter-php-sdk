...
class StoreAvailabilityEventResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->container['store_state'] = $data['store_state'] ?? null;
        $this->container['status_changed_at'] = $data['status_changed_at'] ?? null;
        $this->container['event_result_metadata'] = $data['event_result_metadata'] ?? null;
    }
