...
/**
 * OrderStatusEvent Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class OrderStatusEvent implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OrderStatusEvent';
    ...
    public const STATUS_ACCEPTED = 'ORDER_ACCEPTED';
    public const STATUS_HANDED_OFF = 'ORDER_HANDED_OFF';
    public const STATUS_READY_TO_PICKUP = 'ORDER_READY_TO_PICKUP';
    public const STATUS_FULFILLED = 'ORDER_FULFILLED';
    ...
    */
     ...
     * Sets status
     *
     * @param string|null $status Events that represent updates on order status.
     *
     * @return self
     */
     ...
     * Sets event_time
     *
     * @param \DateTime|null $event_time The time when this OrderStatusUpdateEvent occurred
     *
     * @return self
     */
