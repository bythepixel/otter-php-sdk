...
/**
 * FulfillmentPathEntity Class Doc Comment
 *
 * @category Class
 ...
 */
class FulfillmentPathEntity implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FulfillmentPathEntity';
    ...
    public const TYPE_FULFILLMENT_PROCESSOR = 'FULFILLMENT_PROCESSOR';
    ...
    {
        return [
            self::TYPE_FULFILLMENT_PROCESSOR,
            self::TYPE_INTERMEDIARY,
        ];
    }
    ...
    */
     ...
     * Sets name
     *
     * @param string|null $name Describes the entity name.
     *
     * @return self
     */
    public function setName($name)
    {
        ...
        if (!is_null($name) && (mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling FulfillmentPathEntity., must be bigger than or equal to 1.');
        }
     ...
     * Sets type
     *
     * @param string|null $type Type of entities in the fulfillment path.
     *
     * @return self
     */
