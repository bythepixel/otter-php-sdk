<?php
/**
 * FinancialDataFeeForServiceProviderDelivery
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * FinancialDataFeeForServiceProviderDelivery Class Doc Comment
 *
 * @category Class
 ...
 */
class FinancialDataFeeForServiceProviderDelivery implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FinancialData_feeForServiceProviderDelivery';
    ...
    */
    ...
    public function setBreakdown($breakdown)
    {
        ...
        if ((count($breakdown) < 1)) {
            throw new \InvalidArgumentException('invalid length for $breakdown when calling FinancialDataFeeForServiceProviderDelivery., number of items must be greater than or equal to 1.');
        }
