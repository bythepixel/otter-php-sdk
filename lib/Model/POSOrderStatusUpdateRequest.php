...
/**
 * POSOrderStatusUpdateRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class POSOrderStatusUpdateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'POSOrderStatusUpdateRequest';
     ...
     * Sets order_status
     *
     * @param string $order_status The requested status to transition the order to.
     *
     * @return self
     */
