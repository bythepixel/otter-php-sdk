...
/**
 * SendMenuEventCallback Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SendMenuEventCallback implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SendMenuEventCallback';
    ...
    protected static $openAPITypes = [
        'menu_data' => '\OpenAPI\Client\Model\MenuData'
    ];
    ...
    {
        $this->setIfExists('menu_data', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['menu_data'] === null) {
            $invalidProperties[] = "'menu_data' can't be null";
        }
     ...
     * Gets menu_data
     *
     * @return \OpenAPI\Client\Model\MenuData
     */
    public function getMenuData()
    {
        return $this->container['menu_data'];
    }

    /**
     * Sets menu_data
     *
     * @param \OpenAPI\Client\Model\MenuData $menu_data menu_data
     *
     * @return self
     */
    public function setMenuData($menu_data)
    {
        ...
        if (is_null($menu_data)) {
            throw new \InvalidArgumentException('non-nullable menu_data cannot be null');
        }

        $this->container['menu_data'] = $menu_data;
