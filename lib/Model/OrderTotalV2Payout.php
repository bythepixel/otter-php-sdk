...
/**
 * OrderTotalV2Payout Class Doc Comment
 *
 * @category Class
 ...
 */
class OrderTotalV2Payout implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OrderTotalV2_payout';
    ...
    protected static $openAPITypes = [
        'payout_from_service_provider' => 'float',
        'payout_from3rd_party' => 'float',
        'cash_payout' => 'float'
    ];
    ...
    protected static $openAPIFormats = [
        'payout_from_service_provider' => null,
        'payout_from3rd_party' => null,
        'cash_payout' => null
    ];
    ...
    protected static array $openAPINullables = [
        'payout_from_service_provider' => true,
		'payout_from3rd_party' => true,
		'cash_payout' => true
    ];
    ...
    protected static $attributeMap = [
        'payout_from_service_provider' => 'payoutFromServiceProvider',
        'payout_from3rd_party' => 'payoutFrom3rdParty',
    ...
    protected static $setters = [
        'payout_from_service_provider' => 'setPayoutFromServiceProvider',
        'payout_from3rd_party' => 'setPayoutFrom3rdParty',
        'cash_payout' => 'setCashPayout'
    ];
    ...
    protected static $getters = [
        'payout_from_service_provider' => 'getPayoutFromServiceProvider',
        'payout_from3rd_party' => 'getPayoutFrom3rdParty',
        'cash_payout' => 'getCashPayout'
    ];
    ...
    {
        $this->setIfExists('payout_from_service_provider', $data ?? [], null);
        $this->setIfExists('payout_from3rd_party', $data ?? [], null);
        $this->setIfExists('cash_payout', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets payout_from_service_provider
     *
     * @return float|null
     */
    public function getPayoutFromServiceProvider()
    {
        return $this->container['payout_from_service_provider'];
    }

    /**
     * Sets payout_from_service_provider
     *
     * @param float|null $payout_from_service_provider Payout amount that will be received from service provider (usually the order source).
     *
     * @return self
     */
    public function setPayoutFromServiceProvider($payout_from_service_provider)
    {
        if (is_null($payout_from_service_provider)) {
            array_push($this->openAPINullablesSetToNull, 'payout_from_service_provider');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('payout_from_service_provider', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['payout_from_service_provider'] = $payout_from_service_provider;

        return $this;
    }

    /**
     * Gets payout_from3rd_party
     *
     * @return float|null
     */
    public function getPayoutFrom3rdParty()
    {
        return $this->container['payout_from3rd_party'];
    }

    /**
     * Sets payout_from3rd_party
     *
     * @param float|null $payout_from3rd_party Payout amount that will be received from any 3rd party organization involved.
     *
     * @return self
     */
    public function setPayoutFrom3rdParty($payout_from3rd_party)
    {
        if (is_null($payout_from3rd_party)) {
            array_push($this->openAPINullablesSetToNull, 'payout_from3rd_party');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('payout_from3rd_party', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['payout_from3rd_party'] = $payout_from3rd_party;
     ...
     * @return float|null
     */
    public function getCashPayout()
    {
        return $this->container['cash_payout'];
    }

    /**
     * Sets cash_payout
     *
     * @param float|null $cash_payout Payout amount received from orders paid in cash directly to the store.
     *
     * @return self
     */
    public function setCashPayout($cash_payout)
    {
        if (is_null($cash_payout)) {
            array_push($this->openAPINullablesSetToNull, 'cash_payout');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('cash_payout', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['cash_payout'] = $cash_payout;
