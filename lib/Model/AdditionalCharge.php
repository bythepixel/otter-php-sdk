...
/**
 * AdditionalCharge Class Doc Comment
 *
 * @category Class
 ...
 */
class AdditionalCharge implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AdditionalCharge';
    ...
    protected static $openAPITypes = [
        'charge_type' => 'string',
        'flat_charge' => '\OpenAPI\Client\Model\Money',
        'percentage_charge' => '\OpenAPI\Client\Model\PercentageValue'
    ];
    ...
    public const CHARGE_TYPE_PACKAGING_CHARGE = 'PACKAGING_CHARGE';
    ...
    {
        return [
            self::CHARGE_TYPE_PACKAGING_CHARGE,
        ];
    }
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('flat_charge', $data ?? [], null);
    ...
    */
     ...
     * Sets charge_type
     *
     * @param string $charge_type The type of the additional charge.
     *
     * @return self
     */
     ...
     */
    public function getFlatCharge()
    {
        return $this->container['flat_charge'];
    }

    /**
     * Sets flat_charge
     *
     * @param \OpenAPI\Client\Model\Money|null $flat_charge flat_charge
     *
     * @return self
     */
    public function setFlatCharge($flat_charge)
    {

        if (is_null($flat_charge)) {
            throw new \InvalidArgumentException('non-nullable flat_charge cannot be null');
        }

        $this->container['flat_charge'] = $flat_charge;
     ...
     *
     * @return \OpenAPI\Client\Model\PercentageValue|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\PercentageValue|null $percentage_charge percentage_charge
     *
     * @return self
     */
