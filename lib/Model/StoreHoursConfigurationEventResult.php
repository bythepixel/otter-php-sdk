...
/**
 * StoreHoursConfigurationEventResult Class Doc Comment
 *
 * @category Class
 ...
 */
class StoreHoursConfigurationEventResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'StoreHoursConfigurationEventResult';
    ...
    protected static $openAPITypes = [
        'store_hours_configuration' => '\OpenAPI\Client\Model\StoreHoursConfiguration',
    ...
    protected static $openAPIFormats = [
        'store_hours_configuration' => null,
    ...
    protected static array $openAPINullables = [
        'store_hours_configuration' => false,
    ...
    protected static $attributeMap = [
        'store_hours_configuration' => 'storeHoursConfiguration',
    ...
    protected static $setters = [
        'store_hours_configuration' => 'setStoreHoursConfiguration',
    ...
    protected static $getters = [
        'store_hours_configuration' => 'getStoreHoursConfiguration',
    ...
    {
        $this->setIfExists('store_hours_configuration', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets store_hours_configuration
     *
     * @return \OpenAPI\Client\Model\StoreHoursConfiguration|null
     */
    public function getStoreHoursConfiguration()
    {
        return $this->container['store_hours_configuration'];
    }

    /**
     * Sets store_hours_configuration
     *
     * @param \OpenAPI\Client\Model\StoreHoursConfiguration|null $store_hours_configuration store_hours_configuration
     *
     * @return self
     */
    public function setStoreHoursConfiguration($store_hours_configuration)
    {

        if (is_null($store_hours_configuration)) {
            throw new \InvalidArgumentException('non-nullable store_hours_configuration cannot be null');
        }

        $this->container['store_hours_configuration'] = $store_hours_configuration;
     ...
     *
     * @param \DateTime|null $status_changed_at The time when the store hours configuration changed.
     *
     * @return self
     */
