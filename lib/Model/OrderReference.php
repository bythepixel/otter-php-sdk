...
/**
 * OrderReference Class Doc Comment
 *
 * @category Class
 ...
 */
class OrderReference implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OrderReference';
    ...
    */
     ...
     * Sets store_id
     *
     * @param string $store_id The identifier of the store.
     *
     * @return self
     */
