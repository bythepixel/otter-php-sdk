 ...
 */
class ItemStatus implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ItemStatus';
    ...
    public const SALE_STATUS_FOR_SALE = 'FOR_SALE';
    public const SALE_STATUS_INDEFINITELY_NOT_FOR_SALE = 'INDEFINITELY_NOT_FOR_SALE';
    public const SALE_STATUS_TEMPORARILY_NOT_FOR_SALE = 'TEMPORARILY_NOT_FOR_SALE';
     ...
     * @return string[]
     */
    public function getSaleStatusAllowableValues()
    {
        return [
            self::SALE_STATUS_FOR_SALE,
            self::SALE_STATUS_INDEFINITELY_NOT_FOR_SALE,
            self::SALE_STATUS_TEMPORARILY_NOT_FOR_SALE,
        ];
    }
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['suspended_until'] = $data['suspended_until'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['sale_status'] === null) {
            $invalidProperties[] = "'sale_status' can't be null";
        }
        $allowedValues = $this->getSaleStatusAllowableValues();
        if (!is_null($this->container['sale_status']) && !in_array($this->container['sale_status'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'sale_status', must be one of '%s'",
                $this->container['sale_status'],
     ...
     * Sets sale_status
     *
     * @param string $sale_status The sale status of the item.
     *
     * @return self
     */
    ...
    {
        $allowedValues = $this->getSaleStatusAllowableValues();
        if (!in_array($sale_status, $allowedValues, true)) {
     ...
     *
     * @param \DateTime|null $suspended_until ISO-8601 timestamp representing the time the saleStatus value is supposed to change to FOR_SALE. Set only when current saleStatus value is TEMPORARILY_NOT_FOR_SALE. E.g.: 2020-11-23T21:33:51Z, 2007-12-03T10:15:30+01:00
     *
     * @return self
     */
