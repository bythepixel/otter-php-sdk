...
class RequiredDeliveryInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['license_plate'] = $data['license_plate'] ?? null;
        $this->container['make_model'] = $data['make_model'] ?? null;
        $this->container['last_known_location'] = $data['last_known_location'] ?? null;
