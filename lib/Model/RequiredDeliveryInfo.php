...
/**
 * RequiredDeliveryInfo Class Doc Comment
 *
 * @category Class
 ...
 */
class RequiredDeliveryInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RequiredDeliveryInfo';
    ...
    protected static $openAPITypes = [
        ...
        'destination' => '\OpenAPI\Client\Model\Address',
        'license_plate' => 'string',
        'make_model' => 'string',
        'last_known_location' => '\OpenAPI\Client\Model\Location',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('make_model', $data ?? [], null);
    ...
    */
     ...
     * Sets destination
     *
     * @param \OpenAPI\Client\Model\Address|null $destination destination
     *
     * @return self
     */
     ...
     * Sets license_plate
     *
     * @param string|null $license_plate License plate of a vehicle used by the courier.
     *
     * @return self
     */
     ...
     * Sets make_model
     *
     * @param string|null $make_model Make and model of a vehicle used by the courier.
     *
     * @return self
     */
    public function setMakeModel($make_model)
    {
        if (is_null($make_model)) {
            array_push($this->openAPINullablesSetToNull, 'make_model');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('make_model', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     *
     * @param \OpenAPI\Client\Model\Location|null $last_known_location last_known_location
     *
     * @return self
     */
    public function setLastKnownLocation($last_known_location)
    {
        if (is_null($last_known_location)) {
            array_push($this->openAPINullablesSetToNull, 'last_known_location');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('last_known_location', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Sets note
     *
     * @param string|null $note Special delivery instructions, if any.
     *
     * @return self
     */
