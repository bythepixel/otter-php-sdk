...
class Address implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets address_lines
     *
     * @param string[]|null $address_lines Address lines (e.g. street, PO Box, or company name). Deprecated for linesOfAddress.
     *
     * @return self
     * @deprecated
     */
     ...
     *
     * @param string[]|null $lines_of_address Address lines (e.g. street, PO Box, or company name).
     *
     * @return self
     */
