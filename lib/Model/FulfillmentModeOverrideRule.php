...
/**
 * FulfillmentModeOverrideRule Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class FulfillmentModeOverrideRule extends OverrideRule3PD
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FulfillmentModeOverrideRule';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['fulfillment_mode'] = $data['fulfillment_mode'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['fulfillment_mode'] === null) {
            $invalidProperties[] = "'fulfillment_mode' can't be null";
        }
     ...
     *
     * @param string $fulfillment_mode The fulfillment mode for which the override rule should apply.
     *
     * @return self
     */
