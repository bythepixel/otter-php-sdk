...
/**
 * PriceOverride Class Doc Comment
 *
 * @category Class
 ...
 */
class PriceOverride implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PriceOverride';
    ...
    protected static $openAPITypes = [
        ...
        'rules' => '\OpenAPI\Client\Model\OverrideRule3PD[]'
    ];
    ...
    */
     ...
     * Gets rules
     *
     * @return \OpenAPI\Client\Model\OverrideRule3PD[]
     */
     ...
     * Sets rules
     *
     * @param \OpenAPI\Client\Model\OverrideRule3PD[] $rules Override rules for when this price override should be applied.
     *
     * @return self
     */
    public function setRules($rules)
    {
        ...
        if ((count($rules) < 1)) {
            throw new \InvalidArgumentException('invalid length for $rules when calling PriceOverride., number of items must be greater than or equal to 1.');
        }
