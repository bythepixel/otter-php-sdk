 ...
 */
class DropoffInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DropoffInfo';
    ...
    protected static $openAPITypes = [
        'courier_note' => 'string',
        'proof_of_delivery' => '\OpenAPI\Client\Model\VerificationProof'
    ];
    ...
    {
        $this->setIfExists('courier_note', $data ?? [], null);
    ...
    */
    ...
    {
        return $this->container['courier_note'];
    }

    /**
     * Sets courier_note
     *
     * @param string|null $courier_note Courier supplied dropoff note.
     *
     * @return self
     */
    public function setCourierNote($courier_note)
    {
        if (is_null($courier_note)) {
            array_push($this->openAPINullablesSetToNull, 'courier_note');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('courier_note', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['courier_note'] = $courier_note;
     ...
     *
     * @return \OpenAPI\Client\Model\VerificationProof|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\VerificationProof|null $proof_of_delivery proof_of_delivery
     *
     * @return self
     */
    public function setProofOfDelivery($proof_of_delivery)
    {
        if (is_null($proof_of_delivery)) {
            array_push($this->openAPINullablesSetToNull, 'proof_of_delivery');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('proof_of_delivery', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
