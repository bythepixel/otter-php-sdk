...
/**
 * MetadataObjectNoPayload Class Doc Comment
 *
 * @category Class
 ...
 */
class MetadataObjectNoPayload implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MetadataObjectNoPayload';
     ...
     * Sets application_id
     *
     * @param string $application_id The plain-text Application ID, provided at partner onboarding, also available on Developer Portal.
     *
     * @return self
     */
