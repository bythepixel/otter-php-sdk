 ...
 */
class SkuBarcode implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SkuBarcode';
    ...
    public const BARCODE_TYPE_GTIN = 'GTIN';
    public const BARCODE_TYPE_ASIN = 'ASIN';
    public const BARCODE_TYPE_INTERNAL = 'INTERNAL';
    ...
    public function getBarcodeTypeAllowableValues()
    {
        return [
            ...
            self::BARCODE_TYPE_GTIN,
            self::BARCODE_TYPE_ASIN,
            self::BARCODE_TYPE_INTERNAL,
        ];
    }
    ...
    {
        $this->container['barcode_type'] = $data['barcode_type'] ?? null;
     ...
     * Sets barcode_type
     *
     * @param string|null $barcode_type The type of the barcode.
     *
     * @return self
     */
     ...
     * Sets value
     *
     * @param string|null $value The value of the barcode.
     *
     * @return self
     */
