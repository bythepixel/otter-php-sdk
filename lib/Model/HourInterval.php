...
class HourInterval implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['from_hour'] = $data['from_hour'] ?? null;
        $this->container['from_minute'] = $data['from_minute'] ?? null;
        $this->container['to_hour'] = $data['to_hour'] ?? null;
        $this->container['to_minute'] = $data['to_minute'] ?? null;
    }
    ...
    public function setFromHour($from_hour)
    {
        ...
        if (!is_null($from_hour) && ($from_hour > 23)) {
        ...
        if (!is_null($from_hour) && ($from_hour < 0)) {
    ...
    public function setFromMinute($from_minute)
    {
        ...
        if (!is_null($from_minute) && ($from_minute > 59)) {
        ...
        if (!is_null($from_minute) && ($from_minute < 0)) {
    ...
    public function setToMinute($to_minute)
    {
        ...
        if (!is_null($to_minute) && ($to_minute > 59)) {
        ...
        if (!is_null($to_minute) && ($to_minute < 0)) {
