...
/**
 * DietaryClassification Class Doc Comment
 *
 * @category Class
 ...
 */
class DietaryClassification implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DietaryClassification';
    ...
    public const TAG_VEGAN = 'VEGAN';
    public const TAG_VEGETARIAN = 'VEGETARIAN';
    public const TAG_NON_VEGETARIAN = 'NON_VEGETARIAN';
    public const TAG_EGG = 'EGG';
    public const TAG_KOSHER = 'KOSHER';
    public const TAG_HALAL = 'HALAL';
    ...
    */
     ...
     * Sets tag
     *
     * @param string|null $tag The type of dietary classification.
     *
     * @return self
     */
