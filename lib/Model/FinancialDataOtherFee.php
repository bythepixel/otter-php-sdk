...
/**
 * FinancialDataOtherFee Class Doc Comment
 *
 * @category Class
 ...
 */
class FinancialDataOtherFee implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FinancialData_otherFee';
    ...
    */
    ...
    public function setBreakdown($breakdown)
    {
        ...
        if ((count($breakdown) < 1)) {
            throw new \InvalidArgumentException('invalid length for $breakdown when calling FinancialDataOtherFee., number of items must be greater than or equal to 1.');
        }
