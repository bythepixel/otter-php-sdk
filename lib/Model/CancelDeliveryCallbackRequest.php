...
/**
 * CancelDeliveryCallbackRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class CancelDeliveryCallbackRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CancelDeliveryCallbackRequest';
     ...
     * Sets canceled_at
     *
     * @param \DateTime|null $canceled_at The time that the request was cancelled.
     *
     * @return self
     */
