...
/**
 * POSCancelOrderRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class POSCancelOrderRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'POSCancelOrderRequest';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('canceling_party', $data ?? [], null);
    }
    ...
    */
    ...
    {
        if (is_null($canceling_party)) {
            array_push($this->openAPINullablesSetToNull, 'canceling_party');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('canceling_party', $nullablesSetToNull);
            if ($index !== FALSE) {
