...
/**
 * ServiceProviderCharge Class Doc Comment
 *
 * @category Class
 * @description Details charges by service provider.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class ServiceProviderCharge implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ServiceProviderCharge';
    ...
    protected static $openAPITypes = [
        'sales_tax_withheld' => '\OpenAPI\Client\Model\CompositeFinanceLine',
        'commission' => '\OpenAPI\Client\Model\CompositeFinanceLine',
        'processing_fee' => '\OpenAPI\Client\Model\CompositeFinanceLine',
        'delivery_fee_for_restaurant' => '\OpenAPI\Client\Model\CompositeFinanceLine',
        'charges_adjustments' => '\OpenAPI\Client\Model\CompositeFinanceLine',
        'other_fees' => '\OpenAPI\Client\Model\CompositeFinanceLine'
    ];
    ...
    protected static $openAPIFormats = [
        'sales_tax_withheld' => null,
        'commission' => null,
        'processing_fee' => null,
        'delivery_fee_for_restaurant' => null,
        'charges_adjustments' => null,
        'other_fees' => null
    ];
    ...
    protected static $attributeMap = [
        'sales_tax_withheld' => 'salesTaxWithheld',
        'commission' => 'commission',
        'processing_fee' => 'processingFee',
        'delivery_fee_for_restaurant' => 'deliveryFeeForRestaurant',
        'charges_adjustments' => 'chargesAdjustments',
    ...
    protected static $setters = [
        'sales_tax_withheld' => 'setSalesTaxWithheld',
        'commission' => 'setCommission',
        'processing_fee' => 'setProcessingFee',
        'delivery_fee_for_restaurant' => 'setDeliveryFeeForRestaurant',
        'charges_adjustments' => 'setChargesAdjustments',
    ...
    protected static $getters = [
        'sales_tax_withheld' => 'getSalesTaxWithheld',
        'commission' => 'getCommission',
        'processing_fee' => 'getProcessingFee',
        'delivery_fee_for_restaurant' => 'getDeliveryFeeForRestaurant',
        'charges_adjustments' => 'getChargesAdjustments',
    ...
    {
        $this->container['sales_tax_withheld'] = $data['sales_tax_withheld'] ?? null;
        $this->container['commission'] = $data['commission'] ?? null;
        $this->container['processing_fee'] = $data['processing_fee'] ?? null;
        $this->container['delivery_fee_for_restaurant'] = $data['delivery_fee_for_restaurant'] ?? null;
        $this->container['charges_adjustments'] = $data['charges_adjustments'] ?? null;
        $this->container['other_fees'] = $data['other_fees'] ?? null;
    }
    ...
    /**
     * Gets sales_tax_withheld
     *
     * @return \OpenAPI\Client\Model\CompositeFinanceLine|null
     */
    public function getSalesTaxWithheld()
    {
        return $this->container['sales_tax_withheld'];
    }

    /**
     * Sets sales_tax_withheld
     *
     * @param \OpenAPI\Client\Model\CompositeFinanceLine|null $sales_tax_withheld sales_tax_withheld
     *
     * @return self
     */
    public function setSalesTaxWithheld($sales_tax_withheld)
    {
        $this->container['sales_tax_withheld'] = $sales_tax_withheld;
     ...
     * Sets commission
     *
     * @param \OpenAPI\Client\Model\CompositeFinanceLine|null $commission commission
     *
     * @return self
     */
     ...
     * Sets processing_fee
     *
     * @param \OpenAPI\Client\Model\CompositeFinanceLine|null $processing_fee processing_fee
     *
     * @return self
     */
    ...
    /**
     * Gets delivery_fee_for_restaurant
     *
     * @return \OpenAPI\Client\Model\CompositeFinanceLine|null
     */
    public function getDeliveryFeeForRestaurant()
    {
        return $this->container['delivery_fee_for_restaurant'];
    }

    /**
     * Sets delivery_fee_for_restaurant
     *
     * @param \OpenAPI\Client\Model\CompositeFinanceLine|null $delivery_fee_for_restaurant delivery_fee_for_restaurant
     *
     * @return self
     */
    public function setDeliveryFeeForRestaurant($delivery_fee_for_restaurant)
    {
        $this->container['delivery_fee_for_restaurant'] = $delivery_fee_for_restaurant;

        return $this;
    }

    /**
     * Gets charges_adjustments
     *
     * @return \OpenAPI\Client\Model\CompositeFinanceLine|null
     */
    public function getChargesAdjustments()
    {
        return $this->container['charges_adjustments'];
    }

    /**
     * Sets charges_adjustments
     *
     * @param \OpenAPI\Client\Model\CompositeFinanceLine|null $charges_adjustments charges_adjustments
     *
     * @return self
     */
    public function setChargesAdjustments($charges_adjustments)
    {
        $this->container['charges_adjustments'] = $charges_adjustments;
     ...
     * Sets other_fees
     *
     * @param \OpenAPI\Client\Model\CompositeFinanceLine|null $other_fees other_fees
     *
     * @return self
     */
