...
/**
 * RegularHours Class Doc Comment
 *
 * @category Class
 ...
 */
class RegularHours implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RegularHours';
    ...
    */
     ...
     * Sets days
     *
     * @param string[] $days The day of the week this configuration applies.
     *
     * @return self
     */
     ...
     * Sets time_ranges
     *
     * @param \OpenAPI\Client\Model\TimeRange[] $time_ranges Hours range applied to the provided day of the week
     *
     * @return self
     */
