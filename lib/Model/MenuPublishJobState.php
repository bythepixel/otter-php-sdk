...
/**
 * MenuPublishJobState Class Doc Comment
 *
 * @category Class
 ...
 */
class MenuPublishJobState implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MenuPublishJobState';
     ...
     * Sets status
     *
     * @param string|null $status Status of the menu publish.
     *
     * @return self
     */
     ...
     * Sets message
     *
     * @param string|null $message Only present if status is FAILED. Contains the error message returned by our menu systems.
     *
     * @return self
     */
