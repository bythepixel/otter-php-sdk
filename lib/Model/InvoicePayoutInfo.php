...
/**
 * InvoicePayoutInfo Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InvoicePayoutInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InvoicePayoutInfo';
    ...
    protected static $openAPITypes = [
        'id' => 'string',
        'date' => '\DateTime',
        'summary' => '\OpenAPI\Client\Model\FinancialData',
        'total' => 'float'
    ];
    ...
    */
     ...
     * Sets date
     *
     * @param \DateTime $date The payout date.
     *
     * @return self
     */
     ...
     * Gets summary
     *
     * @return \OpenAPI\Client\Model\FinancialData|null
     */
     ...
     * Sets summary
     *
     * @param \OpenAPI\Client\Model\FinancialData|null $summary summary
     *
     * @return self
     */
     ...
     * Sets total
     *
     * @param float|null $total Total payout value. Should only be used if summary is not provided.
     *
     * @return self
     */
