...
/**
 * GenerateReportMultiRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class GenerateReportMultiRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GenerateReportMultiRequest';
    ...
    protected static $openAPITypes = [
        ...
        'start' => '\DateTime',
        'end' => '\DateTime',
        'external_store_ids' => 'string[]',
        'external_service_slugs' => 'string[]',
        'language' => 'string'
    ];
    ...
    protected static $openAPIFormats = [
        ...
        'start' => 'date',
        'end' => 'date',
        'external_store_ids' => null,
        'external_service_slugs' => null,
        'language' => null
    ];
    ...
    protected static array $openAPINullables = [
		...
		'start' => false,
		'end' => false,
		'external_store_ids' => false,
		'external_service_slugs' => true,
		'language' => true
    ];
    ...
    protected static $attributeMap = [
        ...
        'start' => 'start',
        'end' => 'end',
        'external_store_ids' => 'externalStoreIds',
        'external_service_slugs' => 'externalServiceSlugs',
        'language' => 'language'
    ];
    ...
    protected static $setters = [
        ...
        'start' => 'setStart',
        'end' => 'setEnd',
        'external_store_ids' => 'setExternalStoreIds',
        'external_service_slugs' => 'setExternalServiceSlugs',
    ...
    protected static $getters = [
        ...
        'start' => 'getStart',
        'end' => 'getEnd',
        'external_store_ids' => 'getExternalStoreIds',
        'external_service_slugs' => 'getExternalServiceSlugs',
    ...
    public const REPORT_TYPE_ORDER_STORES = 'ORDER_STORES';
    public const REPORT_TYPE_ORDER_ITEMS = 'ORDER_ITEMS';
    public const REPORT_TYPE_PAYOUT_TRANSACTIONS = 'PAYOUT_TRANSACTIONS';
    public const REPORT_TYPE_RATINGS_AND_REVIEWS = 'RATINGS_AND_REVIEWS';
    ...
    {
        return [
            self::REPORT_TYPE_ORDER_STORES,
            self::REPORT_TYPE_ORDER_ITEMS,
            self::REPORT_TYPE_PAYOUT_TRANSACTIONS,
            self::REPORT_TYPE_RATINGS_AND_REVIEWS,
        ];
    }
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('external_store_ids', $data ?? [], null);
        $this->setIfExists('external_service_slugs', $data ?? [], null);
    ...
    */
     ...
     * Sets report_type
     *
     * @param string|null $report_type Type of report to generate
     *
     * @return self
     */
     ...
     * Sets start
     *
     * @param \DateTime|null $start Report start date
     *
     * @return self
     */
     ...
     * Sets end
     *
     * @param \DateTime|null $end Report end date
     *
     * @return self
     */
    ...
    /**
     * Gets external_store_ids
     *
     * @return string[]|null
     */
    public function getExternalStoreIds()
    {
        return $this->container['external_store_ids'];
    }

    /**
     * Sets external_store_ids
     *
     * @param string[]|null $external_store_ids List of external store IDs to filter the orders with. At least one value is required. Max is 5000. Fails the requests if one or more invalid external store ID is passed
     *
     * @return self
     */
    public function setExternalStoreIds($external_store_ids)
    {
        if (is_null($external_store_ids)) {
            throw new \InvalidArgumentException('non-nullable external_store_ids cannot be null');
        }
        $this->container['external_store_ids'] = $external_store_ids;

        return $this;
    }

    /**
     * Gets external_service_slugs
     *
     * @return string[]|null
     */
    public function getExternalServiceSlugs()
    {
        return $this->container['external_service_slugs'];
    }

    /**
     * Sets external_service_slugs
     *
     * @param string[]|null $external_service_slugs List of external service slugs to fetch orders from. Default to all services
     *
     * @return self
     */
    public function setExternalServiceSlugs($external_service_slugs)
    {
        if (is_null($external_service_slugs)) {
            array_push($this->openAPINullablesSetToNull, 'external_service_slugs');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('external_service_slugs', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['external_service_slugs'] = $external_service_slugs;
     ...
     * Sets language
     *
     * @param string|null $language Language of the report. Ignored by ORDER_STORES report Optional. Falls back to English if empty.
     *
     * @return self
     */
