<?php
/**
 * FinancialDataServiceProviderDiscount
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * FinancialDataServiceProviderDiscount Class Doc Comment
 *
 * @category Class
 ...
 */
class FinancialDataServiceProviderDiscount implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FinancialData_serviceProviderDiscount';
    ...
    */
    ...
    public function setBreakdown($breakdown)
    {
        ...
        if ((count($breakdown) < 1)) {
            throw new \InvalidArgumentException('invalid length for $breakdown when calling FinancialDataServiceProviderDiscount., number of items must be greater than or equal to 1.');
        }
