...
/**
 * PosOrderCancelDetails Class Doc Comment
 *
 * @category Class
 ...
 */
class PosOrderCancelDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PosOrderCancelDetails';
    ...
    public const CANCEL_SOURCE_UNKNOWN = 'CANCEL_SOURCE_UNKNOWN';
    public const CANCEL_SOURCE_OPERATOR = 'CANCEL_SOURCE_OPERATOR';
    public const CANCEL_SOURCE_SERVICE_PROVIDER = 'CANCEL_SOURCE_SERVICE_PROVIDER';
     ...
     * @return string[]
     */
    public function getCancelSourceAllowableValues()
    {
        return [
            self::CANCEL_SOURCE_UNKNOWN,
            self::CANCEL_SOURCE_OPERATOR,
            self::CANCEL_SOURCE_SERVICE_PROVIDER,
        ];
    }
    ...
    {
        $this->setIfExists('cancel_source', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['cancel_source'] === null) {
            $invalidProperties[] = "'cancel_source' can't be null";
        }
        $allowedValues = $this->getCancelSourceAllowableValues();
        if (!is_null($this->container['cancel_source']) && !in_array($this->container['cancel_source'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'cancel_source', must be one of '%s'",
                $this->container['cancel_source'],
    ...
    {
        return $this->container['cancel_source'];
    }

    /**
     * Sets cancel_source
     *
     * @param string $cancel_source Source of the order cancellation
     *
     * @return self
     */
    public function setCancelSource($cancel_source)
    {
        $allowedValues = $this->getCancelSourceAllowableValues();
        if (!in_array($cancel_source, $allowedValues, true)) {
        ...
        if (is_null($cancel_source)) {
            throw new \InvalidArgumentException('non-nullable cancel_source cannot be null');
        }

        $this->container['cancel_source'] = $cancel_source;
